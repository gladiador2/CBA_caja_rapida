...
namespace CBA.FlowV2.Services.Base
{
    public abstract class Definiciones
    {
        ...
        public abstract class FlujosIDs
        {
            ...
            public const int CAJA_RAPIDA = 59;
            public const int TRANSFERENCIA_DE_INSUMOS = 60;
            public const int TRANSFERENCIA_DE_BALANCEADOS = 62;
            ...
            public static string GetNombre(decimal flujoId)
            {
                ...
                switch ((int)flujoId)
                {
                    ...
                    case (int)EGRESO_PRODUCTOS:
                        ...
                        break;
                    case (int)CAJA_RAPIDA:
                        descripcion = "Facturas de Cliente";
                        break;
                    case (int)TRANSFERENCIA_DE_INSUMOS:
                        descripcion = "Transferencia de Insumos";
                        break;
                    case (int)TRANSFERENCIA_DE_BALANCEADOS:
                        descripcion = "Transferencia de Balanceados";
                        break;
                }
        ...
        public abstract class VariablesDeSistema
        {
            ...
            /// <summary>
            /// Indique la lista de precios base, solo este se podrá modificar en el flujo modificar lista de precios
            /// </summary>
            public const decimal ListaDePrecioPorDefectoID = 249;

            /// <summary>
            /// Define la moneda minima para redondeo, Ej: 50 gs
            /// </summary>
            public const decimal ValorRedondeoEnListaDePrecio = 250;

            /// <summary>
            /// Indique 1, redondeo hacia abajo; 2, arriba; 3, Mas Cercano
            /// </summary>
            public const decimal TipoRedondeoEnListaDePrecio = 251;

            /// <summary>
            /// ID de la lista de precio minorista
            /// </summary>
            public const decimal ListaPrecioBalanzaId = 252;

            /// <summary>
            /// ID de la lista de precio minorista
            /// </summary>
            public const decimal ListaDePrecioMayoristaID = 253;

            /// <summary>
            /// ID de la Vendedor Predeterminado
            /// </summary>
            public const decimal IdVendedorPorDefault = 254;

            /// <summary>
            /// ID del Cliente Predeterminado
            /// </summary>
            public const decimal IdClientePorDefault = 255;

            /// <summary>
            /// ID texto predefinido en proceso de tarjetas para Deposito Bancario
            /// </summary>
            public const decimal IdConceptoProcTarjDepoBanc = 256;

            /// <summary>
            /// ID texto predefinido en proceso de tarjetas para Transferencia de Caja
            /// </summary>
            public const decimal IdConceptoProceTarjTransfCaja = 257;

            /// <summary>
            /// Id de la moneda base que utiliza el sistema, aft
            /// </summary>
            public const decimal MonedaBaseSistemaId = 258;
        }
        ...
        public abstract class Flujo
        {
            ...
            public abstract class ProduccionBalanceados
            {
                public static decimal ID = 57;
                public static string permisoCreacion = "PRODUCCION BALANCEADOS CREAR";
            }

            public abstract class EgresoProductos
            {
                public static decimal ID = 58;
                public static string permisoCreacion = "EGRESO PRODUCTOS CREAR";
            }
            public abstract class CajaRapida
            {
                public static string nombre = "Caja Rápida";
                public static decimal ID = 59;
                public static string permisoCreacion = "FC CLIENTE CREAR";
            }

            public abstract class StockTransferenciaInsumos
            {
                public static string nombre = "Stock Transferencia Insumo";
                public static decimal ID = 60;
                public static string permisoCreacion = "TRANSFERENCIAS INSUMOS CREAR";
            }

            public abstract class StockTransferenciaBalanceados
            {
                public static string nombre = "Stock Transferencia Balanceados";
                public static decimal ID = 62;
                public static string permisoCreacion = "TRANSFERENCIAS BALANCEADOS CREAR";
            }
            ...
            public static string[] permisosFlujos()
            {
                return new string[]{
                    ...
                    ProduccionBalanceados.permisoCreacion,
                    EgresoProductos.permisoCreacion,
                    StockTransferenciaInsumos.permisoCreacion,
                    StockTransferenciaBalanceados.permisoCreacion
                };
            }
        }
        #endregion Flujos
        ...
        {
            public const decimal Dolares = 1;
            public const decimal Guaranies = 2;
        ...
        public abstract class TiposCliente
        {
            ...
            public const decimal Diplomatico = 2;
        }
        #endregion TiposCliente
        #region ValorCero
        public abstract class ValorCero
        {
            public const decimal CeroDecimal = 0;
            public const string CeroString = "0";
        ...
        public abstract class Reportes
        {
            ...
            public abstract class Tesoreria //prefijo 2
            {
                ...
                public const int FacturaCajaRapida = 311;
                public const int Presupuesto = 410;
                public const int OrdenDePagoImpresionMasiva = 422;
            }
            ...
            public abstract class Stock //prefijo 5
            {
                ...
                public const int StockTransferenciasArticulosListadoControl = 516;
                ...
                public const int ProduccionBalanceados = 530;
                public const int ProduccionBalanceadosListadoCargas = 531;
                public const int OrdenSalidaMercaderia = 532;
                public const int ListadoProduccionBalanceados = 533;
                public const int EgresoProductos = 534;
                public const int EgresoProductosListadoCargas = 535;
                public const int OrdenSalidaEgresoProducto = 536;
                public const int ListadoEgresoProductos = 537;
        ...
        public abstract class TipoTextoPredefinido
        {
            ...
            public const decimal TransferenciaInsumos = 56;
            public const decimal AjusteStock = 57;
            public const decimal TransferenciaBalanceados = 58;
            public const decimal Promociones = 59;
        }
        ...
        public abstract class TextoPredefinido
        {
            ...
            {
                public const decimal PorImporte = 233;
                public const decimal PorCantidad = 234;
            }
        }
        ...
        #region keyJson
        public abstract class AccionesFacturaRapida
        {
            public const int BuscarCliente = 1;
            public const int ModificarAgregarCliente = 2;
            public const int IncertarCabecera = 3;
            public const int IncertarDetalle = 4;
            public const int EliminarDetalle = 5;
            public const int AgregarModificarEnvases = 6;
            public const int ObtenerCabeceraCaso = 7;
            public const int ObtenerDetallesCaso = 8;
            public const int BuscarArtiuclo = 9;
            public const int ConsultarPrecio = 10;
            public const int CambiarMinoristaMayorista = 11;
            public const int CerrarVentaBorradorACerrado = 12;//pasar a cerrado
            public const int Cobrar = 13;
            public const int lineaCredito = 14;
            public const int EiminarEnvaceDetalle = 15;
            public const int leerCodigoBalanza = 16;
            public const int AnularVenta = 17;
        ...
        public abstract class Webservices
        {
            ...
            public static int TesoreriaCrearDepositoBancariosValorPOS = 105;
        ...
        #region TipoFormulaArticulos
        public abstract class TipoFormulaArticulos
        {
        ...
        #endregion TipoFormulaArticulos
