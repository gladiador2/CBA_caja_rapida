// <fileinfo name="ALARMASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ALARMASRow"/> that 
	/// represents a record in the <c>ALARMAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ALARMASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ALARMASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ALARMASRow_Base"/> class.
		/// </summary>
		public ALARMASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ALARMASRow_Base original)
		{
