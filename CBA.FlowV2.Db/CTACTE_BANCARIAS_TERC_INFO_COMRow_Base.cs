// <fileinfo name="CTACTE_BANCARIAS_TERC_INFO_COMRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_BANCARIAS_TERC_INFO_COMRow"/> that 
	/// represents a record in the <c>CTACTE_BANCARIAS_TERC_INFO_COM</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_BANCARIAS_TERC_INFO_COMRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_BANCARIAS_TERC_INFO_COMRow_Base
	{
		private decimal _id;
		...
		private string _banco_cuenta;
		private decimal _moneda_id;
		private string _moneda_nombre;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_BANCARIAS_TERC_INFO_COMRow_Base"/> class.
		/// </summary>
		public CTACTE_BANCARIAS_TERC_INFO_COMRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_BANCARIAS_TERC_INFO_COMRow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.CTACTE_BANCO_ID != original.CTACTE_BANCO_ID) return true;
			if (this.BANCO != original.BANCO) return true;
			...
			if (this.BANCO_CUENTA != original.BANCO_CUENTA) return true;
		...
		/// <summary>
		/// Gets or sets the <c>BANCO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BANCO</c> column value.</value>
		public string BANCO
		{
			get { return _banco; }
			set { _banco = value; }
		...
		/// <summary>
		/// Gets or sets the <c>BANCO_CUENTA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BANCO_CUENTA</c> column value.</value>
		public string BANCO_CUENTA
		{
			get { return _banco_cuenta; }
			set { _banco_cuenta = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@BANCO_CUENTA=");
			dynStr.Append(BANCO_CUENTA);
	...
	} // End of CTACTE_BANCARIAS_TERC_INFO_COMRow_Base class
} // End of namespace
