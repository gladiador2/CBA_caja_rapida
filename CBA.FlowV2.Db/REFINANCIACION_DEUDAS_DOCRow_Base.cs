// <fileinfo name="REFINANCIACION_DEUDAS_DOCRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="REFINANCIACION_DEUDAS_DOCRow"/> that 
	/// represents a record in the <c>REFINANCIACION_DEUDAS_DOC</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="REFINANCIACION_DEUDAS_DOCRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class REFINANCIACION_DEUDAS_DOCRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="REFINANCIACION_DEUDAS_DOCRow_Base"/> class.
		/// </summary>
		public REFINANCIACION_DEUDAS_DOCRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(REFINANCIACION_DEUDAS_DOCRow_Base original)
		{
	...
	} // End of REFINANCIACION_DEUDAS_DOCRow_Base class
} // End of namespace
