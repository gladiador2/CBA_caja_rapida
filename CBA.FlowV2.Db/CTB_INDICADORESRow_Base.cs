// <fileinfo name="CTB_INDICADORESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_INDICADORESRow"/> that 
	/// represents a record in the <c>CTB_INDICADORES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_INDICADORESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_INDICADORESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_INDICADORESRow_Base"/> class.
		/// </summary>
		public CTB_INDICADORESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_INDICADORESRow_Base original)
		{
	...
	} // End of CTB_INDICADORESRow_Base class
} // End of namespace
