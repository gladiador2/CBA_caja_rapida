// <fileinfo name="COPARNRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="COPARNRow"/> that 
	/// represents a record in the <c>COPARN</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="COPARNRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class COPARNRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="COPARNRow_Base"/> class.
		/// </summary>
		public COPARNRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(COPARNRow_Base original)
		{
