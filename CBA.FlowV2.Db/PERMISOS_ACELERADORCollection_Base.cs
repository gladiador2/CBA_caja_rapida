// <fileinfo name="PERMISOS_ACELERADORCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PERMISOS_ACELERADORCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="PERMISOS_ACELERADORCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PERMISOS_ACELERADORCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PERMISOS_ACELERADORCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public PERMISOS_ACELERADORCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>PERMISOS_ACELERADOR</c> view.
		/// </summary>
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		public virtual PERMISOS_ACELERADORRow[] GetAll()
		{
		...
		/// includes all records from the <c>PERMISOS_ACELERADOR</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>PERMISOS_ACELERADOR</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="PERMISOS_ACELERADORRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="PERMISOS_ACELERADORRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public PERMISOS_ACELERADORRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			PERMISOS_ACELERADORRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PERMISOS_ACELERADORRow"/> objects that 
		...
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		public PERMISOS_ACELERADORRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		public virtual PERMISOS_ACELERADORRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.PERMISOS_ACELERADOR";
		...
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		protected PERMISOS_ACELERADORRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		protected PERMISOS_ACELERADORRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="PERMISOS_ACELERADORRow"/> objects.</returns>
		protected virtual PERMISOS_ACELERADORRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					PERMISOS_ACELERADORRow record = new PERMISOS_ACELERADORRow();
			...
			return (PERMISOS_ACELERADORRow[])(recordList.ToArray(typeof(PERMISOS_ACELERADORRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="PERMISOS_ACELERADORRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="PERMISOS_ACELERADORRow"/> object.</returns>
		protected virtual PERMISOS_ACELERADORRow MapRow(DataRow row)
		{
			PERMISOS_ACELERADORRow mappedObject = new PERMISOS_ACELERADORRow();
		...
		/// the <c>PERMISOS_ACELERADOR</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "PERMISOS_ACELERADOR";
			DataColumn dataColumn;
	...
	} // End of PERMISOS_ACELERADORCollection_Base class
}  // End of namespace
