// <fileinfo name="CUSTODIA_VALORESCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CUSTODIA_VALORESCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CUSTODIA_VALORESCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CUSTODIA_VALORESCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CUSTODIA_VALORESCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CUSTODIA_VALORESCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetAll()
		{
		...
		/// includes all records from the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CUSTODIA_VALORESRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CUSTODIA_VALORESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CUSTODIA_VALORESRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CUSTODIA_VALORESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects that 
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public CUSTODIA_VALORESRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CUSTODIA_VALORES";
		...
		/// <summary>
		/// Gets <see cref="CUSTODIA_VALORESRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="CUSTODIA_VALORESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual CUSTODIA_VALORESRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			CUSTODIA_VALORESRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public CUSTODIA_VALORESRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// return records by the <c>FK_CUSTODIA_VALORES_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_BCO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_banco_id">The <c>CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByCTACTE_BANCO_ID(decimal ctacte_banco_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_BCO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_banco_id">The <c>CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_CAJA</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByCTACTE_CAJA_TESORERIA_ID(decimal ctacte_caja_tesoreria_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_CAJA</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_CTACTE_BAN</c> foreign key.
		/// </summary>
		/// <param name="ctacte_bancaria_id">The <c>CTACTE_BANCARIA_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public CUSTODIA_VALORESRow[] GetByCTACTE_BANCARIA_ID(decimal ctacte_bancaria_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByCTACTE_BANCARIA_ID(decimal ctacte_bancaria_id, bool ctacte_bancaria_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_CTACTE_BAN</c> foreign key.
		/// </summary>
		/// <param name="ctacte_bancaria_id">The <c>CTACTE_BANCARIA_ID</c> column value.</param>
		/// <param name="ctacte_bancaria_idNull">true if the method ignores the ctacte_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORESRow"/> objects 
		/// by the <c>FK_CUSTODIA_VALORES_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		public virtual CUSTODIA_VALORESRow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VALORES_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORESRow"/> object to be inserted.</param>
		public virtual void Insert(CUSTODIA_VALORESRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.CUSTODIA_VALORES (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
				...
				"PORCENTAJE_IMPUESTO, " +
				"TOTAL_IMPUESTO, " +
				"PORCENTAJE_INTERES_ACORDADO, " +
				"TOTAL_INTERES_ACORDADO, " +
				"OBSERVACION" +
				") VALUES (" +
				...
				_db.CreateSqlParameterName("PORCENTAJE_INTERES_ACORDADO") + ", " +
				_db.CreateSqlParameterName("TOTAL_INTERES_ACORDADO") + ", " +
			...
			AddParameter(cmd, "TOTAL_DOCUMENTOS",
				value.IsTOTAL_DOCUMENTOSNull ? DBNull.Value : (object)value.TOTAL_DOCUMENTOS);
			...
			AddParameter(cmd, "TOTAL_COSTO", value.TOTAL_COSTO);
			AddParameter(cmd, "PORCENTAJE_IMPUESTO", value.PORCENTAJE_IMPUESTO);
			AddParameter(cmd, "TOTAL_IMPUESTO", value.TOTAL_IMPUESTO);
			AddParameter(cmd, "PORCENTAJE_INTERES_ACORDADO", value.PORCENTAJE_INTERES_ACORDADO);
			AddParameter(cmd, "TOTAL_INTERES_ACORDADO", value.TOTAL_INTERES_ACORDADO);
			AddParameter(cmd, "OBSERVACION", value.OBSERVACION);
			cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Updates a record in the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORESRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(CUSTODIA_VALORESRow value)
		{
			
			string sqlStr = "UPDATE TRC.CUSTODIA_VALORES SET " +
				...
				"PORCENTAJE_INTERES_ACORDADO=" + _db.CreateSqlParameterName("PORCENTAJE_INTERES_ACORDADO") + ", " +
				"TOTAL_INTERES_ACORDADO=" + _db.CreateSqlParameterName("TOTAL_INTERES_ACORDADO") + ", " +
		...
		/// <summary>
		/// Updates the <c>CUSTODIA_VALORES</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>CUSTODIA_VALORES</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORESRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(CUSTODIA_VALORESRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>CUSTODIA_VALORES</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_BCO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_banco_id">The <c>CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_BCO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_banco_id">The <c>CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_CAJA</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_CAJA</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_CTACTE_BAN</c> foreign key.
		/// </summary>
		/// <param name="ctacte_bancaria_id">The <c>CTACTE_BANCARIA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_CTACTE_BAN</c> foreign key.
		/// </summary>
		/// <param name="ctacte_bancaria_id">The <c>CTACTE_BANCARIA_ID</c> column value.</param>
		/// <param name="ctacte_bancaria_idNull">true if the method ignores the ctacte_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES</c> table using the 
		/// <c>FK_CUSTODIA_VALORES_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VALORES_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>CUSTODIA_VALORES</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>CUSTODIA_VALORES</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.CUSTODIA_VALORES";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		protected CUSTODIA_VALORESRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		protected CUSTODIA_VALORESRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORESRow"/> objects.</returns>
		protected virtual CUSTODIA_VALORESRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CUSTODIA_VALORESRow record = new CUSTODIA_VALORESRow();
			...
			return (CUSTODIA_VALORESRow[])(recordList.ToArray(typeof(CUSTODIA_VALORESRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CUSTODIA_VALORESRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CUSTODIA_VALORESRow"/> object.</returns>
		protected virtual CUSTODIA_VALORESRow MapRow(DataRow row)
		{
			CUSTODIA_VALORESRow mappedObject = new CUSTODIA_VALORESRow();
		...
		/// the <c>CUSTODIA_VALORES</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CUSTODIA_VALORES";
			DataColumn dataColumn;
	...
	} // End of CUSTODIA_VALORESCollection_Base class
}  // End of namespace
