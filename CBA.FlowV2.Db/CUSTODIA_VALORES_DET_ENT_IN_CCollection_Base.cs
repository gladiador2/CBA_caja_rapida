// <fileinfo name="CUSTODIA_VALORES_DET_ENT_IN_CCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CUSTODIA_VALORES_DET_ENT_IN_CCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CUSTODIA_VALORES_DET_ENT_IN_CCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CUSTODIA_VALORES_DET_ENT_IN_CCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CUSTODIA_VALORES_DET_ENT_IN_CCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CUSTODIA_VALORES_DET_ENT_IN_CCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CUSTODIA_VALORES_DET_ENT_IN_C</c> view.
		/// </summary>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENT_IN_CRow[] GetAll()
		{
		...
		/// includes all records from the <c>CUSTODIA_VALORES_DET_ENT_IN_C</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>CUSTODIA_VALORES_DET_ENT_IN_C</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CUSTODIA_VALORES_DET_ENT_IN_CRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CUSTODIA_VALORES_DET_ENT_IN_CRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects that 
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		public CUSTODIA_VALORES_DET_ENT_IN_CRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENT_IN_CRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CUSTODIA_VALORES_DET_ENT_IN_C";
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		protected CUSTODIA_VALORES_DET_ENT_IN_CRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		protected CUSTODIA_VALORES_DET_ENT_IN_CRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> objects.</returns>
		protected virtual CUSTODIA_VALORES_DET_ENT_IN_CRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CUSTODIA_VALORES_DET_ENT_IN_CRow record = new CUSTODIA_VALORES_DET_ENT_IN_CRow();
			...
			return (CUSTODIA_VALORES_DET_ENT_IN_CRow[])(recordList.ToArray(typeof(CUSTODIA_VALORES_DET_ENT_IN_CRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CUSTODIA_VALORES_DET_ENT_IN_CRow"/> object.</returns>
		protected virtual CUSTODIA_VALORES_DET_ENT_IN_CRow MapRow(DataRow row)
		{
			CUSTODIA_VALORES_DET_ENT_IN_CRow mappedObject = new CUSTODIA_VALORES_DET_ENT_IN_CRow();
		...
		/// the <c>CUSTODIA_VALORES_DET_ENT_IN_C</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CUSTODIA_VALORES_DET_ENT_IN_C";
			DataColumn dataColumn;
	...
	} // End of CUSTODIA_VALORES_DET_ENT_IN_CCollection_Base class
}  // End of namespace
