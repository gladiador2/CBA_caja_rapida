// <fileinfo name="STOCK_TRANSFERENCIACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSFERENCIACollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="STOCK_TRANSFERENCIACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSFERENCIACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSFERENCIACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public STOCK_TRANSFERENCIACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetAll()
		{
		...
		/// includes all records from the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="STOCK_TRANSFERENCIARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="STOCK_TRANSFERENCIARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public STOCK_TRANSFERENCIARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			STOCK_TRANSFERENCIARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects that 
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.STOCK_TRANSFERENCIA";
		...
		/// <summary>
		/// Gets <see cref="STOCK_TRANSFERENCIARow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="STOCK_TRANSFERENCIARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual STOCK_TRANSFERENCIARow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			STOCK_TRANSFERENCIARow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// return records by the <c>FK_STOCK_TRANS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_CASO_ASOC_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_asociado_id">The <c>CASO_ASOCIADO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByCASO_ASOCIADO_ID(decimal caso_asociado_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByCASO_ASOCIADO_ID(decimal caso_asociado_id, bool caso_asociado_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_CASO_ASOC_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_asociado_id">The <c>CASO_ASOCIADO_ID</c> column value.</param>
		/// <param name="caso_asociado_idNull">true if the method ignores the caso_asociado_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByCASO_ID(decimal caso_id, bool caso_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <param name="caso_idNull">true if the method ignores the caso_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByDEPOSITO_DESTINO_ID(decimal deposito_destino_id)
		{
			return MapRecords(CreateGetByDEPOSITO_DESTINO_IDCommand(deposito_destino_id));
		}
		...
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByDEPOSITO_DESTINO_IDAsDataTable(decimal deposito_destino_id)
		{
			return MapRecordsToDataTable(CreateGetByDEPOSITO_DESTINO_IDCommand(deposito_destino_id));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByDEPOSITO_DESTINO_IDCommand(decimal deposito_destino_id)
		{
			string whereSql = "";
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_DEPO_ORIG</c> foreign key.
		/// </summary>
		/// <param name="deposito_origen_id">The <c>DEPOSITO_ORIGEN_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByDEPOSITO_ORIGEN_ID(decimal deposito_origen_id)
		{
			return MapRecords(CreateGetByDEPOSITO_ORIGEN_IDCommand(deposito_origen_id));
		}
		...
		/// <param name="deposito_origen_id">The <c>DEPOSITO_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByDEPOSITO_ORIGEN_IDAsDataTable(decimal deposito_origen_id)
		{
			return MapRecordsToDataTable(CreateGetByDEPOSITO_ORIGEN_IDCommand(deposito_origen_id));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_DEPO_ORIG</c> foreign key.
		/// </summary>
		/// <param name="deposito_origen_id">The <c>DEPOSITO_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByDEPOSITO_ORIGEN_IDCommand(decimal deposito_origen_id)
		{
			string whereSql = "";
			whereSql += "DEPOSITO_ORIGEN_ID=" + _db.CreateSqlParameterName("DEPOSITO_ORIGEN_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "DEPOSITO_ORIGEN_ID", deposito_origen_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_FUNC_ACO1</c> foreign key.
		/// </summary>
		/// <param name="acompanante1_id">The <c>ACOMPANANTE1_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByACOMPANANTE1_ID(decimal acompanante1_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByACOMPANANTE1_ID(decimal acompanante1_id, bool acompanante1_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_FUNC_ACO1</c> foreign key.
		/// </summary>
		/// <param name="acompanante1_id">The <c>ACOMPANANTE1_ID</c> column value.</param>
		/// <param name="acompanante1_idNull">true if the method ignores the acompanante1_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_FUNC_ACO2</c> foreign key.
		/// </summary>
		/// <param name="acompanante2_id">The <c>ACOMPANANTE2_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByACOMPANANTE2_ID(decimal acompanante2_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByACOMPANANTE2_ID(decimal acompanante2_id, bool acompanante2_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_FUNC_ACO2</c> foreign key.
		/// </summary>
		/// <param name="acompanante2_id">The <c>ACOMPANANTE2_ID</c> column value.</param>
		/// <param name="acompanante2_idNull">true if the method ignores the acompanante2_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_FUNC_ACO3</c> foreign key.
		/// </summary>
		/// <param name="acompanante3_id">The <c>ACOMPANANTE3_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByACOMPANANTE3_ID(decimal acompanante3_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByACOMPANANTE3_ID(decimal acompanante3_id, bool acompanante3_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_FUNC_ACO3</c> foreign key.
		/// </summary>
		/// <param name="acompanante3_id">The <c>ACOMPANANTE3_ID</c> column value.</param>
		/// <param name="acompanante3_idNull">true if the method ignores the acompanante3_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_FUNC_CHOF</c> foreign key.
		/// </summary>
		/// <param name="funcionario_chofer_id">The <c>FUNCIONARIO_CHOFER_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByFUNCIONARIO_CHOFER_ID(decimal funcionario_chofer_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByFUNCIONARIO_CHOFER_ID(decimal funcionario_chofer_id, bool funcionario_chofer_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_FUNC_CHOF</c> foreign key.
		/// </summary>
		/// <param name="funcionario_chofer_id">The <c>FUNCIONARIO_CHOFER_ID</c> column value.</param>
		/// <param name="funcionario_chofer_idNull">true if the method ignores the funcionario_chofer_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByMONEDA_ID(decimal moneda_id, bool moneda_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <param name="moneda_idNull">true if the method ignores the moneda_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_PROV_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByPROVEEDOR_ID(decimal proveedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByPROVEEDOR_ID(decimal proveedor_id, bool proveedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_PROV_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_REM_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="remision_autonumeracion_id">The <c>REMISION_AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByREMISION_AUTONUMERACION_ID(decimal remision_autonumeracion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByREMISION_AUTONUMERACION_ID(decimal remision_autonumeracion_id, bool remision_autonumeracion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_REM_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="remision_autonumeracion_id">The <c>REMISION_AUTONUMERACION_ID</c> column value.</param>
		/// <param name="remision_autonumeracion_idNull">true if the method ignores the remision_autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetBySUCURSAL_DESTINO_ID(decimal sucursal_destino_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_SUC_ORIG</c> foreign key.
		/// </summary>
		/// <param name="sucursal_origen_id">The <c>SUCURSAL_ORIGEN_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetBySUCURSAL_ORIGEN_ID(decimal sucursal_origen_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_SUC_ORIG</c> foreign key.
		/// </summary>
		/// <param name="sucursal_origen_id">The <c>SUCURSAL_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIARow"/> objects 
		/// by the <c>FK_STOCK_TRANS_TEXTO_PREDEF_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public STOCK_TRANSFERENCIARow[] GetByTEXTO_PREDEFINIDO_ID(decimal texto_predefinido_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIARow[] GetByTEXTO_PREDEFINIDO_ID(decimal texto_predefinido_id, bool texto_predefinido_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STOCK_TRANS_TEXTO_PREDEF_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <param name="texto_predefinido_idNull">true if the method ignores the texto_predefinido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIARow"/> object to be inserted.</param>
		public virtual void Insert(STOCK_TRANSFERENCIARow value)
		{
						
			string sqlStr = "INSERT INTO TRC.STOCK_TRANSFERENCIA (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ORIGEN_ID, " +
				"DEPOSITO_ORIGEN_ID, " +
			...
			AddParameter(cmd, "DEPOSITO_ORIGEN_ID", value.DEPOSITO_ORIGEN_ID);
			AddParameter(cmd, "SUCURSAL_DESTINO_ID", value.SUCURSAL_DESTINO_ID);
			AddParameter(cmd, "DEPOSITO_DESTINO_ID", value.DEPOSITO_DESTINO_ID);
		...
		/// <summary>
		/// Updates a record in the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIARow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(STOCK_TRANSFERENCIARow value)
		{
			
			string sqlStr = "UPDATE TRC.STOCK_TRANSFERENCIA SET " +
		...
		/// <summary>
		/// Updates the <c>STOCK_TRANSFERENCIA</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>STOCK_TRANSFERENCIA</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIARow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(STOCK_TRANSFERENCIARow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>STOCK_TRANSFERENCIA</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_CASO_ASOC_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_asociado_id">The <c>CASO_ASOCIADO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_CASO_ASOC_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_asociado_id">The <c>CASO_ASOCIADO_ID</c> column value.</param>
		/// <param name="caso_asociado_idNull">true if the method ignores the caso_asociado_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <param name="caso_idNull">true if the method ignores the caso_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByDEPOSITO_DESTINO_ID(decimal deposito_destino_id)
		{
			return CreateDeleteByDEPOSITO_DESTINO_IDCommand(deposito_destino_id).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByDEPOSITO_DESTINO_IDCommand(decimal deposito_destino_id)
		{
			string whereSql = "";
			whereSql += "DEPOSITO_DESTINO_ID=" + _db.CreateSqlParameterName("DEPOSITO_DESTINO_ID");
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_DEPO_ORIG</c> foreign key.
		/// </summary>
		/// <param name="deposito_origen_id">The <c>DEPOSITO_ORIGEN_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByDEPOSITO_ORIGEN_ID(decimal deposito_origen_id)
		{
			return CreateDeleteByDEPOSITO_ORIGEN_IDCommand(deposito_origen_id).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_DEPO_ORIG</c> foreign key.
		/// </summary>
		/// <param name="deposito_origen_id">The <c>DEPOSITO_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByDEPOSITO_ORIGEN_IDCommand(decimal deposito_origen_id)
		{
			string whereSql = "";
			whereSql += "DEPOSITO_ORIGEN_ID=" + _db.CreateSqlParameterName("DEPOSITO_ORIGEN_ID");
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_FUNC_ACO1</c> foreign key.
		/// </summary>
		/// <param name="acompanante1_id">The <c>ACOMPANANTE1_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_FUNC_ACO1</c> foreign key.
		/// </summary>
		/// <param name="acompanante1_id">The <c>ACOMPANANTE1_ID</c> column value.</param>
		/// <param name="acompanante1_idNull">true if the method ignores the acompanante1_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_FUNC_ACO2</c> foreign key.
		/// </summary>
		/// <param name="acompanante2_id">The <c>ACOMPANANTE2_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_FUNC_ACO2</c> foreign key.
		/// </summary>
		/// <param name="acompanante2_id">The <c>ACOMPANANTE2_ID</c> column value.</param>
		/// <param name="acompanante2_idNull">true if the method ignores the acompanante2_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_FUNC_ACO3</c> foreign key.
		/// </summary>
		/// <param name="acompanante3_id">The <c>ACOMPANANTE3_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_FUNC_ACO3</c> foreign key.
		/// </summary>
		/// <param name="acompanante3_id">The <c>ACOMPANANTE3_ID</c> column value.</param>
		/// <param name="acompanante3_idNull">true if the method ignores the acompanante3_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_FUNC_CHOF</c> foreign key.
		/// </summary>
		/// <param name="funcionario_chofer_id">The <c>FUNCIONARIO_CHOFER_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_FUNC_CHOF</c> foreign key.
		/// </summary>
		/// <param name="funcionario_chofer_id">The <c>FUNCIONARIO_CHOFER_ID</c> column value.</param>
		/// <param name="funcionario_chofer_idNull">true if the method ignores the funcionario_chofer_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <param name="moneda_idNull">true if the method ignores the moneda_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_PROV_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_PROV_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_REM_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="remision_autonumeracion_id">The <c>REMISION_AUTONUMERACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_REM_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="remision_autonumeracion_id">The <c>REMISION_AUTONUMERACION_ID</c> column value.</param>
		/// <param name="remision_autonumeracion_idNull">true if the method ignores the remision_autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_SUC_ORIG</c> foreign key.
		/// </summary>
		/// <param name="sucursal_origen_id">The <c>SUCURSAL_ORIGEN_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_SUC_ORIG</c> foreign key.
		/// </summary>
		/// <param name="sucursal_origen_id">The <c>SUCURSAL_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA</c> table using the 
		/// <c>FK_STOCK_TRANS_TEXTO_PREDEF_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STOCK_TRANS_TEXTO_PREDEF_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <param name="texto_predefinido_idNull">true if the method ignores the texto_predefinido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>STOCK_TRANSFERENCIA</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>STOCK_TRANSFERENCIA</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.STOCK_TRANSFERENCIA";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		protected STOCK_TRANSFERENCIARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		protected STOCK_TRANSFERENCIARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIARow"/> objects.</returns>
		protected virtual STOCK_TRANSFERENCIARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					STOCK_TRANSFERENCIARow record = new STOCK_TRANSFERENCIARow();
			...
			return (STOCK_TRANSFERENCIARow[])(recordList.ToArray(typeof(STOCK_TRANSFERENCIARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="STOCK_TRANSFERENCIARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="STOCK_TRANSFERENCIARow"/> object.</returns>
		protected virtual STOCK_TRANSFERENCIARow MapRow(DataRow row)
		{
			STOCK_TRANSFERENCIARow mappedObject = new STOCK_TRANSFERENCIARow();
		...
		/// the <c>STOCK_TRANSFERENCIA</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "STOCK_TRANSFERENCIA";
			DataColumn dataColumn;
	...
	} // End of STOCK_TRANSFERENCIACollection_Base class
}  // End of namespace
