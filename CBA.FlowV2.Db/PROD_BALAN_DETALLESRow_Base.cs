// <fileinfo name="PROD_BALAN_DETALLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PROD_BALAN_DETALLESRow"/> that 
	/// represents a record in the <c>PROD_BALAN_DETALLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PROD_BALAN_DETALLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PROD_BALAN_DETALLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PROD_BALAN_DETALLESRow_Base"/> class.
		/// </summary>
		public PROD_BALAN_DETALLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PROD_BALAN_DETALLESRow_Base original)
		{
	...
	} // End of PROD_BALAN_DETALLESRow_Base class
} // End of namespace
