// <fileinfo name="CONTENEDORES_MOVIMIENTOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CONTENEDORES_MOVIMIENTOSRow"/> that 
	/// represents a record in the <c>CONTENEDORES_MOVIMIENTOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CONTENEDORES_MOVIMIENTOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CONTENEDORES_MOVIMIENTOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CONTENEDORES_MOVIMIENTOSRow_Base"/> class.
		/// </summary>
		public CONTENEDORES_MOVIMIENTOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CONTENEDORES_MOVIMIENTOSRow_Base original)
		{
	...
	} // End of CONTENEDORES_MOVIMIENTOSRow_Base class
} // End of namespace
