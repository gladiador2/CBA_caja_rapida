// <fileinfo name="ORDENES_PAGORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ORDENES_PAGORow"/> that 
	/// represents a record in the <c>ORDENES_PAGO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ORDENES_PAGORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ORDENES_PAGORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ORDENES_PAGORow_Base"/> class.
		/// </summary>
		public ORDENES_PAGORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ORDENES_PAGORow_Base original)
		{
	...
	} // End of ORDENES_PAGORow_Base class
} // End of namespace
