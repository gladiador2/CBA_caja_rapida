// <fileinfo name="PRE_EMBARQUE_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PRE_EMBARQUE_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>PRE_EMBARQUE_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PRE_EMBARQUE_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PRE_EMBARQUE_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _armador_nombre;

		/// <summary>
		/// Initializes a new instance of the <see cref="PRE_EMBARQUE_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public PRE_EMBARQUE_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PRE_EMBARQUE_INFO_COMPLETARow_Base original)
		{
			...
			if (this.BUQUE_EMPRESA != original.BUQUE_EMPRESA) return true;
			...
			if (this.ARMADOR_NOMBRE != original.ARMADOR_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>BUQUE_EMPRESA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BUQUE_EMPRESA</c> column value.</value>
		public string BUQUE_EMPRESA
		{
			get { return _buque_empresa; }
			set { _buque_empresa = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ARMADOR_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ARMADOR_NOMBRE</c> column value.</value>
		public string ARMADOR_NOMBRE
		{
			get { return _armador_nombre; }
			set { _armador_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@BUQUE_EMPRESA=");
			dynStr.Append(BUQUE_EMPRESA);
			...
			dynStr.Append("@CBA@ARMADOR_NOMBRE=");
			dynStr.Append(ARMADOR_NOMBRE);
			return dynStr.ToString();
		}
	} // End of PRE_EMBARQUE_INFO_COMPLETARow_Base class
} // End of namespace
