// <fileinfo name="CTACTE_CHEQUES_GIR_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CHEQUES_GIR_INFO_COMPLCollection_Base
	{
		// Constants
		...
		public const string CTACTE_BANCARIAS_NUMEROColumnName = "CTACTE_BANCARIAS_NUMERO";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CTACTE_CHEQUES_GIR_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CTACTE_CHEQUES_GIR_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		public virtual CTACTE_CHEQUES_GIR_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>CTACTE_CHEQUES_GIR_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>CTACTE_CHEQUES_GIR_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CTACTE_CHEQUES_GIR_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CTACTE_CHEQUES_GIR_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		public CTACTE_CHEQUES_GIR_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		public virtual CTACTE_CHEQUES_GIR_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CTACTE_CHEQUES_GIR_INFO_COMPL";
		...
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		protected CTACTE_CHEQUES_GIR_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		protected CTACTE_CHEQUES_GIR_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> objects.</returns>
		protected virtual CTACTE_CHEQUES_GIR_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int ctacte_bancarias_numeroColumnIndex = reader.GetOrdinal("CTACTE_BANCARIAS_NUMERO");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CTACTE_CHEQUES_GIR_INFO_COMPLRow record = new CTACTE_CHEQUES_GIR_INFO_COMPLRow();
					...
					record.CTACTE_BANCARIAS_NUMERO = Convert.ToString(reader.GetValue(ctacte_bancarias_numeroColumnIndex));
			...
			return (CTACTE_CHEQUES_GIR_INFO_COMPLRow[])(recordList.ToArray(typeof(CTACTE_CHEQUES_GIR_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CTACTE_CHEQUES_GIR_INFO_COMPLRow"/> object.</returns>
		protected virtual CTACTE_CHEQUES_GIR_INFO_COMPLRow MapRow(DataRow row)
		{
			CTACTE_CHEQUES_GIR_INFO_COMPLRow mappedObject = new CTACTE_CHEQUES_GIR_INFO_COMPLRow();
			...
			// Column "CTACTE_BANCARIAS_NUMERO"
			dataColumn = dataTable.Columns["CTACTE_BANCARIAS_NUMERO"];
			if(!row.IsNull(dataColumn))
				mappedObject.CTACTE_BANCARIAS_NUMERO = (string)row[dataColumn];
		...
		/// the <c>CTACTE_CHEQUES_GIR_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CTACTE_CHEQUES_GIR_INFO_COMPL";
			DataColumn dataColumn;
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("CTACTE_BANCARIAS_NUMERO", typeof(string));
	...
	} // End of CTACTE_CHEQUES_GIR_INFO_COMPLCollection_Base class
}  // End of namespace
