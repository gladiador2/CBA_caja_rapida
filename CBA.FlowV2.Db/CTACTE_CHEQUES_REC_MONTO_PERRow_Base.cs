// <fileinfo name="CTACTE_CHEQUES_REC_MONTO_PERRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CHEQUES_REC_MONTO_PERRow"/> that 
	/// represents a record in the <c>CTACTE_CHEQUES_REC_MONTO_PER</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_CHEQUES_REC_MONTO_PERRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CHEQUES_REC_MONTO_PERRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CHEQUES_REC_MONTO_PERRow_Base"/> class.
		/// </summary>
		public CTACTE_CHEQUES_REC_MONTO_PERRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_CHEQUES_REC_MONTO_PERRow_Base original)
		{
	...
	} // End of CTACTE_CHEQUES_REC_MONTO_PERRow_Base class
} // End of namespace
