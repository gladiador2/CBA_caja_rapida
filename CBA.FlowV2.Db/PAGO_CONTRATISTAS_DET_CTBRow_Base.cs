// <fileinfo name="PAGO_CONTRATISTAS_DET_CTBRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PAGO_CONTRATISTAS_DET_CTBRow"/> that 
	/// represents a record in the <c>PAGO_CONTRATISTAS_DET_CTB</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PAGO_CONTRATISTAS_DET_CTBRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PAGO_CONTRATISTAS_DET_CTBRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PAGO_CONTRATISTAS_DET_CTBRow_Base"/> class.
		/// </summary>
		public PAGO_CONTRATISTAS_DET_CTBRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PAGO_CONTRATISTAS_DET_CTBRow_Base original)
		{
	...
	} // End of PAGO_CONTRATISTAS_DET_CTBRow_Base class
} // End of namespace
