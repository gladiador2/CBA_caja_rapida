// <fileinfo name="REGLAS_LOGINRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="REGLAS_LOGINRow"/> that 
	/// represents a record in the <c>REGLAS_LOGIN</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="REGLAS_LOGINRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class REGLAS_LOGINRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="REGLAS_LOGINRow_Base"/> class.
		/// </summary>
		public REGLAS_LOGINRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(REGLAS_LOGINRow_Base original)
		{
	...
	} // End of REGLAS_LOGINRow_Base class
} // End of namespace
