// <fileinfo name="TIPOS_EVENTO_CALENDARIORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TIPOS_EVENTO_CALENDARIORow"/> that 
	/// represents a record in the <c>TIPOS_EVENTO_CALENDARIO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="TIPOS_EVENTO_CALENDARIORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TIPOS_EVENTO_CALENDARIORow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TIPOS_EVENTO_CALENDARIORow_Base"/> class.
		/// </summary>
		public TIPOS_EVENTO_CALENDARIORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(TIPOS_EVENTO_CALENDARIORow_Base original)
		{
	...
	} // End of TIPOS_EVENTO_CALENDARIORow_Base class
} // End of namespace
