// <fileinfo name="ARTICULOS_COMBOS_INFO_COMPLETACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_COMBOS_INFO_COMPLETACollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="ARTICULOS_COMBOS_INFO_COMPLETACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_COMBOS_INFO_COMPLETACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_COMBOS_INFO_COMPLETACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public ARTICULOS_COMBOS_INFO_COMPLETACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>ARTICULOS_COMBOS_INFO_COMPLETA</c> view.
		/// </summary>
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		public virtual ARTICULOS_COMBOS_INFO_COMPLETARow[] GetAll()
		{
		...
		/// includes all records from the <c>ARTICULOS_COMBOS_INFO_COMPLETA</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>ARTICULOS_COMBOS_INFO_COMPLETA</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public ARTICULOS_COMBOS_INFO_COMPLETARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			ARTICULOS_COMBOS_INFO_COMPLETARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects that 
		...
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		public ARTICULOS_COMBOS_INFO_COMPLETARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		public virtual ARTICULOS_COMBOS_INFO_COMPLETARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.ARTICULOS_COMBOS_INFO_COMPLETA";
		...
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		protected ARTICULOS_COMBOS_INFO_COMPLETARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		protected ARTICULOS_COMBOS_INFO_COMPLETARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> objects.</returns>
		protected virtual ARTICULOS_COMBOS_INFO_COMPLETARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					ARTICULOS_COMBOS_INFO_COMPLETARow record = new ARTICULOS_COMBOS_INFO_COMPLETARow();
			...
			return (ARTICULOS_COMBOS_INFO_COMPLETARow[])(recordList.ToArray(typeof(ARTICULOS_COMBOS_INFO_COMPLETARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> object.</returns>
		protected virtual ARTICULOS_COMBOS_INFO_COMPLETARow MapRow(DataRow row)
		{
			ARTICULOS_COMBOS_INFO_COMPLETARow mappedObject = new ARTICULOS_COMBOS_INFO_COMPLETARow();
		...
		/// the <c>ARTICULOS_COMBOS_INFO_COMPLETA</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "ARTICULOS_COMBOS_INFO_COMPLETA";
			DataColumn dataColumn;
	...
	} // End of ARTICULOS_COMBOS_INFO_COMPLETACollection_Base class
}  // End of namespace
