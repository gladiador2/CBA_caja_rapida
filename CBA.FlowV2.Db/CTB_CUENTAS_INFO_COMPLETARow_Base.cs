// <fileinfo name="CTB_CUENTAS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_CUENTAS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>CTB_CUENTAS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_CUENTAS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_CUENTAS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _ctb_cuenta_madre_nombre;
		...
		private string _codigo_completo;
		...
		private string _es_cuenta_de_resultados;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_CUENTAS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public CTB_CUENTAS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_CUENTAS_INFO_COMPLETARow_Base original)
		{
			...
			if (this.CTB_CUENTA_MADRE_NOMBRE != original.CTB_CUENTA_MADRE_NOMBRE) return true;
			...
			if (this.CODIGO_COMPLETO != original.CODIGO_COMPLETO) return true;
			...
			if (this.ES_CUENTA_DE_RESULTADOS != original.ES_CUENTA_DE_RESULTADOS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CTB_CUENTA_MADRE_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTB_CUENTA_MADRE_NOMBRE</c> column value.</value>
		public string CTB_CUENTA_MADRE_NOMBRE
		{
			get { return _ctb_cuenta_madre_nombre; }
			set { _ctb_cuenta_madre_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CODIGO_COMPLETO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CODIGO_COMPLETO</c> column value.</value>
		public string CODIGO_COMPLETO
		{
			get { return _codigo_completo; }
			set { _codigo_completo = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ES_CUENTA_DE_RESULTADOS</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ES_CUENTA_DE_RESULTADOS</c> column value.</value>
		public string ES_CUENTA_DE_RESULTADOS
		{
			get { return _es_cuenta_de_resultados; }
			set { _es_cuenta_de_resultados = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CTB_CUENTA_MADRE_NOMBRE=");
			dynStr.Append(CTB_CUENTA_MADRE_NOMBRE);
			...
			dynStr.Append("@CBA@CODIGO_COMPLETO=");
			dynStr.Append(CODIGO_COMPLETO);
			...
			dynStr.Append("@CBA@ES_CUENTA_DE_RESULTADOS=");
			dynStr.Append(ES_CUENTA_DE_RESULTADOS);
			return dynStr.ToString();
		}
	} // End of CTB_CUENTAS_INFO_COMPLETARow_Base class
} // End of namespace
