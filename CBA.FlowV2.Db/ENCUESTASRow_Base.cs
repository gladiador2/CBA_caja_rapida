// <fileinfo name="ENCUESTASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ENCUESTASRow"/> that 
	/// represents a record in the <c>ENCUESTAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ENCUESTASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ENCUESTASRow_Base
	{
		private decimal _id;
		...
		private string _para_personas;
		private string _para_funcionarios;
		private decimal _cantidad_preguntas;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ENCUESTASRow_Base"/> class.
		/// </summary>
		public ENCUESTASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ENCUESTASRow_Base original)
		{
			...
			if (this.PARA_PERSONAS != original.PARA_PERSONAS) return true;
			if (this.PARA_FUNCIONARIOS != original.PARA_FUNCIONARIOS) return true;
			if (this.CANTIDAD_PREGUNTAS != original.CANTIDAD_PREGUNTAS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>PARA_PERSONAS</c> column value.
		/// </summary>
		/// <value>The <c>PARA_PERSONAS</c> column value.</value>
		public string PARA_PERSONAS
		{
			get { return _para_personas; }
			set { _para_personas = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>PARA_FUNCIONARIOS</c> column value.
		/// </summary>
		/// <value>The <c>PARA_FUNCIONARIOS</c> column value.</value>
		public string PARA_FUNCIONARIOS
		{
			get { return _para_funcionarios; }
			set { _para_funcionarios = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CANTIDAD_PREGUNTAS</c> column value.
		/// </summary>
		/// <value>The <c>CANTIDAD_PREGUNTAS</c> column value.</value>
		public decimal CANTIDAD_PREGUNTAS
		{
			get { return _cantidad_preguntas; }
			set { _cantidad_preguntas = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@PARA_PERSONAS=");
			dynStr.Append(PARA_PERSONAS);
			dynStr.Append("@CBA@PARA_FUNCIONARIOS=");
			dynStr.Append(PARA_FUNCIONARIOS);
			dynStr.Append("@CBA@CANTIDAD_PREGUNTAS=");
			dynStr.Append(CANTIDAD_PREGUNTAS);
	...
	} // End of ENCUESTASRow_Base class
} // End of namespace
