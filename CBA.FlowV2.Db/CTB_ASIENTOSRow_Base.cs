// <fileinfo name="CTB_ASIENTOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_ASIENTOSRow"/> that 
	/// represents a record in the <c>CTB_ASIENTOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_ASIENTOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_ASIENTOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_ASIENTOSRow_Base"/> class.
		/// </summary>
		public CTB_ASIENTOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_ASIENTOSRow_Base original)
		{
	...
	} // End of CTB_ASIENTOSRow_Base class
} // End of namespace
