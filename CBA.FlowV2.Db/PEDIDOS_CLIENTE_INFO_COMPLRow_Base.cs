// <fileinfo name="PEDIDOS_CLIENTE_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PEDIDOS_CLIENTE_INFO_COMPLRow"/> that 
	/// represents a record in the <c>PEDIDOS_CLIENTE_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PEDIDOS_CLIENTE_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PEDIDOS_CLIENTE_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		private string _sucursal_venta;
		...
		private string _texto_obs_dpto_credito;
		private string _texto_obs_dpto_precios;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PEDIDOS_CLIENTE_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public PEDIDOS_CLIENTE_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PEDIDOS_CLIENTE_INFO_COMPLRow_Base original)
		{
			...
			if (this.VENDEDOR != original.VENDEDOR) return true;
			...
			if (this.SUCURSAL_VENTA != original.SUCURSAL_VENTA) return true;
			...
			if (this.TEXTO_OBS_DPTO_CREDITO != original.TEXTO_OBS_DPTO_CREDITO) return true;
			if (this.TEXTO_OBS_DPTO_PRECIOS != original.TEXTO_OBS_DPTO_PRECIOS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>VENDEDOR</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>VENDEDOR</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>SUCURSAL_VENTA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>SUCURSAL_VENTA</c> column value.</value>
		public string SUCURSAL_VENTA
		{
			get { return _sucursal_venta; }
			set { _sucursal_venta = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>TEXTO_OBS_DPTO_CREDITO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>TEXTO_OBS_DPTO_CREDITO</c> column value.</value>
		public string TEXTO_OBS_DPTO_CREDITO
		{
			get { return _texto_obs_dpto_credito; }
			set { _texto_obs_dpto_credito = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>TEXTO_OBS_DPTO_PRECIOS</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>TEXTO_OBS_DPTO_PRECIOS</c> column value.</value>
		public string TEXTO_OBS_DPTO_PRECIOS
		{
			get { return _texto_obs_dpto_precios; }
			set { _texto_obs_dpto_precios = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@VENDEDOR=");
			dynStr.Append(VENDEDOR);
			...
			dynStr.Append("@CBA@SUCURSAL_VENTA=");
			dynStr.Append(SUCURSAL_VENTA);
			...
			dynStr.Append("@CBA@TEXTO_OBS_DPTO_CREDITO=");
			dynStr.Append(TEXTO_OBS_DPTO_CREDITO);
			dynStr.Append("@CBA@TEXTO_OBS_DPTO_PRECIOS=");
			dynStr.Append(TEXTO_OBS_DPTO_PRECIOS);
	...
	} // End of PEDIDOS_CLIENTE_INFO_COMPLRow_Base class
} // End of namespace
