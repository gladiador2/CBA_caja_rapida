// <fileinfo name="CTACTE_TARJETAS_CREDITORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_TARJETAS_CREDITORow"/> that 
	/// represents a record in the <c>CTACTE_TARJETAS_CREDITO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_TARJETAS_CREDITORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_TARJETAS_CREDITORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_TARJETAS_CREDITORow_Base"/> class.
		/// </summary>
		public CTACTE_TARJETAS_CREDITORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_TARJETAS_CREDITORow_Base original)
		{
	...
	} // End of CTACTE_TARJETAS_CREDITORow_Base class
} // End of namespace
