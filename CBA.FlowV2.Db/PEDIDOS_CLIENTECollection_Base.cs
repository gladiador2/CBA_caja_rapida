// <fileinfo name="PEDIDOS_CLIENTECollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PEDIDOS_CLIENTECollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="PEDIDOS_CLIENTECollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PEDIDOS_CLIENTECollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PEDIDOS_CLIENTECollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public PEDIDOS_CLIENTECollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetAll()
		{
		...
		/// includes all records from the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="PEDIDOS_CLIENTERow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="PEDIDOS_CLIENTERow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public PEDIDOS_CLIENTERow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			PEDIDOS_CLIENTERow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects that 
		...
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.PEDIDOS_CLIENTE";
		...
		/// <summary>
		/// Gets <see cref="PEDIDOS_CLIENTERow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="PEDIDOS_CLIENTERow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual PEDIDOS_CLIENTERow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			PEDIDOS_CLIENTERow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_APROB_CRED_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByUSUARIO_APROB_DPTO_CREDITO(decimal usuario_aprob_dpto_credito)
		{
			return GetByUSUARIO_APROB_DPTO_CREDITO(usuario_aprob_dpto_credito, false);
		}
		...
		/// </summary>
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <param name="usuario_aprob_dpto_creditoNull">true if the method ignores the usuario_aprob_dpto_credito
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByUSUARIO_APROB_DPTO_CREDITO(decimal usuario_aprob_dpto_credito, bool usuario_aprob_dpto_creditoNull)
		{
			return MapRecords(CreateGetByUSUARIO_APROB_DPTO_CREDITOCommand(usuario_aprob_dpto_credito, usuario_aprob_dpto_creditoNull));
		}
		...
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByUSUARIO_APROB_DPTO_CREDITOAsDataTable(decimal usuario_aprob_dpto_credito)
		{
			return GetByUSUARIO_APROB_DPTO_CREDITOAsDataTable(usuario_aprob_dpto_credito, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByUSUARIO_APROB_DPTO_CREDITOAsDataTable(decimal usuario_aprob_dpto_credito, bool usuario_aprob_dpto_creditoNull)
		{
			return MapRecordsToDataTable(CreateGetByUSUARIO_APROB_DPTO_CREDITOCommand(usuario_aprob_dpto_credito, usuario_aprob_dpto_creditoNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_APROB_CRED_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <param name="usuario_aprob_dpto_creditoNull">true if the method ignores the usuario_aprob_dpto_credito
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByUSUARIO_APROB_DPTO_CREDITOCommand(decimal usuario_aprob_dpto_credito, bool usuario_aprob_dpto_creditoNull)
		{
			string whereSql = "";
			if(usuario_aprob_dpto_creditoNull)
				whereSql += "USUARIO_APROB_DPTO_CREDITO IS NULL";
			else
				whereSql += "USUARIO_APROB_DPTO_CREDITO=" + _db.CreateSqlParameterName("USUARIO_APROB_DPTO_CREDITO");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!usuario_aprob_dpto_creditoNull)
				AddParameter(cmd, "USUARIO_APROB_DPTO_CREDITO", usuario_aprob_dpto_credito);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_APROB_PREC_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByUSUARIO_APROB_DPTO_PRECIOS(decimal usuario_aprob_dpto_precios)
		{
			return GetByUSUARIO_APROB_DPTO_PRECIOS(usuario_aprob_dpto_precios, false);
		}
		...
		/// </summary>
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <param name="usuario_aprob_dpto_preciosNull">true if the method ignores the usuario_aprob_dpto_precios
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByUSUARIO_APROB_DPTO_PRECIOS(decimal usuario_aprob_dpto_precios, bool usuario_aprob_dpto_preciosNull)
		{
			return MapRecords(CreateGetByUSUARIO_APROB_DPTO_PRECIOSCommand(usuario_aprob_dpto_precios, usuario_aprob_dpto_preciosNull));
		}
		...
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByUSUARIO_APROB_DPTO_PRECIOSAsDataTable(decimal usuario_aprob_dpto_precios)
		{
			return GetByUSUARIO_APROB_DPTO_PRECIOSAsDataTable(usuario_aprob_dpto_precios, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByUSUARIO_APROB_DPTO_PRECIOSAsDataTable(decimal usuario_aprob_dpto_precios, bool usuario_aprob_dpto_preciosNull)
		{
			return MapRecordsToDataTable(CreateGetByUSUARIO_APROB_DPTO_PRECIOSCommand(usuario_aprob_dpto_precios, usuario_aprob_dpto_preciosNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_APROB_PREC_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <param name="usuario_aprob_dpto_preciosNull">true if the method ignores the usuario_aprob_dpto_precios
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByUSUARIO_APROB_DPTO_PRECIOSCommand(decimal usuario_aprob_dpto_precios, bool usuario_aprob_dpto_preciosNull)
		{
			string whereSql = "";
			if(usuario_aprob_dpto_preciosNull)
				whereSql += "USUARIO_APROB_DPTO_PRECIOS IS NULL";
			else
				whereSql += "USUARIO_APROB_DPTO_PRECIOS=" + _db.CreateSqlParameterName("USUARIO_APROB_DPTO_PRECIOS");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!usuario_aprob_dpto_preciosNull)
				AddParameter(cmd, "USUARIO_APROB_DPTO_PRECIOS", usuario_aprob_dpto_precios);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_COND_PAGO</c> foreign key.
		/// </summary>
		/// <param name="condicion_pago_id">The <c>CONDICION_PAGO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByCONDICION_PAGO_ID(decimal condicion_pago_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByCONDICION_PAGO_ID(decimal condicion_pago_id, bool condicion_pago_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_COND_PAGO</c> foreign key.
		/// </summary>
		/// <param name="condicion_pago_id">The <c>CONDICION_PAGO_ID</c> column value.</param>
		/// <param name="condicion_pago_idNull">true if the method ignores the condicion_pago_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByDEPOSITO_ID(decimal deposito_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByDEPOSITO_ID(decimal deposito_id, bool deposito_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <param name="deposito_idNull">true if the method ignores the deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_LISTA_PRECIO_ID</c> foreign key.
		/// </summary>
		/// <param name="lista_precio_id">The <c>LISTA_PRECIO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByLISTA_PRECIO_ID(decimal lista_precio_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByLISTA_PRECIO_ID(decimal lista_precio_id, bool lista_precio_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_LISTA_PRECIO_ID</c> foreign key.
		/// </summary>
		/// <param name="lista_precio_id">The <c>LISTA_PRECIO_ID</c> column value.</param>
		/// <param name="lista_precio_idNull">true if the method ignores the lista_precio_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_MONEDA_ID_ORI</c> foreign key.
		/// </summary>
		/// <param name="moneda_destino_id">The <c>MONEDA_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByMONEDA_DESTINO_ID(decimal moneda_destino_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByMONEDA_DESTINO_ID(decimal moneda_destino_id, bool moneda_destino_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_MONEDA_ID_ORI</c> foreign key.
		/// </summary>
		/// <param name="moneda_destino_id">The <c>MONEDA_DESTINO_ID</c> column value.</param>
		/// <param name="moneda_destino_idNull">true if the method ignores the moneda_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByPERSONA_ID(decimal persona_id, bool persona_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetBySUCURSAL_ID(decimal sucursal_id, bool sucursal_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <param name="sucursal_idNull">true if the method ignores the sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_SUCURSAL_VENT_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_venta_id">The <c>SUCURSAL_VENTA_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetBySUCURSAL_VENTA_ID(decimal sucursal_venta_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetBySUCURSAL_VENTA_ID(decimal sucursal_venta_id, bool sucursal_venta_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_SUCURSAL_VENT_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_venta_id">The <c>SUCURSAL_VENTA_ID</c> column value.</param>
		/// <param name="sucursal_venta_idNull">true if the method ignores the sucursal_venta_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_TEXTO_CREDITO</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByTEXTO_OBS_DPTO_CREDITO_ID(decimal texto_obs_dpto_credito_id)
		{
			return GetByTEXTO_OBS_DPTO_CREDITO_ID(texto_obs_dpto_credito_id, false);
		}
		...
		/// </summary>
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_credito_idNull">true if the method ignores the texto_obs_dpto_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByTEXTO_OBS_DPTO_CREDITO_ID(decimal texto_obs_dpto_credito_id, bool texto_obs_dpto_credito_idNull)
		{
			return MapRecords(CreateGetByTEXTO_OBS_DPTO_CREDITO_IDCommand(texto_obs_dpto_credito_id, texto_obs_dpto_credito_idNull));
		}
		...
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByTEXTO_OBS_DPTO_CREDITO_IDAsDataTable(decimal texto_obs_dpto_credito_id)
		{
			return GetByTEXTO_OBS_DPTO_CREDITO_IDAsDataTable(texto_obs_dpto_credito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByTEXTO_OBS_DPTO_CREDITO_IDAsDataTable(decimal texto_obs_dpto_credito_id, bool texto_obs_dpto_credito_idNull)
		{
			return MapRecordsToDataTable(CreateGetByTEXTO_OBS_DPTO_CREDITO_IDCommand(texto_obs_dpto_credito_id, texto_obs_dpto_credito_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_TEXTO_CREDITO</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_credito_idNull">true if the method ignores the texto_obs_dpto_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByTEXTO_OBS_DPTO_CREDITO_IDCommand(decimal texto_obs_dpto_credito_id, bool texto_obs_dpto_credito_idNull)
		{
			string whereSql = "";
			if(texto_obs_dpto_credito_idNull)
				whereSql += "TEXTO_OBS_DPTO_CREDITO_ID IS NULL";
			else
				whereSql += "TEXTO_OBS_DPTO_CREDITO_ID=" + _db.CreateSqlParameterName("TEXTO_OBS_DPTO_CREDITO_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!texto_obs_dpto_credito_idNull)
				AddParameter(cmd, "TEXTO_OBS_DPTO_CREDITO_ID", texto_obs_dpto_credito_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_TEXTO_PRECIOS</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByTEXTO_OBS_DPTO_PRECIOS_ID(decimal texto_obs_dpto_precios_id)
		{
			return GetByTEXTO_OBS_DPTO_PRECIOS_ID(texto_obs_dpto_precios_id, false);
		}
		...
		/// </summary>
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_precios_idNull">true if the method ignores the texto_obs_dpto_precios_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByTEXTO_OBS_DPTO_PRECIOS_ID(decimal texto_obs_dpto_precios_id, bool texto_obs_dpto_precios_idNull)
		{
			return MapRecords(CreateGetByTEXTO_OBS_DPTO_PRECIOS_IDCommand(texto_obs_dpto_precios_id, texto_obs_dpto_precios_idNull));
		}
		...
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByTEXTO_OBS_DPTO_PRECIOS_IDAsDataTable(decimal texto_obs_dpto_precios_id)
		{
			return GetByTEXTO_OBS_DPTO_PRECIOS_IDAsDataTable(texto_obs_dpto_precios_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByTEXTO_OBS_DPTO_PRECIOS_IDAsDataTable(decimal texto_obs_dpto_precios_id, bool texto_obs_dpto_precios_idNull)
		{
			return MapRecordsToDataTable(CreateGetByTEXTO_OBS_DPTO_PRECIOS_IDCommand(texto_obs_dpto_precios_id, texto_obs_dpto_precios_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_TEXTO_PRECIOS</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_precios_idNull">true if the method ignores the texto_obs_dpto_precios_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByTEXTO_OBS_DPTO_PRECIOS_IDCommand(decimal texto_obs_dpto_precios_id, bool texto_obs_dpto_precios_idNull)
		{
			string whereSql = "";
			if(texto_obs_dpto_precios_idNull)
				whereSql += "TEXTO_OBS_DPTO_PRECIOS_ID IS NULL";
			else
				whereSql += "TEXTO_OBS_DPTO_PRECIOS_ID=" + _db.CreateSqlParameterName("TEXTO_OBS_DPTO_PRECIOS_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!texto_obs_dpto_precios_idNull)
				AddParameter(cmd, "TEXTO_OBS_DPTO_PRECIOS_ID", texto_obs_dpto_precios_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_id_autoriza_descuento">The <c>USUARIO_ID_AUTORIZA_DESCUENTO</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByUSUARIO_ID_AUTORIZA_DESCUENTO(decimal usuario_id_autoriza_descuento)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByUSUARIO_ID_AUTORIZA_DESCUENTO(decimal usuario_id_autoriza_descuento, bool usuario_id_autoriza_descuentoNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_id_autoriza_descuento">The <c>USUARIO_ID_AUTORIZA_DESCUENTO</c> column value.</param>
		/// <param name="usuario_id_autoriza_descuentoNull">true if the method ignores the usuario_id_autoriza_descuento
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PEDIDOS_CLIENTERow"/> objects 
		/// by the <c>FK_PEDIDO_CLI_VENDEDOR</c> foreign key.
		/// </summary>
		/// <param name="vendedor_id">The <c>VENDEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public PEDIDOS_CLIENTERow[] GetByVENDEDOR_ID(decimal vendedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		public virtual PEDIDOS_CLIENTERow[] GetByVENDEDOR_ID(decimal vendedor_id, bool vendedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PEDIDO_CLI_VENDEDOR</c> foreign key.
		/// </summary>
		/// <param name="vendedor_id">The <c>VENDEDOR_ID</c> column value.</param>
		/// <param name="vendedor_idNull">true if the method ignores the vendedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PEDIDOS_CLIENTERow"/> object to be inserted.</param>
		public virtual void Insert(PEDIDOS_CLIENTERow value)
		{
						
			string sqlStr = "INSERT INTO TRC.PEDIDOS_CLIENTE (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
				"SUCURSAL_VENTA_ID, " +
				...
				"TOTAL_MONTO_DTO, " +
				"TOTAL_MONTO_BRUTO_INICIAL, " +
				"TOTAL_MONTO_BRUTO_FINAL, " +
				"TOTAL_NETO, " +
				"TOTAL_FINAL_SUBITEMS, " +
				"TOTAL_COSTO_BRUTO, " +
				"TOTAL_COSTO_NETO, " +
				...
				"COMISION_POR_VENTA, " +
				"OBSERVACION, " +
				"APROBACION_DPTO_CREDITO, " +
				"FECHA_APROB_DPTO_CREDITO, " +
				"USUARIO_APROB_DPTO_CREDITO, " +
				"APROBACION_DPTO_PRECIOS, " +
				"FECHA_APROB_DPTO_PRECIOS, " +
				"USUARIO_APROB_DPTO_PRECIOS, " +
				"TEXTO_OBS_DPTO_CREDITO_ID, " +
				"TEXTO_OBS_DPTO_PRECIOS_ID, " +
				"PREVENTA, " +
				"PREVENTA_ORDEN, " +
				"PREVENTA_FECHA_ENTREGA, " +
				"A_CONSIGNACION, " +
				"IMPRESO, " +
				...
				_db.CreateSqlParameterName("TOTAL_MONTO_BRUTO_INICIAL") + ", " +
				_db.CreateSqlParameterName("TOTAL_MONTO_BRUTO_FINAL") + ", " +
				_db.CreateSqlParameterName("TOTAL_NETO") + ", " +
				_db.CreateSqlParameterName("TOTAL_FINAL_SUBITEMS") + ", " +
				...
				_db.CreateSqlParameterName("APROBACION_DPTO_CREDITO") + ", " +
				_db.CreateSqlParameterName("FECHA_APROB_DPTO_CREDITO") + ", " +
				_db.CreateSqlParameterName("USUARIO_APROB_DPTO_CREDITO") + ", " +
				_db.CreateSqlParameterName("APROBACION_DPTO_PRECIOS") + ", " +
				_db.CreateSqlParameterName("FECHA_APROB_DPTO_PRECIOS") + ", " +
				_db.CreateSqlParameterName("USUARIO_APROB_DPTO_PRECIOS") + ", " +
				_db.CreateSqlParameterName("TEXTO_OBS_DPTO_CREDITO_ID") + ", " +
				_db.CreateSqlParameterName("TEXTO_OBS_DPTO_PRECIOS_ID") + ", " +
				_db.CreateSqlParameterName("PREVENTA") + ", " +
				_db.CreateSqlParameterName("PREVENTA_ORDEN") + ", " +
				_db.CreateSqlParameterName("PREVENTA_FECHA_ENTREGA") + ", " +
				_db.CreateSqlParameterName("A_CONSIGNACION") + ", " +
				_db.CreateSqlParameterName("IMPRESO") + ", " +
				_db.CreateSqlParameterName("MONTO_CREDITO_APROBADO") + ", " +
				...
				_db.CreateSqlParameterName("USAR_REMISIONES") + ")";
			...
			AddParameter(cmd, "TOTAL_MONTO_BRUTO_INICIAL",
				value.IsTOTAL_MONTO_BRUTO_INICIALNull ? DBNull.Value : (object)value.TOTAL_MONTO_BRUTO_INICIAL);
			AddParameter(cmd, "TOTAL_MONTO_BRUTO_FINAL",
				value.IsTOTAL_MONTO_BRUTO_FINALNull ? DBNull.Value : (object)value.TOTAL_MONTO_BRUTO_FINAL);
			AddParameter(cmd, "TOTAL_NETO",
				value.IsTOTAL_NETONull ? DBNull.Value : (object)value.TOTAL_NETO);
			AddParameter(cmd, "TOTAL_FINAL_SUBITEMS",
				value.IsTOTAL_FINAL_SUBITEMSNull ? DBNull.Value : (object)value.TOTAL_FINAL_SUBITEMS);
			...
			AddParameter(cmd, "APROBACION_DPTO_CREDITO", value.APROBACION_DPTO_CREDITO);
			AddParameter(cmd, "FECHA_APROB_DPTO_CREDITO",
				value.IsFECHA_APROB_DPTO_CREDITONull ? DBNull.Value : (object)value.FECHA_APROB_DPTO_CREDITO);
			AddParameter(cmd, "USUARIO_APROB_DPTO_CREDITO",
				value.IsUSUARIO_APROB_DPTO_CREDITONull ? DBNull.Value : (object)value.USUARIO_APROB_DPTO_CREDITO);
			AddParameter(cmd, "APROBACION_DPTO_PRECIOS", value.APROBACION_DPTO_PRECIOS);
			AddParameter(cmd, "FECHA_APROB_DPTO_PRECIOS",
				value.IsFECHA_APROB_DPTO_PRECIOSNull ? DBNull.Value : (object)value.FECHA_APROB_DPTO_PRECIOS);
			AddParameter(cmd, "USUARIO_APROB_DPTO_PRECIOS",
				value.IsUSUARIO_APROB_DPTO_PRECIOSNull ? DBNull.Value : (object)value.USUARIO_APROB_DPTO_PRECIOS);
			AddParameter(cmd, "TEXTO_OBS_DPTO_CREDITO_ID",
				value.IsTEXTO_OBS_DPTO_CREDITO_IDNull ? DBNull.Value : (object)value.TEXTO_OBS_DPTO_CREDITO_ID);
			AddParameter(cmd, "TEXTO_OBS_DPTO_PRECIOS_ID",
				value.IsTEXTO_OBS_DPTO_PRECIOS_IDNull ? DBNull.Value : (object)value.TEXTO_OBS_DPTO_PRECIOS_ID);
			AddParameter(cmd, "PREVENTA", value.PREVENTA);
			AddParameter(cmd, "PREVENTA_ORDEN",
				value.IsPREVENTA_ORDENNull ? DBNull.Value : (object)value.PREVENTA_ORDEN);
			AddParameter(cmd, "PREVENTA_FECHA_ENTREGA",
				value.IsPREVENTA_FECHA_ENTREGANull ? DBNull.Value : (object)value.PREVENTA_FECHA_ENTREGA);
			AddParameter(cmd, "A_CONSIGNACION", value.A_CONSIGNACION);
			AddParameter(cmd, "IMPRESO", value.IMPRESO);
			AddParameter(cmd, "MONTO_CREDITO_APROBADO",
				value.IsMONTO_CREDITO_APROBADONull ? DBNull.Value : (object)value.MONTO_CREDITO_APROBADO);
			...
			AddParameter(cmd, "USAR_REMISIONES", value.USAR_REMISIONES);
			cmd.ExecuteNonQuery();
		}

		/// <summary>
		/// Updates a record in the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PEDIDOS_CLIENTERow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(PEDIDOS_CLIENTERow value)
		{
			
			string sqlStr = "UPDATE TRC.PEDIDOS_CLIENTE SET " +
				...
				"TOTAL_MONTO_BRUTO_INICIAL=" + _db.CreateSqlParameterName("TOTAL_MONTO_BRUTO_INICIAL") + ", " +
				"TOTAL_MONTO_BRUTO_FINAL=" + _db.CreateSqlParameterName("TOTAL_MONTO_BRUTO_FINAL") + ", " +
				"TOTAL_NETO=" + _db.CreateSqlParameterName("TOTAL_NETO") + ", " +
				"TOTAL_FINAL_SUBITEMS=" + _db.CreateSqlParameterName("TOTAL_FINAL_SUBITEMS") + ", " +
				...
				"APROBACION_DPTO_CREDITO=" + _db.CreateSqlParameterName("APROBACION_DPTO_CREDITO") + ", " +
				"FECHA_APROB_DPTO_CREDITO=" + _db.CreateSqlParameterName("FECHA_APROB_DPTO_CREDITO") + ", " +
				"USUARIO_APROB_DPTO_CREDITO=" + _db.CreateSqlParameterName("USUARIO_APROB_DPTO_CREDITO") + ", " +
				"APROBACION_DPTO_PRECIOS=" + _db.CreateSqlParameterName("APROBACION_DPTO_PRECIOS") + ", " +
				"FECHA_APROB_DPTO_PRECIOS=" + _db.CreateSqlParameterName("FECHA_APROB_DPTO_PRECIOS") + ", " +
				"USUARIO_APROB_DPTO_PRECIOS=" + _db.CreateSqlParameterName("USUARIO_APROB_DPTO_PRECIOS") + ", " +
				"TEXTO_OBS_DPTO_CREDITO_ID=" + _db.CreateSqlParameterName("TEXTO_OBS_DPTO_CREDITO_ID") + ", " +
				"TEXTO_OBS_DPTO_PRECIOS_ID=" + _db.CreateSqlParameterName("TEXTO_OBS_DPTO_PRECIOS_ID") + ", " +
				"PREVENTA=" + _db.CreateSqlParameterName("PREVENTA") + ", " +
				"PREVENTA_ORDEN=" + _db.CreateSqlParameterName("PREVENTA_ORDEN") + ", " +
				"PREVENTA_FECHA_ENTREGA=" + _db.CreateSqlParameterName("PREVENTA_FECHA_ENTREGA") + ", " +
				"A_CONSIGNACION=" + _db.CreateSqlParameterName("A_CONSIGNACION") + ", " +
				"IMPRESO=" + _db.CreateSqlParameterName("IMPRESO") + ", " +
				"MONTO_CREDITO_APROBADO=" + _db.CreateSqlParameterName("MONTO_CREDITO_APROBADO") + ", " +
				...
				"USAR_REMISIONES=" + _db.CreateSqlParameterName("USAR_REMISIONES") +
				" WHERE " +
		...
		/// <summary>
		/// Updates the <c>PEDIDOS_CLIENTE</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>PEDIDOS_CLIENTE</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PEDIDOS_CLIENTERow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(PEDIDOS_CLIENTERow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>PEDIDOS_CLIENTE</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_APROB_CRED_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByUSUARIO_APROB_DPTO_CREDITO(decimal usuario_aprob_dpto_credito)
		{
			return DeleteByUSUARIO_APROB_DPTO_CREDITO(usuario_aprob_dpto_credito, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByUSUARIO_APROB_DPTO_CREDITO(decimal usuario_aprob_dpto_credito, bool usuario_aprob_dpto_creditoNull)
		{
			return CreateDeleteByUSUARIO_APROB_DPTO_CREDITOCommand(usuario_aprob_dpto_credito, usuario_aprob_dpto_creditoNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_APROB_CRED_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_credito">The <c>USUARIO_APROB_DPTO_CREDITO</c> column value.</param>
		/// <param name="usuario_aprob_dpto_creditoNull">true if the method ignores the usuario_aprob_dpto_credito
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByUSUARIO_APROB_DPTO_CREDITOCommand(decimal usuario_aprob_dpto_credito, bool usuario_aprob_dpto_creditoNull)
		{
			string whereSql = "";
			if(usuario_aprob_dpto_creditoNull)
				whereSql += "USUARIO_APROB_DPTO_CREDITO IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_APROB_PREC_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByUSUARIO_APROB_DPTO_PRECIOS(decimal usuario_aprob_dpto_precios)
		{
			return DeleteByUSUARIO_APROB_DPTO_PRECIOS(usuario_aprob_dpto_precios, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByUSUARIO_APROB_DPTO_PRECIOS(decimal usuario_aprob_dpto_precios, bool usuario_aprob_dpto_preciosNull)
		{
			return CreateDeleteByUSUARIO_APROB_DPTO_PRECIOSCommand(usuario_aprob_dpto_precios, usuario_aprob_dpto_preciosNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_APROB_PREC_USR</c> foreign key.
		/// </summary>
		/// <param name="usuario_aprob_dpto_precios">The <c>USUARIO_APROB_DPTO_PRECIOS</c> column value.</param>
		/// <param name="usuario_aprob_dpto_preciosNull">true if the method ignores the usuario_aprob_dpto_precios
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByUSUARIO_APROB_DPTO_PRECIOSCommand(decimal usuario_aprob_dpto_precios, bool usuario_aprob_dpto_preciosNull)
		{
			string whereSql = "";
			if(usuario_aprob_dpto_preciosNull)
				whereSql += "USUARIO_APROB_DPTO_PRECIOS IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_COND_PAGO</c> foreign key.
		/// </summary>
		/// <param name="condicion_pago_id">The <c>CONDICION_PAGO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_COND_PAGO</c> foreign key.
		/// </summary>
		/// <param name="condicion_pago_id">The <c>CONDICION_PAGO_ID</c> column value.</param>
		/// <param name="condicion_pago_idNull">true if the method ignores the condicion_pago_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <param name="deposito_idNull">true if the method ignores the deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_LISTA_PRECIO_ID</c> foreign key.
		/// </summary>
		/// <param name="lista_precio_id">The <c>LISTA_PRECIO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_LISTA_PRECIO_ID</c> foreign key.
		/// </summary>
		/// <param name="lista_precio_id">The <c>LISTA_PRECIO_ID</c> column value.</param>
		/// <param name="lista_precio_idNull">true if the method ignores the lista_precio_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_MONEDA_ID_ORI</c> foreign key.
		/// </summary>
		/// <param name="moneda_destino_id">The <c>MONEDA_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_MONEDA_ID_ORI</c> foreign key.
		/// </summary>
		/// <param name="moneda_destino_id">The <c>MONEDA_DESTINO_ID</c> column value.</param>
		/// <param name="moneda_destino_idNull">true if the method ignores the moneda_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <param name="sucursal_idNull">true if the method ignores the sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_SUCURSAL_VENT_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_venta_id">The <c>SUCURSAL_VENTA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_SUCURSAL_VENT_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_venta_id">The <c>SUCURSAL_VENTA_ID</c> column value.</param>
		/// <param name="sucursal_venta_idNull">true if the method ignores the sucursal_venta_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_TEXTO_CREDITO</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTEXTO_OBS_DPTO_CREDITO_ID(decimal texto_obs_dpto_credito_id)
		{
			return DeleteByTEXTO_OBS_DPTO_CREDITO_ID(texto_obs_dpto_credito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTEXTO_OBS_DPTO_CREDITO_ID(decimal texto_obs_dpto_credito_id, bool texto_obs_dpto_credito_idNull)
		{
			return CreateDeleteByTEXTO_OBS_DPTO_CREDITO_IDCommand(texto_obs_dpto_credito_id, texto_obs_dpto_credito_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_TEXTO_CREDITO</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_credito_id">The <c>TEXTO_OBS_DPTO_CREDITO_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_credito_idNull">true if the method ignores the texto_obs_dpto_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByTEXTO_OBS_DPTO_CREDITO_IDCommand(decimal texto_obs_dpto_credito_id, bool texto_obs_dpto_credito_idNull)
		{
			string whereSql = "";
			if(texto_obs_dpto_credito_idNull)
				whereSql += "TEXTO_OBS_DPTO_CREDITO_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_TEXTO_PRECIOS</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTEXTO_OBS_DPTO_PRECIOS_ID(decimal texto_obs_dpto_precios_id)
		{
			return DeleteByTEXTO_OBS_DPTO_PRECIOS_ID(texto_obs_dpto_precios_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTEXTO_OBS_DPTO_PRECIOS_ID(decimal texto_obs_dpto_precios_id, bool texto_obs_dpto_precios_idNull)
		{
			return CreateDeleteByTEXTO_OBS_DPTO_PRECIOS_IDCommand(texto_obs_dpto_precios_id, texto_obs_dpto_precios_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_TEXTO_PRECIOS</c> foreign key.
		/// </summary>
		/// <param name="texto_obs_dpto_precios_id">The <c>TEXTO_OBS_DPTO_PRECIOS_ID</c> column value.</param>
		/// <param name="texto_obs_dpto_precios_idNull">true if the method ignores the texto_obs_dpto_precios_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByTEXTO_OBS_DPTO_PRECIOS_IDCommand(decimal texto_obs_dpto_precios_id, bool texto_obs_dpto_precios_idNull)
		{
			string whereSql = "";
			if(texto_obs_dpto_precios_idNull)
				whereSql += "TEXTO_OBS_DPTO_PRECIOS_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_id_autoriza_descuento">The <c>USUARIO_ID_AUTORIZA_DESCUENTO</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_id_autoriza_descuento">The <c>USUARIO_ID_AUTORIZA_DESCUENTO</c> column value.</param>
		/// <param name="usuario_id_autoriza_descuentoNull">true if the method ignores the usuario_id_autoriza_descuento
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PEDIDOS_CLIENTE</c> table using the 
		/// <c>FK_PEDIDO_CLI_VENDEDOR</c> foreign key.
		/// </summary>
		/// <param name="vendedor_id">The <c>VENDEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PEDIDO_CLI_VENDEDOR</c> foreign key.
		/// </summary>
		/// <param name="vendedor_id">The <c>VENDEDOR_ID</c> column value.</param>
		/// <param name="vendedor_idNull">true if the method ignores the vendedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>PEDIDOS_CLIENTE</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>PEDIDOS_CLIENTE</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.PEDIDOS_CLIENTE";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		protected PEDIDOS_CLIENTERow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		protected PEDIDOS_CLIENTERow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="PEDIDOS_CLIENTERow"/> objects.</returns>
		protected virtual PEDIDOS_CLIENTERow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					PEDIDOS_CLIENTERow record = new PEDIDOS_CLIENTERow();
			...
			return (PEDIDOS_CLIENTERow[])(recordList.ToArray(typeof(PEDIDOS_CLIENTERow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="PEDIDOS_CLIENTERow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="PEDIDOS_CLIENTERow"/> object.</returns>
		protected virtual PEDIDOS_CLIENTERow MapRow(DataRow row)
		{
			PEDIDOS_CLIENTERow mappedObject = new PEDIDOS_CLIENTERow();
		...
		/// the <c>PEDIDOS_CLIENTE</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "PEDIDOS_CLIENTE";
			DataColumn dataColumn;
	...
	} // End of PEDIDOS_CLIENTECollection_Base class
}  // End of namespace
