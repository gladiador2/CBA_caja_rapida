// <fileinfo name="MANIFIESTOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MANIFIESTOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>MANIFIESTOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MANIFIESTOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MANIFIESTOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MANIFIESTOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public MANIFIESTOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(MANIFIESTOS_INFO_COMPLETARow_Base original)
		{
	...
	} // End of MANIFIESTOS_INFO_COMPLETARow_Base class
} // End of namespace
