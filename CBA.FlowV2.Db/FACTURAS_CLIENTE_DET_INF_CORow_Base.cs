// <fileinfo name="FACTURAS_CLIENTE_DET_INF_CORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FACTURAS_CLIENTE_DET_INF_CORow"/> that 
	/// represents a record in the <c>FACTURAS_CLIENTE_DET_INF_CO</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FACTURAS_CLIENTE_DET_INF_CORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FACTURAS_CLIENTE_DET_INF_CORow_Base
	{
		private decimal _id;
		...
		private string _articulo_es_trazable;
		...
		private decimal _caso_aso_flujo_id;
		private bool _caso_aso_flujo_idNull = true;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FACTURAS_CLIENTE_DET_INF_CORow_Base"/> class.
		/// </summary>
		public FACTURAS_CLIENTE_DET_INF_CORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(FACTURAS_CLIENTE_DET_INF_CORow_Base original)
		{
			...
			if (this.ARTICULO_ES_TRAZABLE != original.ARTICULO_ES_TRAZABLE) return true;
			...
			if (this.IsCASO_ASO_FLUJO_IDNull != original.IsCASO_ASO_FLUJO_IDNull) return true;
			if (!this.IsCASO_ASO_FLUJO_IDNull && !original.IsCASO_ASO_FLUJO_IDNull)
				if (this.CASO_ASO_FLUJO_ID != original.CASO_ASO_FLUJO_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>ARTICULO_ES_TRAZABLE</c> column value.
		/// </summary>
		/// <value>The <c>ARTICULO_ES_TRAZABLE</c> column value.</value>
		public string ARTICULO_ES_TRAZABLE
		{
			get { return _articulo_es_trazable; }
			set { _articulo_es_trazable = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CASO_ASO_FLUJO_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CASO_ASO_FLUJO_ID</c> column value.</value>
		public decimal CASO_ASO_FLUJO_ID
		{
			get
			{
				if(IsCASO_ASO_FLUJO_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _caso_aso_flujo_id;
			}
			set
			{
				_caso_aso_flujo_idNull = false;
				_caso_aso_flujo_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CASO_ASO_FLUJO_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCASO_ASO_FLUJO_IDNull
		{
			get { return _caso_aso_flujo_idNull; }
			set { _caso_aso_flujo_idNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@ARTICULO_ES_TRAZABLE=");
			dynStr.Append(ARTICULO_ES_TRAZABLE);
			...
			dynStr.Append("@CBA@CASO_ASO_FLUJO_ID=");
			dynStr.Append(IsCASO_ASO_FLUJO_IDNull ? (object)"<NULL>" : CASO_ASO_FLUJO_ID);
	...
	} // End of FACTURAS_CLIENTE_DET_INF_CORow_Base class
} // End of namespace
