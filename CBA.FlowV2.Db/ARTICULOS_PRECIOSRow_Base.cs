// <fileinfo name="ARTICULOS_PRECIOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_PRECIOSRow"/> that 
	/// represents a record in the <c>ARTICULOS_PRECIOS</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_PRECIOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_PRECIOSRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_PRECIOSRow_Base"/> class.
		/// </summary>
		public ARTICULOS_PRECIOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_PRECIOSRow_Base original)
		{
	...
	} // End of ARTICULOS_PRECIOSRow_Base class
} // End of namespace
