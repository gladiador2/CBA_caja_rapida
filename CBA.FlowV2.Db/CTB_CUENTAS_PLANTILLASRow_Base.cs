// <fileinfo name="CTB_CUENTAS_PLANTILLASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_CUENTAS_PLANTILLASRow"/> that 
	/// represents a record in the <c>CTB_CUENTAS_PLANTILLAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_CUENTAS_PLANTILLASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_CUENTAS_PLANTILLASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_CUENTAS_PLANTILLASRow_Base"/> class.
		/// </summary>
		public CTB_CUENTAS_PLANTILLASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_CUENTAS_PLANTILLASRow_Base original)
		{
	...
	} // End of CTB_CUENTAS_PLANTILLASRow_Base class
} // End of namespace
