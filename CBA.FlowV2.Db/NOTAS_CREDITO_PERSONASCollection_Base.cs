// <fileinfo name="NOTAS_CREDITO_PERSONASCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="NOTAS_CREDITO_PERSONASCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="NOTAS_CREDITO_PERSONASCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class NOTAS_CREDITO_PERSONASCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NOTAS_CREDITO_PERSONASCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public NOTAS_CREDITO_PERSONASCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetAll()
		{
		...
		/// includes all records from the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="NOTAS_CREDITO_PERSONASRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="NOTAS_CREDITO_PERSONASRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public NOTAS_CREDITO_PERSONASRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			NOTAS_CREDITO_PERSONASRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects that 
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONASRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.NOTAS_CREDITO_PERSONAS";
		...
		/// <summary>
		/// Gets <see cref="NOTAS_CREDITO_PERSONASRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="NOTAS_CREDITO_PERSONASRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			NOTAS_CREDITO_PERSONASRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CRED_PERS_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONASRow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id)
		{
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id, bool ctacte_caja_sucursal_idNull)
		{
		...
		/// return records by the <c>FK_NOTAS_CRED_PERS_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_AUT</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONASRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_AUT</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_DEP</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONASRow[] GetByDEPOSITO_ID(decimal deposito_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByDEPOSITO_ID(decimal deposito_id, bool deposito_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_DEP</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <param name="deposito_idNull">true if the method ignores the deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_FUN</c> foreign key.
		/// </summary>
		/// <param name="funcionario_cobrador_id">The <c>FUNCIONARIO_COBRADOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByFUNCIONARIO_COBRADOR_ID(decimal funcionario_cobrador_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_FUN</c> foreign key.
		/// </summary>
		/// <param name="funcionario_cobrador_id">The <c>FUNCIONARIO_COBRADOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_PERS</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_PERS</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_PERSONAS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_PERSONAS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects 
		/// by the <c>FK_NOTAS_CREDITO_TIPO_NOTA_CRE</c> foreign key.
		/// </summary>
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONASRow[] GetByTIPO_NOTA_CREDITO_ID(decimal tipo_nota_credito_id)
		{
			return GetByTIPO_NOTA_CREDITO_ID(tipo_nota_credito_id, false);
		}
		...
		/// </summary>
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <param name="tipo_nota_credito_idNull">true if the method ignores the tipo_nota_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONASRow[] GetByTIPO_NOTA_CREDITO_ID(decimal tipo_nota_credito_id, bool tipo_nota_credito_idNull)
		{
			return MapRecords(CreateGetByTIPO_NOTA_CREDITO_IDCommand(tipo_nota_credito_id, tipo_nota_credito_idNull));
		}
		...
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByTIPO_NOTA_CREDITO_IDAsDataTable(decimal tipo_nota_credito_id)
		{
			return GetByTIPO_NOTA_CREDITO_IDAsDataTable(tipo_nota_credito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByTIPO_NOTA_CREDITO_IDAsDataTable(decimal tipo_nota_credito_id, bool tipo_nota_credito_idNull)
		{
			return MapRecordsToDataTable(CreateGetByTIPO_NOTA_CREDITO_IDCommand(tipo_nota_credito_id, tipo_nota_credito_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTAS_CREDITO_TIPO_NOTA_CRE</c> foreign key.
		/// </summary>
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <param name="tipo_nota_credito_idNull">true if the method ignores the tipo_nota_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByTIPO_NOTA_CREDITO_IDCommand(decimal tipo_nota_credito_id, bool tipo_nota_credito_idNull)
		{
			string whereSql = "";
			if(tipo_nota_credito_idNull)
				whereSql += "TIPO_NOTA_CREDITO_ID IS NULL";
			else
		...
		/// <summary>
		/// Adds a new record into the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONASRow"/> object to be inserted.</param>
		public virtual void Insert(NOTAS_CREDITO_PERSONASRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.NOTAS_CREDITO_PERSONAS (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
				"DEPOSITO_ID, " +
			...
			AddParameter(cmd, "TIPO_NOTA_CREDITO_ID",
				value.IsTIPO_NOTA_CREDITO_IDNull ? DBNull.Value : (object)value.TIPO_NOTA_CREDITO_ID);
		...
		/// <summary>
		/// Updates a record in the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONASRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(NOTAS_CREDITO_PERSONASRow value)
		{
			
			string sqlStr = "UPDATE TRC.NOTAS_CREDITO_PERSONAS SET " +
		...
		/// <summary>
		/// Updates the <c>NOTAS_CREDITO_PERSONAS</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>NOTAS_CREDITO_PERSONAS</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONASRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(NOTAS_CREDITO_PERSONASRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>NOTAS_CREDITO_PERSONAS</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CRED_PERS_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CRED_PERS_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_AUT</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_AUT</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_DEP</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_DEP</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <param name="deposito_idNull">true if the method ignores the deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_FUN</c> foreign key.
		/// </summary>
		/// <param name="funcionario_cobrador_id">The <c>FUNCIONARIO_COBRADOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_FUN</c> foreign key.
		/// </summary>
		/// <param name="funcionario_cobrador_id">The <c>FUNCIONARIO_COBRADOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_PERS</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_PERS</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_PERSONAS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_PERSONAS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS</c> table using the 
		/// <c>FK_NOTAS_CREDITO_TIPO_NOTA_CRE</c> foreign key.
		/// </summary>
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTIPO_NOTA_CREDITO_ID(decimal tipo_nota_credito_id)
		{
			return DeleteByTIPO_NOTA_CREDITO_ID(tipo_nota_credito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTIPO_NOTA_CREDITO_ID(decimal tipo_nota_credito_id, bool tipo_nota_credito_idNull)
		{
			return CreateDeleteByTIPO_NOTA_CREDITO_IDCommand(tipo_nota_credito_id, tipo_nota_credito_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTAS_CREDITO_TIPO_NOTA_CRE</c> foreign key.
		/// </summary>
		/// <param name="tipo_nota_credito_id">The <c>TIPO_NOTA_CREDITO_ID</c> column value.</param>
		/// <param name="tipo_nota_credito_idNull">true if the method ignores the tipo_nota_credito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByTIPO_NOTA_CREDITO_IDCommand(decimal tipo_nota_credito_id, bool tipo_nota_credito_idNull)
		{
			string whereSql = "";
			if(tipo_nota_credito_idNull)
				whereSql += "TIPO_NOTA_CREDITO_ID IS NULL";
		...
		/// <summary>
		/// Deletes <c>NOTAS_CREDITO_PERSONAS</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>NOTAS_CREDITO_PERSONAS</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.NOTAS_CREDITO_PERSONAS";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		protected NOTAS_CREDITO_PERSONASRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		protected NOTAS_CREDITO_PERSONASRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONASRow"/> objects.</returns>
		protected virtual NOTAS_CREDITO_PERSONASRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					NOTAS_CREDITO_PERSONASRow record = new NOTAS_CREDITO_PERSONASRow();
			...
			return (NOTAS_CREDITO_PERSONASRow[])(recordList.ToArray(typeof(NOTAS_CREDITO_PERSONASRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="NOTAS_CREDITO_PERSONASRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="NOTAS_CREDITO_PERSONASRow"/> object.</returns>
		protected virtual NOTAS_CREDITO_PERSONASRow MapRow(DataRow row)
		{
			NOTAS_CREDITO_PERSONASRow mappedObject = new NOTAS_CREDITO_PERSONASRow();
		...
		/// the <c>NOTAS_CREDITO_PERSONAS</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "NOTAS_CREDITO_PERSONAS";
			DataColumn dataColumn;
	...
	} // End of NOTAS_CREDITO_PERSONASCollection_Base class
}  // End of namespace
