// <fileinfo name="PLANILLA_ASOC_FUNC_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PLANILLA_ASOC_FUNC_INFO_COMPRow"/> that 
	/// represents a record in the <c>PLANILLA_ASOC_FUNC_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PLANILLA_ASOC_FUNC_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PLANILLA_ASOC_FUNC_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PLANILLA_ASOC_FUNC_INFO_COMPRow_Base"/> class.
		/// </summary>
		public PLANILLA_ASOC_FUNC_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PLANILLA_ASOC_FUNC_INFO_COMPRow_Base original)
		{
			...
			if (this.GENERADO != original.GENERADO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>GENERADO</c> column value.
		/// </summary>
		/// <value>The <c>GENERADO</c> column value.</value>
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@GENERADO=");
			dynStr.Append(GENERADO);
	...
	} // End of PLANILLA_ASOC_FUNC_INFO_COMPRow_Base class
} // End of namespace
