// <fileinfo name="ESTADO_MOROSIDADRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ESTADO_MOROSIDADRow"/> that 
	/// represents a record in the <c>ESTADO_MOROSIDAD</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ESTADO_MOROSIDADRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ESTADO_MOROSIDADRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ESTADO_MOROSIDADRow_Base"/> class.
		/// </summary>
		public ESTADO_MOROSIDADRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ESTADO_MOROSIDADRow_Base original)
		{
	...
	} // End of ESTADO_MOROSIDADRow_Base class
} // End of namespace
