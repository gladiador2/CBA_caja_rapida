// <fileinfo name="PEDIDOS_PROVEEDORRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PEDIDOS_PROVEEDORRow"/> that 
	/// represents a record in the <c>PEDIDOS_PROVEEDOR</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PEDIDOS_PROVEEDORRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PEDIDOS_PROVEEDORRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PEDIDOS_PROVEEDORRow_Base"/> class.
		/// </summary>
		public PEDIDOS_PROVEEDORRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PEDIDOS_PROVEEDORRow_Base original)
		{
	...
	} // End of PEDIDOS_PROVEEDORRow_Base class
} // End of namespace
