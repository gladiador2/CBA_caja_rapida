// <fileinfo name="ORDENES_COMPRA_DETALLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ORDENES_COMPRA_DETALLESRow"/> that 
	/// represents a record in the <c>ORDENES_COMPRA_DETALLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ORDENES_COMPRA_DETALLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ORDENES_COMPRA_DETALLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ORDENES_COMPRA_DETALLESRow_Base"/> class.
		/// </summary>
		public ORDENES_COMPRA_DETALLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ORDENES_COMPRA_DETALLESRow_Base original)
		{
	...
	} // End of ORDENES_COMPRA_DETALLESRow_Base class
} // End of namespace
