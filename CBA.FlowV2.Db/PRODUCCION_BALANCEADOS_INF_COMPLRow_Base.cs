// <fileinfo name="PRODUCCION_BALANCEADOS_INF_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PRODUCCION_BALANCEADOS_INF_COMPLRow"/> that 
	/// represents a record in the <c>PRODUCCION_BALANCEADOS_INF_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PRODUCCION_BALANCEADOS_INF_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PRODUCCION_BALANCEADOS_INF_COMPLRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PRODUCCION_BALANCEADOS_INF_COMPLRow_Base"/> class.
		/// </summary>
		public PRODUCCION_BALANCEADOS_INF_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PRODUCCION_BALANCEADOS_INF_COMPLRow_Base original)
		{
	...
	} // End of PRODUCCION_BALANCEADOS_INF_COMPLRow_Base class
} // End of namespace
