// <fileinfo name="CTACTE_CAJAS_TESORERIARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CAJAS_TESORERIARow"/> that 
	/// represents a record in the <c>CTACTE_CAJAS_TESORERIA</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_CAJAS_TESORERIARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CAJAS_TESORERIARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CAJAS_TESORERIARow_Base"/> class.
		/// </summary>
		public CTACTE_CAJAS_TESORERIARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_CAJAS_TESORERIARow_Base original)
		{
	...
	} // End of CTACTE_CAJAS_TESORERIARow_Base class
} // End of namespace
