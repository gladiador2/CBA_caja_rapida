// <fileinfo name="ANTICIPOS_PERSONA_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ANTICIPOS_PERSONA_DETRow"/> that 
	/// represents a record in the <c>ANTICIPOS_PERSONA_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ANTICIPOS_PERSONA_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ANTICIPOS_PERSONA_DETRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ANTICIPOS_PERSONA_DETRow_Base"/> class.
		/// </summary>
		public ANTICIPOS_PERSONA_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ANTICIPOS_PERSONA_DETRow_Base original)
		{
	...
	} // End of ANTICIPOS_PERSONA_DETRow_Base class
} // End of namespace
