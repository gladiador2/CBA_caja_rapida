// <fileinfo name="EGRESO_PROD_DET_MATERIALESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EGRESO_PROD_DET_MATERIALESRow"/> that 
	/// represents a record in the <c>EGRESO_PROD_DET_MATERIALES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EGRESO_PROD_DET_MATERIALESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EGRESO_PROD_DET_MATERIALESRow_Base
	{
		private decimal _id;
		private decimal _egreso_producto_det_id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EGRESO_PROD_DET_MATERIALESRow_Base"/> class.
		/// </summary>
		public EGRESO_PROD_DET_MATERIALESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EGRESO_PROD_DET_MATERIALESRow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.EGRESO_PRODUCTO_DET_ID != original.EGRESO_PRODUCTO_DET_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>EGRESO_PRODUCTO_DET_ID</c> column value.
		/// </summary>
		/// <value>The <c>EGRESO_PRODUCTO_DET_ID</c> column value.</value>
		public decimal EGRESO_PRODUCTO_DET_ID
		{
			get { return _egreso_producto_det_id; }
			set { _egreso_producto_det_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(ID);
			dynStr.Append("@CBA@EGRESO_PRODUCTO_DET_ID=");
			dynStr.Append(EGRESO_PRODUCTO_DET_ID);
	...
	} // End of EGRESO_PROD_DET_MATERIALESRow_Base class
} // End of namespace
