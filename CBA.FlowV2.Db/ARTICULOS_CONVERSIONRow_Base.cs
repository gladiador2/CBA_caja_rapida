// <fileinfo name="ARTICULOS_CONVERSIONRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_CONVERSIONRow"/> that 
	/// represents a record in the <c>ARTICULOS_CONVERSION</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_CONVERSIONRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_CONVERSIONRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_CONVERSIONRow_Base"/> class.
		/// </summary>
		public ARTICULOS_CONVERSIONRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_CONVERSIONRow_Base original)
		{
	...
	} // End of ARTICULOS_CONVERSIONRow_Base class
} // End of namespace
