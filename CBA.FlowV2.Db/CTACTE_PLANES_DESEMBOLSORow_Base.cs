// <fileinfo name="CTACTE_PLANES_DESEMBOLSORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_PLANES_DESEMBOLSORow"/> that 
	/// represents a record in the <c>CTACTE_PLANES_DESEMBOLSO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_PLANES_DESEMBOLSORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_PLANES_DESEMBOLSORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_PLANES_DESEMBOLSORow_Base"/> class.
		/// </summary>
		public CTACTE_PLANES_DESEMBOLSORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_PLANES_DESEMBOLSORow_Base original)
		{
	...
	} // End of CTACTE_PLANES_DESEMBOLSORow_Base class
} // End of namespace
