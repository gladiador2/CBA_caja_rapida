// <fileinfo name="ARTICULOS_COMBOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>ARTICULOS_COMBOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_COMBOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_COMBOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public ARTICULOS_COMBOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_COMBOS_INFO_COMPLETARow_Base original)
		{
	...
	} // End of ARTICULOS_COMBOS_INFO_COMPLETARow_Base class
} // End of namespace
