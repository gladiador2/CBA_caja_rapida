// <fileinfo name="ARTICULOS_SUBGRUPOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_SUBGRUPOSRow"/> that 
	/// represents a record in the <c>ARTICULOS_SUBGRUPOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_SUBGRUPOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_SUBGRUPOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_SUBGRUPOSRow_Base"/> class.
		/// </summary>
		public ARTICULOS_SUBGRUPOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_SUBGRUPOSRow_Base original)
		{
	...
	} // End of ARTICULOS_SUBGRUPOSRow_Base class
} // End of namespace
