// <fileinfo name="NOTAS_CREDITO_PROVEED_INF_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="NOTAS_CREDITO_PROVEED_INF_COMPRow"/> that 
	/// represents a record in the <c>NOTAS_CREDITO_PROVEED_INF_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="NOTAS_CREDITO_PROVEED_INF_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class NOTAS_CREDITO_PROVEED_INF_COMPRow_Base
	{
		private decimal _id;
		...
		private string _funcionario_respons_nombre;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NOTAS_CREDITO_PROVEED_INF_COMPRow_Base"/> class.
		/// </summary>
		public NOTAS_CREDITO_PROVEED_INF_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(NOTAS_CREDITO_PROVEED_INF_COMPRow_Base original)
		{
			...
			if (this.FUNCIONARIO_RESPONS_NOMBRE != original.FUNCIONARIO_RESPONS_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>FUNCIONARIO_RESPONS_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>FUNCIONARIO_RESPONS_NOMBRE</c> column value.</value>
		public string FUNCIONARIO_RESPONS_NOMBRE
		{
			get { return _funcionario_respons_nombre; }
			set { _funcionario_respons_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@FUNCIONARIO_RESPONS_NOMBRE=");
			dynStr.Append(FUNCIONARIO_RESPONS_NOMBRE);
	...
	} // End of NOTAS_CREDITO_PROVEED_INF_COMPRow_Base class
} // End of namespace
