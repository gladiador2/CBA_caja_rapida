// <fileinfo name="REGIONESCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="REGIONESCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="REGIONESCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class REGIONESCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="REGIONESCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public REGIONESCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>REGIONES</c> table.
		/// </summary>
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public virtual REGIONESRow[] GetAll()
		{
		...
		/// includes all records from the <c>REGIONES</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>REGIONES</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="REGIONESRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="REGIONESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public REGIONESRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			REGIONESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="REGIONESRow"/> objects that 
		...
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public REGIONESRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public virtual REGIONESRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.REGIONES";
		...
		/// <summary>
		/// Gets <see cref="REGIONESRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="REGIONESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual REGIONESRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			REGIONESRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="REGIONESRow"/> objects 
		/// by the <c>FK_REGIONES_CENTRO_COSTO</c> foreign key.
		/// </summary>
		/// <param name="centro_costo_id">The <c>CENTRO_COSTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public REGIONESRow[] GetByCENTRO_COSTO_ID(decimal centro_costo_id)
		{
		...
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public virtual REGIONESRow[] GetByCENTRO_COSTO_ID(decimal centro_costo_id, bool centro_costo_idNull)
		{
		...
		/// return records by the <c>FK_REGIONES_CENTRO_COSTO</c> foreign key.
		/// </summary>
		/// <param name="centro_costo_id">The <c>CENTRO_COSTO_ID</c> column value.</param>
		/// <param name="centro_costo_idNull">true if the method ignores the centro_costo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="REGIONESRow"/> objects 
		/// by the <c>FK_REGIONES_ENTIDAD</c> foreign key.
		/// </summary>
		/// <param name="entidad_id">The <c>ENTIDAD_ID</c> column value.</param>
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		public virtual REGIONESRow[] GetByENTIDAD_ID(decimal entidad_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_REGIONES_ENTIDAD</c> foreign key.
		/// </summary>
		/// <param name="entidad_id">The <c>ENTIDAD_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>REGIONES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="REGIONESRow"/> object to be inserted.</param>
		public virtual void Insert(REGIONESRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.REGIONES (" +
				"ID, " +
				"NOMBRE, " +
				"ABREVIATURA, " +
				"ESTADO, " +
		...
		/// <summary>
		/// Updates a record in the <c>REGIONES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="REGIONESRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(REGIONESRow value)
		{
			
			string sqlStr = "UPDATE TRC.REGIONES SET " +
		...
		/// <summary>
		/// Updates the <c>REGIONES</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>REGIONES</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>REGIONES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="REGIONESRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(REGIONESRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>REGIONES</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>REGIONES</c> table using the 
		/// <c>FK_REGIONES_CENTRO_COSTO</c> foreign key.
		/// </summary>
		/// <param name="centro_costo_id">The <c>CENTRO_COSTO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_REGIONES_CENTRO_COSTO</c> foreign key.
		/// </summary>
		/// <param name="centro_costo_id">The <c>CENTRO_COSTO_ID</c> column value.</param>
		/// <param name="centro_costo_idNull">true if the method ignores the centro_costo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>REGIONES</c> table using the 
		/// <c>FK_REGIONES_ENTIDAD</c> foreign key.
		/// </summary>
		/// <param name="entidad_id">The <c>ENTIDAD_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_REGIONES_ENTIDAD</c> foreign key.
		/// </summary>
		/// <param name="entidad_id">The <c>ENTIDAD_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>REGIONES</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>REGIONES</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.REGIONES";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>REGIONES</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		protected REGIONESRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		protected REGIONESRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="REGIONESRow"/> objects.</returns>
		protected virtual REGIONESRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					REGIONESRow record = new REGIONESRow();
			...
			return (REGIONESRow[])(recordList.ToArray(typeof(REGIONESRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="REGIONESRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="REGIONESRow"/> object.</returns>
		protected virtual REGIONESRow MapRow(DataRow row)
		{
			REGIONESRow mappedObject = new REGIONESRow();
		...
		/// the <c>REGIONES</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "REGIONES";
			DataColumn dataColumn;
	...
	} // End of REGIONESCollection_Base class
}  // End of namespace
