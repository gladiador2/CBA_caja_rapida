// <fileinfo name="FUNCIONARIOS_BONIF_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FUNCIONARIOS_BONIF_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FUNCIONARIOS_BONIF_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FUNCIONARIOS_BONIF_INFO_COMPLCollection_Base
	{
		// Constants
		...
		public const string BONIFICAION_UNICAColumnName = "BONIFICAION_UNICA";
		...
		public const string MONEDA_CANTIDA_DECIMALESColumnName = "MONEDA_CANTIDA_DECIMALES";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FUNCIONARIOS_BONIF_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public FUNCIONARIOS_BONIF_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FUNCIONARIOS_BONIF_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		public virtual FUNCIONARIOS_BONIF_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>FUNCIONARIOS_BONIF_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>FUNCIONARIOS_BONIF_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FUNCIONARIOS_BONIF_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FUNCIONARIOS_BONIF_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		public FUNCIONARIOS_BONIF_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		public virtual FUNCIONARIOS_BONIF_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.FUNCIONARIOS_BONIF_INFO_COMPL";
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		protected FUNCIONARIOS_BONIF_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		protected FUNCIONARIOS_BONIF_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> objects.</returns>
		protected virtual FUNCIONARIOS_BONIF_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int bonificaion_unicaColumnIndex = reader.GetOrdinal("BONIFICAION_UNICA");
			...
			int moneda_cantida_decimalesColumnIndex = reader.GetOrdinal("MONEDA_CANTIDA_DECIMALES");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					FUNCIONARIOS_BONIF_INFO_COMPLRow record = new FUNCIONARIOS_BONIF_INFO_COMPLRow();
					...
					record.BONIFICAION_UNICA = Convert.ToString(reader.GetValue(bonificaion_unicaColumnIndex));
					...
					record.MONEDA_CANTIDA_DECIMALES = Math.Round(Convert.ToDecimal(reader.GetValue(moneda_cantida_decimalesColumnIndex)), 9);
			...
			return (FUNCIONARIOS_BONIF_INFO_COMPLRow[])(recordList.ToArray(typeof(FUNCIONARIOS_BONIF_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="FUNCIONARIOS_BONIF_INFO_COMPLRow"/> object.</returns>
		protected virtual FUNCIONARIOS_BONIF_INFO_COMPLRow MapRow(DataRow row)
		{
			FUNCIONARIOS_BONIF_INFO_COMPLRow mappedObject = new FUNCIONARIOS_BONIF_INFO_COMPLRow();
			...
			// Column "BONIFICAION_UNICA"
			dataColumn = dataTable.Columns["BONIFICAION_UNICA"];
			if(!row.IsNull(dataColumn))
				mappedObject.BONIFICAION_UNICA = (string)row[dataColumn];
			// Column "DESCONTAR"
			...
			// Column "MONEDA_CANTIDA_DECIMALES"
			dataColumn = dataTable.Columns["MONEDA_CANTIDA_DECIMALES"];
			if(!row.IsNull(dataColumn))
				mappedObject.MONEDA_CANTIDA_DECIMALES = (decimal)row[dataColumn];
		...
		/// the <c>FUNCIONARIOS_BONIF_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FUNCIONARIOS_BONIF_INFO_COMPL";
			DataColumn dataColumn;
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("BONIFICAION_UNICA", typeof(string));
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("MONEDA_CANTIDA_DECIMALES", typeof(decimal));
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
	...
	} // End of FUNCIONARIOS_BONIF_INFO_COMPLCollection_Base class
}  // End of namespace
