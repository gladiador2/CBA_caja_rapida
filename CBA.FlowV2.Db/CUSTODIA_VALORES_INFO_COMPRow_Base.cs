// <fileinfo name="CUSTODIA_VALORES_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CUSTODIA_VALORES_INFO_COMPRow"/> that 
	/// represents a record in the <c>CUSTODIA_VALORES_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CUSTODIA_VALORES_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CUSTODIA_VALORES_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CUSTODIA_VALORES_INFO_COMPRow_Base"/> class.
		/// </summary>
		public CUSTODIA_VALORES_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CUSTODIA_VALORES_INFO_COMPRow_Base original)
		{
	...
	} // End of CUSTODIA_VALORES_INFO_COMPRow_Base class
} // End of namespace
