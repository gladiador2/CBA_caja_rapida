// <fileinfo name="OBJETIVOS_COBRADORES_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="OBJETIVOS_COBRADORES_INFO_COMPRow"/> that 
	/// represents a record in the <c>OBJETIVOS_COBRADORES_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="OBJETIVOS_COBRADORES_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class OBJETIVOS_COBRADORES_INFO_COMPRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OBJETIVOS_COBRADORES_INFO_COMPRow_Base"/> class.
		/// </summary>
		public OBJETIVOS_COBRADORES_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(OBJETIVOS_COBRADORES_INFO_COMPRow_Base original)
		{
	...
	} // End of OBJETIVOS_COBRADORES_INFO_COMPRow_Base class
} // End of namespace
