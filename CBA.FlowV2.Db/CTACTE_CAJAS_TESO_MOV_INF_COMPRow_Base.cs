// <fileinfo name="CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CAJAS_TESO_MOV_INF_COMPRow"/> that 
	/// represents a record in the <c>CTACTE_CAJAS_TESO_MOV_INF_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_CAJAS_TESO_MOV_INF_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base
	{
		private decimal _id;
		...
		private string _ctacte_cheque_recibido_activo;
		private string _ctacte_cheque_recibido_estado;
		private string _ctacte_cheque_recibido_terc;
		...
		private decimal _ctacte_chq_recibido_persona_id;
		private bool _ctacte_chq_recibido_persona_idNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base"/> class.
		/// </summary>
		public CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base original)
		{
			...
			if (this.CTACTE_CHEQUE_RECIBIDO_ACTIVO != original.CTACTE_CHEQUE_RECIBIDO_ACTIVO) return true;
			if (this.CTACTE_CHEQUE_RECIBIDO_ESTADO != original.CTACTE_CHEQUE_RECIBIDO_ESTADO) return true;
			if (this.CTACTE_CHEQUE_RECIBIDO_TERC != original.CTACTE_CHEQUE_RECIBIDO_TERC) return true;
			...
			if (this.IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull != original.IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull) return true;
			if (!this.IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull && !original.IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull)
				if (this.CTACTE_CHQ_RECIBIDO_PERSONA_ID != original.CTACTE_CHQ_RECIBIDO_PERSONA_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_ACTIVO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_ACTIVO</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_ACTIVO
		{
			get { return _ctacte_cheque_recibido_activo; }
			set { _ctacte_cheque_recibido_activo = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_ESTADO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_ESTADO</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_ESTADO
		{
			get { return _ctacte_cheque_recibido_estado; }
			set { _ctacte_cheque_recibido_estado = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_TERC</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_TERC</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_TERC
		{
			get { return _ctacte_cheque_recibido_terc; }
			set { _ctacte_cheque_recibido_terc = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHQ_RECIBIDO_PERSONA_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHQ_RECIBIDO_PERSONA_ID</c> column value.</value>
		public decimal CTACTE_CHQ_RECIBIDO_PERSONA_ID
		{
			get
			{
				if(IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _ctacte_chq_recibido_persona_id;
			}
			set
			{
				_ctacte_chq_recibido_persona_idNull = false;
				_ctacte_chq_recibido_persona_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CTACTE_CHQ_RECIBIDO_PERSONA_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull
		{
			get { return _ctacte_chq_recibido_persona_idNull; }
			set { _ctacte_chq_recibido_persona_idNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_ACTIVO=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_ACTIVO);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_ESTADO=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_ESTADO);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_TERC=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_TERC);
			...
			dynStr.Append("@CBA@CTACTE_CHQ_RECIBIDO_PERSONA_ID=");
			dynStr.Append(IsCTACTE_CHQ_RECIBIDO_PERSONA_IDNull ? (object)"<NULL>" : CTACTE_CHQ_RECIBIDO_PERSONA_ID);
			return dynStr.ToString();
		}
	} // End of CTACTE_CAJAS_TESO_MOV_INF_COMPRow_Base class
} // End of namespace
