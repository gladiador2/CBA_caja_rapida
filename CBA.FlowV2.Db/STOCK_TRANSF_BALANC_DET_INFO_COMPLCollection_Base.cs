// <fileinfo name="STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>STOCK_TRANSF_BALANC_DET_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		public virtual STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>STOCK_TRANSF_BALANC_DET_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>STOCK_TRANSF_BALANC_DET_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public STOCK_TRANSF_BALANC_DET_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		public STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		public virtual STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.STOCK_TRANSF_BALANC_DET_INFO_COMPL";
		...
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		protected STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		protected STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> objects.</returns>
		protected virtual STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					STOCK_TRANSF_BALANC_DET_INFO_COMPLRow record = new STOCK_TRANSF_BALANC_DET_INFO_COMPLRow();
					...
					if(!reader.IsDBNull(deposito_origenColumnIndex))
			...
			return (STOCK_TRANSF_BALANC_DET_INFO_COMPLRow[])(recordList.ToArray(typeof(STOCK_TRANSF_BALANC_DET_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> object.</returns>
		protected virtual STOCK_TRANSF_BALANC_DET_INFO_COMPLRow MapRow(DataRow row)
		{
			STOCK_TRANSF_BALANC_DET_INFO_COMPLRow mappedObject = new STOCK_TRANSF_BALANC_DET_INFO_COMPLRow();
		...
		/// the <c>STOCK_TRANSF_BALANC_DET_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "STOCK_TRANSF_BALANC_DET_INFO_COMPL";
			DataColumn dataColumn;
	...
	} // End of STOCK_TRANSF_BALANC_DET_INFO_COMPLCollection_Base class
}  // End of namespace
