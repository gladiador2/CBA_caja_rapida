// <fileinfo name="STOCK_ART_RESERVA_PROD_BALANRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_ART_RESERVA_PROD_BALANRow"/> that 
	/// represents a record in the <c>STOCK_ART_RESERVA_PROD_BALAN</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_ART_RESERVA_PROD_BALANRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_ART_RESERVA_PROD_BALANRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_ART_RESERVA_PROD_BALANRow_Base"/> class.
		/// </summary>
		public STOCK_ART_RESERVA_PROD_BALANRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_ART_RESERVA_PROD_BALANRow_Base original)
		{
	...
	} // End of STOCK_ART_RESERVA_PROD_BALANRow_Base class
} // End of namespace
