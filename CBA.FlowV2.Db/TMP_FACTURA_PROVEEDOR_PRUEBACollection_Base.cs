// <fileinfo name="TMP_FACTURA_PROVEEDOR_PRUEBACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TMP_FACTURA_PROVEEDOR_PRUEBACollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="TMP_FACTURA_PROVEEDOR_PRUEBACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TMP_FACTURA_PROVEEDOR_PRUEBACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TMP_FACTURA_PROVEEDOR_PRUEBACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public TMP_FACTURA_PROVEEDOR_PRUEBACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		public virtual TMP_FACTURA_PROVEEDOR_PRUEBARow[] GetAll()
		{
		...
		/// includes all records from the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public TMP_FACTURA_PROVEEDOR_PRUEBARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			TMP_FACTURA_PROVEEDOR_PRUEBARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects that 
		...
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		public TMP_FACTURA_PROVEEDOR_PRUEBARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		public virtual TMP_FACTURA_PROVEEDOR_PRUEBARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.TMP_FACTURA_PROVEEDOR_PRUEBA";
		...
		/// <summary>
		/// Adds a new record into the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> object to be inserted.</param>
		public virtual void Insert(TMP_FACTURA_PROVEEDOR_PRUEBARow value)
		{
						
			string sqlStr = "INSERT INTO TRC.TMP_FACTURA_PROVEEDOR_PRUEBA (" +
				"RUC, " +
				"RAZON_SOCIAL, " +
				"FECHA_FACTURA, " +
				"NRO_COMPROBANTE, " +
		...
		/// <summary>
		/// Deletes <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.TMP_FACTURA_PROVEEDOR_PRUEBA";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		protected TMP_FACTURA_PROVEEDOR_PRUEBARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		protected TMP_FACTURA_PROVEEDOR_PRUEBARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> objects.</returns>
		protected virtual TMP_FACTURA_PROVEEDOR_PRUEBARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					TMP_FACTURA_PROVEEDOR_PRUEBARow record = new TMP_FACTURA_PROVEEDOR_PRUEBARow();
			...
			return (TMP_FACTURA_PROVEEDOR_PRUEBARow[])(recordList.ToArray(typeof(TMP_FACTURA_PROVEEDOR_PRUEBARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="TMP_FACTURA_PROVEEDOR_PRUEBARow"/> object.</returns>
		protected virtual TMP_FACTURA_PROVEEDOR_PRUEBARow MapRow(DataRow row)
		{
			TMP_FACTURA_PROVEEDOR_PRUEBARow mappedObject = new TMP_FACTURA_PROVEEDOR_PRUEBARow();
		...
		/// the <c>TMP_FACTURA_PROVEEDOR_PRUEBA</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "TMP_FACTURA_PROVEEDOR_PRUEBA";
			DataColumn dataColumn;
	...
	} // End of TMP_FACTURA_PROVEEDOR_PRUEBACollection_Base class
}  // End of namespace
