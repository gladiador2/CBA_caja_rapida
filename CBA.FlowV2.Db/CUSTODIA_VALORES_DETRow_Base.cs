// <fileinfo name="CUSTODIA_VALORES_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CUSTODIA_VALORES_DETRow"/> that 
	/// represents a record in the <c>CUSTODIA_VALORES_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CUSTODIA_VALORES_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CUSTODIA_VALORES_DETRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CUSTODIA_VALORES_DETRow_Base"/> class.
		/// </summary>
		public CUSTODIA_VALORES_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CUSTODIA_VALORES_DETRow_Base original)
		{
	...
	} // End of CUSTODIA_VALORES_DETRow_Base class
} // End of namespace
