// <fileinfo name="STOCK_ART_RESERVA_POR_PRODBALACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_ART_RESERVA_POR_PRODBALACollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="STOCK_ART_RESERVA_POR_PRODBALACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_ART_RESERVA_POR_PRODBALACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_ART_RESERVA_POR_PRODBALACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public STOCK_ART_RESERVA_POR_PRODBALACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>STOCK_ART_RESERVA_POR_PRODBALA</c> view.
		/// </summary>
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		public virtual STOCK_ART_RESERVA_POR_PRODBALARow[] GetAll()
		{
		...
		/// includes all records from the <c>STOCK_ART_RESERVA_POR_PRODBALA</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>STOCK_ART_RESERVA_POR_PRODBALA</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public STOCK_ART_RESERVA_POR_PRODBALARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			STOCK_ART_RESERVA_POR_PRODBALARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects that 
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		public STOCK_ART_RESERVA_POR_PRODBALARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		public virtual STOCK_ART_RESERVA_POR_PRODBALARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.STOCK_ART_RESERVA_POR_PRODBALA";
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		protected STOCK_ART_RESERVA_POR_PRODBALARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		protected STOCK_ART_RESERVA_POR_PRODBALARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> objects.</returns>
		protected virtual STOCK_ART_RESERVA_POR_PRODBALARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					STOCK_ART_RESERVA_POR_PRODBALARow record = new STOCK_ART_RESERVA_POR_PRODBALARow();
			...
			return (STOCK_ART_RESERVA_POR_PRODBALARow[])(recordList.ToArray(typeof(STOCK_ART_RESERVA_POR_PRODBALARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="STOCK_ART_RESERVA_POR_PRODBALARow"/> object.</returns>
		protected virtual STOCK_ART_RESERVA_POR_PRODBALARow MapRow(DataRow row)
		{
			STOCK_ART_RESERVA_POR_PRODBALARow mappedObject = new STOCK_ART_RESERVA_POR_PRODBALARow();
		...
		/// the <c>STOCK_ART_RESERVA_POR_PRODBALA</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "STOCK_ART_RESERVA_POR_PRODBALA";
			DataColumn dataColumn;
	...
	} // End of STOCK_ART_RESERVA_POR_PRODBALACollection_Base class
}  // End of namespace
