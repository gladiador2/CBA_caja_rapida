// <fileinfo name="STOCK_TRANSFERENCIA_INSUMOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSFERENCIA_INSUMOSRow"/> that 
	/// represents a record in the <c>STOCK_TRANSFERENCIA_INSUMOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSFERENCIA_INSUMOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSFERENCIA_INSUMOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSFERENCIA_INSUMOSRow_Base"/> class.
		/// </summary>
		public STOCK_TRANSFERENCIA_INSUMOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSFERENCIA_INSUMOSRow_Base original)
		{
	...
	} // End of STOCK_TRANSFERENCIA_INSUMOSRow_Base class
} // End of namespace
