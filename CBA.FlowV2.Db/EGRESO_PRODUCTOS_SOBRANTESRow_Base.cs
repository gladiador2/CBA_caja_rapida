// <fileinfo name="EGRESO_PRODUCTOS_SOBRANTESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EGRESO_PRODUCTOS_SOBRANTESRow"/> that 
	/// represents a record in the <c>EGRESO_PRODUCTOS_SOBRANTES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EGRESO_PRODUCTOS_SOBRANTESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EGRESO_PRODUCTOS_SOBRANTESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EGRESO_PRODUCTOS_SOBRANTESRow_Base"/> class.
		/// </summary>
		public EGRESO_PRODUCTOS_SOBRANTESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EGRESO_PRODUCTOS_SOBRANTESRow_Base original)
		{
	...
	} // End of EGRESO_PRODUCTOS_SOBRANTESRow_Base class
} // End of namespace
