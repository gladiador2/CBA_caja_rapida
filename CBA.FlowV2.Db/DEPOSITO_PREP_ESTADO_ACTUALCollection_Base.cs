// <fileinfo name="DEPOSITO_PREP_ESTADO_ACTUALCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DEPOSITO_PREP_ESTADO_ACTUALCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="DEPOSITO_PREP_ESTADO_ACTUALCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DEPOSITO_PREP_ESTADO_ACTUALCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DEPOSITO_PREP_ESTADO_ACTUALCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public DEPOSITO_PREP_ESTADO_ACTUALCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>DEPOSITO_PREP_ESTADO_ACTUAL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		public virtual DEPOSITO_PREP_ESTADO_ACTUALRow[] GetAll()
		{
		...
		/// includes all records from the <c>DEPOSITO_PREP_ESTADO_ACTUAL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>DEPOSITO_PREP_ESTADO_ACTUAL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public DEPOSITO_PREP_ESTADO_ACTUALRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			DEPOSITO_PREP_ESTADO_ACTUALRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects that 
		...
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		public DEPOSITO_PREP_ESTADO_ACTUALRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		public virtual DEPOSITO_PREP_ESTADO_ACTUALRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.DEPOSITO_PREP_ESTADO_ACTUAL";
		...
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		protected DEPOSITO_PREP_ESTADO_ACTUALRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		protected DEPOSITO_PREP_ESTADO_ACTUALRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> objects.</returns>
		protected virtual DEPOSITO_PREP_ESTADO_ACTUALRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					DEPOSITO_PREP_ESTADO_ACTUALRow record = new DEPOSITO_PREP_ESTADO_ACTUALRow();
			...
			return (DEPOSITO_PREP_ESTADO_ACTUALRow[])(recordList.ToArray(typeof(DEPOSITO_PREP_ESTADO_ACTUALRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="DEPOSITO_PREP_ESTADO_ACTUALRow"/> object.</returns>
		protected virtual DEPOSITO_PREP_ESTADO_ACTUALRow MapRow(DataRow row)
		{
			DEPOSITO_PREP_ESTADO_ACTUALRow mappedObject = new DEPOSITO_PREP_ESTADO_ACTUALRow();
		...
		/// the <c>DEPOSITO_PREP_ESTADO_ACTUAL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "DEPOSITO_PREP_ESTADO_ACTUAL";
			DataColumn dataColumn;
	...
	} // End of DEPOSITO_PREP_ESTADO_ACTUALCollection_Base class
}  // End of namespace
