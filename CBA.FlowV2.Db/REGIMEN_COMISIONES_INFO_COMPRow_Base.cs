// <fileinfo name="REGIMEN_COMISIONES_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="REGIMEN_COMISIONES_INFO_COMPRow"/> that 
	/// represents a record in the <c>REGIMEN_COMISIONES_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="REGIMEN_COMISIONES_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class REGIMEN_COMISIONES_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="REGIMEN_COMISIONES_INFO_COMPRow_Base"/> class.
		/// </summary>
		public REGIMEN_COMISIONES_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(REGIMEN_COMISIONES_INFO_COMPRow_Base original)
		{
			...
			if (this.SUBGRUPO != original.SUBGRUPO) return true;
			...
			if (this.LISTA_PRECIOS != original.LISTA_PRECIOS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>SUBGRUPO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>SUBGRUPO</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>LISTA_PRECIOS</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>LISTA_PRECIOS</c> column value.</value>
		public string LISTA_PRECIOS
		{
			get { return _lista_precios; }
			set { _lista_precios = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@SUBGRUPO=");
			dynStr.Append(SUBGRUPO);
			...
			dynStr.Append("@CBA@LISTA_PRECIOS=");
			dynStr.Append(LISTA_PRECIOS);
	...
	} // End of REGIMEN_COMISIONES_INFO_COMPRow_Base class
} // End of namespace
