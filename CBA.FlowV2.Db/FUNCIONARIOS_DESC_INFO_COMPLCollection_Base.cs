// <fileinfo name="FUNCIONARIOS_DESC_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FUNCIONARIOS_DESC_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FUNCIONARIOS_DESC_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FUNCIONARIOS_DESC_INFO_COMPLCollection_Base
	{
		// Constants
		...
		public const string DESCUENTO_CONSUMOColumnName = "DESCUENTO_CONSUMO";
		public const string DESCUENTO_UNICOColumnName = "DESCUENTO_UNICO";
		...
		public const string EMPRESA_SECCION_NOMBREColumnName = "EMPRESA_SECCION_NOMBRE";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FUNCIONARIOS_DESC_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public FUNCIONARIOS_DESC_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FUNCIONARIOS_DESC_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		public virtual FUNCIONARIOS_DESC_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>FUNCIONARIOS_DESC_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>FUNCIONARIOS_DESC_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FUNCIONARIOS_DESC_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FUNCIONARIOS_DESC_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		public FUNCIONARIOS_DESC_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		public virtual FUNCIONARIOS_DESC_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.FUNCIONARIOS_DESC_INFO_COMPL";
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		protected FUNCIONARIOS_DESC_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		protected FUNCIONARIOS_DESC_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> objects.</returns>
		protected virtual FUNCIONARIOS_DESC_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int descuento_consumoColumnIndex = reader.GetOrdinal("DESCUENTO_CONSUMO");
			int descuento_unicoColumnIndex = reader.GetOrdinal("DESCUENTO_UNICO");
			...
			int empresa_seccion_nombreColumnIndex = reader.GetOrdinal("EMPRESA_SECCION_NOMBRE");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					FUNCIONARIOS_DESC_INFO_COMPLRow record = new FUNCIONARIOS_DESC_INFO_COMPLRow();
					...
					record.DESCUENTO_CONSUMO = Convert.ToString(reader.GetValue(descuento_consumoColumnIndex));
					record.DESCUENTO_UNICO = Convert.ToString(reader.GetValue(descuento_unicoColumnIndex));
					...
					if(!reader.IsDBNull(empresa_seccion_nombreColumnIndex))
						record.EMPRESA_SECCION_NOMBRE = Convert.ToString(reader.GetValue(empresa_seccion_nombreColumnIndex));
			...
			return (FUNCIONARIOS_DESC_INFO_COMPLRow[])(recordList.ToArray(typeof(FUNCIONARIOS_DESC_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="FUNCIONARIOS_DESC_INFO_COMPLRow"/> object.</returns>
		protected virtual FUNCIONARIOS_DESC_INFO_COMPLRow MapRow(DataRow row)
		{
			FUNCIONARIOS_DESC_INFO_COMPLRow mappedObject = new FUNCIONARIOS_DESC_INFO_COMPLRow();
			...
			// Column "DESCUENTO_CONSUMO"
			dataColumn = dataTable.Columns["DESCUENTO_CONSUMO"];
			if(!row.IsNull(dataColumn))
				mappedObject.DESCUENTO_CONSUMO = (string)row[dataColumn];
			// Column "DESCUENTO_UNICO"
			dataColumn = dataTable.Columns["DESCUENTO_UNICO"];
			if(!row.IsNull(dataColumn))
				mappedObject.DESCUENTO_UNICO = (string)row[dataColumn];
			...
			// Column "EMPRESA_SECCION_NOMBRE"
			dataColumn = dataTable.Columns["EMPRESA_SECCION_NOMBRE"];
			if(!row.IsNull(dataColumn))
				mappedObject.EMPRESA_SECCION_NOMBRE = (string)row[dataColumn];
		...
		/// the <c>FUNCIONARIOS_DESC_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FUNCIONARIOS_DESC_INFO_COMPL";
			DataColumn dataColumn;
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("DESCUENTO_CONSUMO", typeof(string));
			dataColumn.MaxLength = 1;
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("DESCUENTO_UNICO", typeof(string));
			dataColumn.MaxLength = 1;
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			...
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("EMPRESA_SECCION_NOMBRE", typeof(string));
			dataColumn.MaxLength = 50;
			dataColumn.ReadOnly = true;
		...
		protected virtual IDbDataParameter AddParameter(IDbCommand cmd, string paramName, object value)
		{
			...
			switch(paramName)
			{
				...
				case "DESCUENTO_CONSUMO":
					parameter = _db.AddParameter(cmd, paramName, DbType.AnsiStringFixedLength, value);
					break;

				case "DESCUENTO_UNICO":
					parameter = _db.AddParameter(cmd, paramName, DbType.AnsiStringFixedLength, value);
					break;
	...
	} // End of FUNCIONARIOS_DESC_INFO_COMPLCollection_Base class
}  // End of namespace
