// <fileinfo name="DETALLES_PERSONALIZADOS_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DETALLES_PERSONALIZADOS_DETRow"/> that 
	/// represents a record in the <c>DETALLES_PERSONALIZADOS_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="DETALLES_PERSONALIZADOS_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DETALLES_PERSONALIZADOS_DETRow_Base
	{
		private decimal _id;
		private decimal _detalle_personalizado_id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DETALLES_PERSONALIZADOS_DETRow_Base"/> class.
		/// </summary>
		public DETALLES_PERSONALIZADOS_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(DETALLES_PERSONALIZADOS_DETRow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.DETALLE_PERSONALIZADO_ID != original.DETALLE_PERSONALIZADO_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>DETALLE_PERSONALIZADO_ID</c> column value.
		/// </summary>
		/// <value>The <c>DETALLE_PERSONALIZADO_ID</c> column value.</value>
		public decimal DETALLE_PERSONALIZADO_ID
		{
			get { return _detalle_personalizado_id; }
			set { _detalle_personalizado_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(ID);
			dynStr.Append("@CBA@DETALLE_PERSONALIZADO_ID=");
			dynStr.Append(DETALLE_PERSONALIZADO_ID);
	...
	} // End of DETALLES_PERSONALIZADOS_DETRow_Base class
} // End of namespace
