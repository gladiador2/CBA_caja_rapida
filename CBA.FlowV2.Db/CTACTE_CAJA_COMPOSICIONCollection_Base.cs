// <fileinfo name="CTACTE_CAJA_COMPOSICIONCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CAJA_COMPOSICIONCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CTACTE_CAJA_COMPOSICIONCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CAJA_COMPOSICIONCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CAJA_COMPOSICIONCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CTACTE_CAJA_COMPOSICIONCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow[] GetAll()
		{
		...
		/// includes all records from the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CTACTE_CAJA_COMPOSICIONRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CTACTE_CAJA_COMPOSICIONRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects that 
		...
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public CTACTE_CAJA_COMPOSICIONRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CTACTE_CAJA_COMPOSICION";
		...
		/// <summary>
		/// Gets <see cref="CTACTE_CAJA_COMPOSICIONRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			CTACTE_CAJA_COMPOSICIONRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects 
		/// by the <c>FK_CTACTE_CAJA_COMPOS_CAJA_S</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public CTACTE_CAJA_COMPOSICIONRow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id)
		{
		...
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id, bool ctacte_caja_sucursal_idNull)
		{
		...
		/// return records by the <c>FK_CTACTE_CAJA_COMPOS_CAJA_S</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects 
		/// by the <c>FK_CTACTE_CAJA_COMPOS_FONDO_F</c> foreign key.
		/// </summary>
		/// <param name="ctacte_fondo_fijo_id">The <c>CTACTE_FONDO_FIJO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public CTACTE_CAJA_COMPOSICIONRow[] GetByCTACTE_FONDO_FIJO_ID(decimal ctacte_fondo_fijo_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow[] GetByCTACTE_FONDO_FIJO_ID(decimal ctacte_fondo_fijo_id, bool ctacte_fondo_fijo_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CTACTE_CAJA_COMPOS_FONDO_F</c> foreign key.
		/// </summary>
		/// <param name="ctacte_fondo_fijo_id">The <c>CTACTE_FONDO_FIJO_ID</c> column value.</param>
		/// <param name="ctacte_fondo_fijo_idNull">true if the method ignores the ctacte_fondo_fijo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects 
		/// by the <c>FK_CTACTE_CAJA_COMPOS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		public virtual CTACTE_CAJA_COMPOSICIONRow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CTACTE_CAJA_COMPOS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CTACTE_CAJA_COMPOSICIONRow"/> object to be inserted.</param>
		public virtual void Insert(CTACTE_CAJA_COMPOSICIONRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.CTACTE_CAJA_COMPOSICION (" +
				"ID, " +
				"SUCURSAL_ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CTACTE_CAJA_COMPOSICIONRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(CTACTE_CAJA_COMPOSICIONRow value)
		{
			
			string sqlStr = "UPDATE TRC.CTACTE_CAJA_COMPOSICION SET " +
		...
		/// <summary>
		/// Updates the <c>CTACTE_CAJA_COMPOSICION</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>CTACTE_CAJA_COMPOSICION</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CTACTE_CAJA_COMPOSICIONRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(CTACTE_CAJA_COMPOSICIONRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>CTACTE_CAJA_COMPOSICION</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>CTACTE_CAJA_COMPOSICION</c> table using the 
		/// <c>FK_CTACTE_CAJA_COMPOS_CAJA_S</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CTACTE_CAJA_COMPOS_CAJA_S</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CTACTE_CAJA_COMPOSICION</c> table using the 
		/// <c>FK_CTACTE_CAJA_COMPOS_FONDO_F</c> foreign key.
		/// </summary>
		/// <param name="ctacte_fondo_fijo_id">The <c>CTACTE_FONDO_FIJO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CTACTE_CAJA_COMPOS_FONDO_F</c> foreign key.
		/// </summary>
		/// <param name="ctacte_fondo_fijo_id">The <c>CTACTE_FONDO_FIJO_ID</c> column value.</param>
		/// <param name="ctacte_fondo_fijo_idNull">true if the method ignores the ctacte_fondo_fijo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CTACTE_CAJA_COMPOSICION</c> table using the 
		/// <c>FK_CTACTE_CAJA_COMPOS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CTACTE_CAJA_COMPOS_SUC</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>CTACTE_CAJA_COMPOSICION</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>CTACTE_CAJA_COMPOSICION</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.CTACTE_CAJA_COMPOSICION";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		protected CTACTE_CAJA_COMPOSICIONRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		protected CTACTE_CAJA_COMPOSICIONRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CTACTE_CAJA_COMPOSICIONRow"/> objects.</returns>
		protected virtual CTACTE_CAJA_COMPOSICIONRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CTACTE_CAJA_COMPOSICIONRow record = new CTACTE_CAJA_COMPOSICIONRow();
			...
			return (CTACTE_CAJA_COMPOSICIONRow[])(recordList.ToArray(typeof(CTACTE_CAJA_COMPOSICIONRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CTACTE_CAJA_COMPOSICIONRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CTACTE_CAJA_COMPOSICIONRow"/> object.</returns>
		protected virtual CTACTE_CAJA_COMPOSICIONRow MapRow(DataRow row)
		{
			CTACTE_CAJA_COMPOSICIONRow mappedObject = new CTACTE_CAJA_COMPOSICIONRow();
		...
		/// the <c>CTACTE_CAJA_COMPOSICION</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CTACTE_CAJA_COMPOSICION";
			DataColumn dataColumn;
	...
	} // End of CTACTE_CAJA_COMPOSICIONCollection_Base class
}  // End of namespace
