// <fileinfo name="CTB_ASIENTOS_AUTOMATICOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_ASIENTOS_AUTOMATICOSRow"/> that 
	/// represents a record in the <c>CTB_ASIENTOS_AUTOMATICOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_ASIENTOS_AUTOMATICOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_ASIENTOS_AUTOMATICOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_ASIENTOS_AUTOMATICOSRow_Base"/> class.
		/// </summary>
		public CTB_ASIENTOS_AUTOMATICOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_ASIENTOS_AUTOMATICOSRow_Base original)
		{
	...
	} // End of CTB_ASIENTOS_AUTOMATICOSRow_Base class
} // End of namespace
