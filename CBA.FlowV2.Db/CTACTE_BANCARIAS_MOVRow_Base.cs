// <fileinfo name="CTACTE_BANCARIAS_MOVRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_BANCARIAS_MOVRow"/> that 
	/// represents a record in the <c>CTACTE_BANCARIAS_MOV</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_BANCARIAS_MOVRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_BANCARIAS_MOVRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_BANCARIAS_MOVRow_Base"/> class.
		/// </summary>
		public CTACTE_BANCARIAS_MOVRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_BANCARIAS_MOVRow_Base original)
		{
	...
	} // End of CTACTE_BANCARIAS_MOVRow_Base class
} // End of namespace
