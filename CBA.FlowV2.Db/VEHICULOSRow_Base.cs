// <fileinfo name="VEHICULOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="VEHICULOSRow"/> that 
	/// represents a record in the <c>VEHICULOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="VEHICULOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class VEHICULOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="VEHICULOSRow_Base"/> class.
		/// </summary>
		public VEHICULOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(VEHICULOSRow_Base original)
		{
	...
	} // End of VEHICULOSRow_Base class
} // End of namespace
