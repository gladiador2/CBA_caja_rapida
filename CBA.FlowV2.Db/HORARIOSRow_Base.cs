// <fileinfo name="HORARIOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="HORARIOSRow"/> that 
	/// represents a record in the <c>HORARIOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="HORARIOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class HORARIOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="HORARIOSRow_Base"/> class.
		/// </summary>
		public HORARIOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(HORARIOSRow_Base original)
		{
