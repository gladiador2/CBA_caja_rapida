// <fileinfo name="MOVIMIENTOS_VARIOS_TESO_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MOVIMIENTOS_VARIOS_TESO_DETRow"/> that 
	/// represents a record in the <c>MOVIMIENTOS_VARIOS_TESO_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MOVIMIENTOS_VARIOS_TESO_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MOVIMIENTOS_VARIOS_TESO_DETRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MOVIMIENTOS_VARIOS_TESO_DETRow_Base"/> class.
		/// </summary>
		public MOVIMIENTOS_VARIOS_TESO_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(MOVIMIENTOS_VARIOS_TESO_DETRow_Base original)
		{
	...
	} // End of MOVIMIENTOS_VARIOS_TESO_DETRow_Base class
} // End of namespace
