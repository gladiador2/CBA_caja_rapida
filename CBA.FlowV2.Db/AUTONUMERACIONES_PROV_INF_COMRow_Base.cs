// <fileinfo name="AUTONUMERACIONES_PROV_INF_COMRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="AUTONUMERACIONES_PROV_INF_COMRow"/> that 
	/// represents a record in the <c>AUTONUMERACIONES_PROV_INF_COM</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="AUTONUMERACIONES_PROV_INF_COMRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class AUTONUMERACIONES_PROV_INF_COMRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AUTONUMERACIONES_PROV_INF_COMRow_Base"/> class.
		/// </summary>
		public AUTONUMERACIONES_PROV_INF_COMRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(AUTONUMERACIONES_PROV_INF_COMRow_Base original)
		{
	...
	} // End of AUTONUMERACIONES_PROV_INF_COMRow_Base class
} // End of namespace
