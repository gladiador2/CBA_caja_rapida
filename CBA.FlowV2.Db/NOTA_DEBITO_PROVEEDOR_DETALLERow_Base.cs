// <fileinfo name="NOTA_DEBITO_PROVEEDOR_DETALLERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="NOTA_DEBITO_PROVEEDOR_DETALLERow"/> that 
	/// represents a record in the <c>NOTA_DEBITO_PROVEEDOR_DETALLE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="NOTA_DEBITO_PROVEEDOR_DETALLERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class NOTA_DEBITO_PROVEEDOR_DETALLERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NOTA_DEBITO_PROVEEDOR_DETALLERow_Base"/> class.
		/// </summary>
		public NOTA_DEBITO_PROVEEDOR_DETALLERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(NOTA_DEBITO_PROVEEDOR_DETALLERow_Base original)
		{
	...
	} // End of NOTA_DEBITO_PROVEEDOR_DETALLERow_Base class
} // End of namespace
