// <fileinfo name="INGRESO_STOCK_DET_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="INGRESO_STOCK_DET_INFO_COMPLRow"/> that 
	/// represents a record in the <c>INGRESO_STOCK_DET_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="INGRESO_STOCK_DET_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class INGRESO_STOCK_DET_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		private decimal _costo_total_prorrateado;
		private bool _costo_total_prorrateadoNull = true;
		private decimal _activo_id;
		private bool _activo_idNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="INGRESO_STOCK_DET_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public INGRESO_STOCK_DET_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(INGRESO_STOCK_DET_INFO_COMPLRow_Base original)
		{
			...
			if (this.IsCOSTO_TOTAL_PRORRATEADONull != original.IsCOSTO_TOTAL_PRORRATEADONull) return true;
			if (!this.IsCOSTO_TOTAL_PRORRATEADONull && !original.IsCOSTO_TOTAL_PRORRATEADONull)
				if (this.COSTO_TOTAL_PRORRATEADO != original.COSTO_TOTAL_PRORRATEADO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>COSTO_TOTAL_PRORRATEADO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>COSTO_TOTAL_PRORRATEADO</c> column value.</value>
		public decimal COSTO_TOTAL_PRORRATEADO
		{
			get
			{
				if(IsCOSTO_TOTAL_PRORRATEADONull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _costo_total_prorrateado;
			}
			set
			{
				_costo_total_prorrateadoNull = false;
				_costo_total_prorrateado = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="COSTO_TOTAL_PRORRATEADO"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCOSTO_TOTAL_PRORRATEADONull
		{
			get { return _costo_total_prorrateadoNull; }
			set { _costo_total_prorrateadoNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@COSTO_TOTAL_PRORRATEADO=");
			dynStr.Append(IsCOSTO_TOTAL_PRORRATEADONull ? (object)"<NULL>" : COSTO_TOTAL_PRORRATEADO);
			dynStr.Append("@CBA@ACTIVO_ID=");
			dynStr.Append(IsACTIVO_IDNull ? (object)"<NULL>" : ACTIVO_ID);
			return dynStr.ToString();
		}
	} // End of INGRESO_STOCK_DET_INFO_COMPLRow_Base class
} // End of namespace
