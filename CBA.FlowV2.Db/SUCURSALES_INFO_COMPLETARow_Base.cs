// <fileinfo name="SUCURSALES_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="SUCURSALES_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>SUCURSALES_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="SUCURSALES_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class SUCURSALES_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _region_abreviatura;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SUCURSALES_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public SUCURSALES_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(SUCURSALES_INFO_COMPLETARow_Base original)
		{
			...
			if (this.REGION_ABREVIATURA != original.REGION_ABREVIATURA) return true;
		...
		/// <summary>
		/// Gets or sets the <c>REGION_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>REGION_ABREVIATURA</c> column value.</value>
		public string REGION_ABREVIATURA
		{
			get { return _region_abreviatura; }
			set { _region_abreviatura = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@REGION_ABREVIATURA=");
			dynStr.Append(REGION_ABREVIATURA);
	...
	} // End of SUCURSALES_INFO_COMPLETARow_Base class
} // End of namespace
