// <fileinfo name="PRE_EMB_CONTENEDOR_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PRE_EMB_CONTENEDOR_INFO_COMPRow"/> that 
	/// represents a record in the <c>PRE_EMB_CONTENEDOR_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PRE_EMB_CONTENEDOR_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PRE_EMB_CONTENEDOR_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		private decimal _contenedor_tipo_id;
		private bool _contenedor_tipo_idNull = true;
		private decimal _contenedor_linea_id;
		private bool _contenedor_linea_idNull = true;
		...
		private string _imo_nombre;
		private string _danado;
		private string _dano_informado;

		/// <summary>
		/// Initializes a new instance of the <see cref="PRE_EMB_CONTENEDOR_INFO_COMPRow_Base"/> class.
		/// </summary>
		public PRE_EMB_CONTENEDOR_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PRE_EMB_CONTENEDOR_INFO_COMPRow_Base original)
		{
			...
			if (this.IsCONTENEDOR_TIPO_IDNull != original.IsCONTENEDOR_TIPO_IDNull) return true;
			if (!this.IsCONTENEDOR_TIPO_IDNull && !original.IsCONTENEDOR_TIPO_IDNull)
				if (this.CONTENEDOR_TIPO_ID != original.CONTENEDOR_TIPO_ID) return true;
			if (this.IsCONTENEDOR_LINEA_IDNull != original.IsCONTENEDOR_LINEA_IDNull) return true;
			if (!this.IsCONTENEDOR_LINEA_IDNull && !original.IsCONTENEDOR_LINEA_IDNull)
				if (this.CONTENEDOR_LINEA_ID != original.CONTENEDOR_LINEA_ID) return true;
			...
			if (this.IMO_NOMBRE != original.IMO_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CONTENEDOR_TIPO_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CONTENEDOR_TIPO_ID</c> column value.</value>
		public decimal CONTENEDOR_TIPO_ID
		{
			get
			{
				if(IsCONTENEDOR_TIPO_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _contenedor_tipo_id;
			}
			set
			{
				_contenedor_tipo_idNull = false;
				_contenedor_tipo_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CONTENEDOR_TIPO_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCONTENEDOR_TIPO_IDNull
		{
			get { return _contenedor_tipo_idNull; }
			set { _contenedor_tipo_idNull = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CONTENEDOR_LINEA_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CONTENEDOR_LINEA_ID</c> column value.</value>
		public decimal CONTENEDOR_LINEA_ID
		{
			get
			{
				if(IsCONTENEDOR_LINEA_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _contenedor_linea_id;
			}
			set
			{
				_contenedor_linea_idNull = false;
				_contenedor_linea_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CONTENEDOR_LINEA_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCONTENEDOR_LINEA_IDNull
		{
			get { return _contenedor_linea_idNull; }
			set { _contenedor_linea_idNull = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>IMO_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>IMO_NOMBRE</c> column value.</value>
		public string IMO_NOMBRE
		{
			get { return _imo_nombre; }
			set { _imo_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CONTENEDOR_TIPO_ID=");
			dynStr.Append(IsCONTENEDOR_TIPO_IDNull ? (object)"<NULL>" : CONTENEDOR_TIPO_ID);
			dynStr.Append("@CBA@CONTENEDOR_LINEA_ID=");
			dynStr.Append(IsCONTENEDOR_LINEA_IDNull ? (object)"<NULL>" : CONTENEDOR_LINEA_ID);
			...
			dynStr.Append("@CBA@IMO_NOMBRE=");
			dynStr.Append(IMO_NOMBRE);
	...
	} // End of PRE_EMB_CONTENEDOR_INFO_COMPRow_Base class
} // End of namespace
