// <fileinfo name="CALENDARIO_PAGOS_FC_CLIENTERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CALENDARIO_PAGOS_FC_CLIENTERow"/> that 
	/// represents a record in the <c>CALENDARIO_PAGOS_FC_CLIENTE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CALENDARIO_PAGOS_FC_CLIENTERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CALENDARIO_PAGOS_FC_CLIENTERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CALENDARIO_PAGOS_FC_CLIENTERow_Base"/> class.
		/// </summary>
		public CALENDARIO_PAGOS_FC_CLIENTERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CALENDARIO_PAGOS_FC_CLIENTERow_Base original)
		{
		...
		{
			get { return _factura_cliente_id; }
			set { _factura_cliente_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(FACTURA_CLIENTE_ID);
	...
	} // End of CALENDARIO_PAGOS_FC_CLIENTERow_Base class
} // End of namespace
