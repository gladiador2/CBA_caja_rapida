// <fileinfo name="LINEA_CREDITO_FACTURA_PENDRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="LINEA_CREDITO_FACTURA_PENDRow"/> that 
	/// represents a record in the <c>LINEA_CREDITO_FACTURA_PEND</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="LINEA_CREDITO_FACTURA_PENDRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class LINEA_CREDITO_FACTURA_PENDRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LINEA_CREDITO_FACTURA_PENDRow_Base"/> class.
		/// </summary>
		public LINEA_CREDITO_FACTURA_PENDRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(LINEA_CREDITO_FACTURA_PENDRow_Base original)
		{
	...
	} // End of LINEA_CREDITO_FACTURA_PENDRow_Base class
} // End of namespace
