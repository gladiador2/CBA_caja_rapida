// <fileinfo name="COPARN_DETALLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="COPARN_DETALLESRow"/> that 
	/// represents a record in the <c>COPARN_DETALLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="COPARN_DETALLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class COPARN_DETALLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="COPARN_DETALLESRow_Base"/> class.
		/// </summary>
		public COPARN_DETALLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(COPARN_DETALLESRow_Base original)
		{
	...
	} // End of COPARN_DETALLESRow_Base class
} // End of namespace
