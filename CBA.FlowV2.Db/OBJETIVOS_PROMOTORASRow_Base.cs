// <fileinfo name="OBJETIVOS_PROMOTORASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="OBJETIVOS_PROMOTORASRow"/> that 
	/// represents a record in the <c>OBJETIVOS_PROMOTORAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="OBJETIVOS_PROMOTORASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class OBJETIVOS_PROMOTORASRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="OBJETIVOS_PROMOTORASRow_Base"/> class.
		/// </summary>
		public OBJETIVOS_PROMOTORASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(OBJETIVOS_PROMOTORASRow_Base original)
		{
	...
	} // End of OBJETIVOS_PROMOTORASRow_Base class
} // End of namespace
