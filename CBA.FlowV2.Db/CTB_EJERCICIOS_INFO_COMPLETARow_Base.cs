// <fileinfo name="CTB_EJERCICIOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_EJERCICIOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>CTB_EJERCICIOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_EJERCICIOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_EJERCICIOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _plan_cuenta_nombre;
		...
		private string _ejercicio_anterior_nombre;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_EJERCICIOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public CTB_EJERCICIOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_EJERCICIOS_INFO_COMPLETARow_Base original)
		{
			...
			if (this.PLAN_CUENTA_NOMBRE != original.PLAN_CUENTA_NOMBRE) return true;
			...
			if (this.EJERCICIO_ANTERIOR_NOMBRE != original.EJERCICIO_ANTERIOR_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>PLAN_CUENTA_NOMBRE</c> column value.
		/// </summary>
		/// <value>The <c>PLAN_CUENTA_NOMBRE</c> column value.</value>
		public string PLAN_CUENTA_NOMBRE
		{
			get { return _plan_cuenta_nombre; }
			set { _plan_cuenta_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>EJERCICIO_ANTERIOR_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>EJERCICIO_ANTERIOR_NOMBRE</c> column value.</value>
		public string EJERCICIO_ANTERIOR_NOMBRE
		{
			get { return _ejercicio_anterior_nombre; }
			set { _ejercicio_anterior_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@PLAN_CUENTA_NOMBRE=");
			dynStr.Append(PLAN_CUENTA_NOMBRE);
			...
			dynStr.Append("@CBA@EJERCICIO_ANTERIOR_NOMBRE=");
			dynStr.Append(EJERCICIO_ANTERIOR_NOMBRE);
	...
	} // End of CTB_EJERCICIOS_INFO_COMPLETARow_Base class
} // End of namespace
