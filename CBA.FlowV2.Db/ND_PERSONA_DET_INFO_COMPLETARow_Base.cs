// <fileinfo name="ND_PERSONA_DET_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ND_PERSONA_DET_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>ND_PERSONA_DET_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ND_PERSONA_DET_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ND_PERSONA_DET_INFO_COMPLETARow_Base
	{
		private decimal _id;
		private decimal _nota_debito_persona_id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ND_PERSONA_DET_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public ND_PERSONA_DET_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ND_PERSONA_DET_INFO_COMPLETARow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.NOTA_DEBITO_PERSONA_ID != original.NOTA_DEBITO_PERSONA_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>NOTA_DEBITO_PERSONA_ID</c> column value.
		/// </summary>
		/// <value>The <c>NOTA_DEBITO_PERSONA_ID</c> column value.</value>
		public decimal NOTA_DEBITO_PERSONA_ID
		{
			get { return _nota_debito_persona_id; }
			set { _nota_debito_persona_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(ID);
			dynStr.Append("@CBA@NOTA_DEBITO_PERSONA_ID=");
			dynStr.Append(NOTA_DEBITO_PERSONA_ID);
	...
	} // End of ND_PERSONA_DET_INFO_COMPLETARow_Base class
} // End of namespace
