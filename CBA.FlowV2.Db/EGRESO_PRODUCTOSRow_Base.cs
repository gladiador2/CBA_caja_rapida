// <fileinfo name="EGRESO_PRODUCTOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EGRESO_PRODUCTOSRow"/> that 
	/// represents a record in the <c>EGRESO_PRODUCTOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EGRESO_PRODUCTOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EGRESO_PRODUCTOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EGRESO_PRODUCTOSRow_Base"/> class.
		/// </summary>
		public EGRESO_PRODUCTOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EGRESO_PRODUCTOSRow_Base original)
		{
	...
	} // End of EGRESO_PRODUCTOSRow_Base class
} // End of namespace
