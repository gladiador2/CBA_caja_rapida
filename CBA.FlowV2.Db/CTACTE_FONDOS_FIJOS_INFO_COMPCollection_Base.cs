// <fileinfo name="CTACTE_FONDOS_FIJOS_INFO_COMPCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_FONDOS_FIJOS_INFO_COMPCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CTACTE_FONDOS_FIJOS_INFO_COMPCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CTACTE_FONDOS_FIJOS_INFO_COMP</c> view.
		/// </summary>
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		public virtual CTACTE_FONDOS_FIJOS_INFO_COMPRow[] GetAll()
		{
		...
		/// includes all records from the <c>CTACTE_FONDOS_FIJOS_INFO_COMP</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>CTACTE_FONDOS_FIJOS_INFO_COMP</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CTACTE_FONDOS_FIJOS_INFO_COMPRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CTACTE_FONDOS_FIJOS_INFO_COMPRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects that 
		...
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		public CTACTE_FONDOS_FIJOS_INFO_COMPRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		public virtual CTACTE_FONDOS_FIJOS_INFO_COMPRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CTACTE_FONDOS_FIJOS_INFO_COMP";
		...
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		protected CTACTE_FONDOS_FIJOS_INFO_COMPRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		protected CTACTE_FONDOS_FIJOS_INFO_COMPRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> objects.</returns>
		protected virtual CTACTE_FONDOS_FIJOS_INFO_COMPRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CTACTE_FONDOS_FIJOS_INFO_COMPRow record = new CTACTE_FONDOS_FIJOS_INFO_COMPRow();
			...
			return (CTACTE_FONDOS_FIJOS_INFO_COMPRow[])(recordList.ToArray(typeof(CTACTE_FONDOS_FIJOS_INFO_COMPRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CTACTE_FONDOS_FIJOS_INFO_COMPRow"/> object.</returns>
		protected virtual CTACTE_FONDOS_FIJOS_INFO_COMPRow MapRow(DataRow row)
		{
			CTACTE_FONDOS_FIJOS_INFO_COMPRow mappedObject = new CTACTE_FONDOS_FIJOS_INFO_COMPRow();
		...
		/// the <c>CTACTE_FONDOS_FIJOS_INFO_COMP</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CTACTE_FONDOS_FIJOS_INFO_COMP";
			DataColumn dataColumn;
	...
	} // End of CTACTE_FONDOS_FIJOS_INFO_COMPCollection_Base class
}  // End of namespace
