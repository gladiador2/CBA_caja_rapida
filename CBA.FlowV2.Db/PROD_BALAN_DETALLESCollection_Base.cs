// <fileinfo name="PROD_BALAN_DETALLESCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PROD_BALAN_DETALLESCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="PROD_BALAN_DETALLESCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PROD_BALAN_DETALLESCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PROD_BALAN_DETALLESCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public PROD_BALAN_DETALLESCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetAll()
		{
		...
		/// includes all records from the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="PROD_BALAN_DETALLESRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="PROD_BALAN_DETALLESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public PROD_BALAN_DETALLESRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			PROD_BALAN_DETALLESRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects that 
		...
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.PROD_BALAN_DETALLES";
		...
		/// <summary>
		/// Gets <see cref="PROD_BALAN_DETALLESRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="PROD_BALAN_DETALLESRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual PROD_BALAN_DETALLESRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			PROD_BALAN_DETALLESRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// return records by the <c>FK_PROD_BALAN_DET_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_CIUDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="ciudad_id">The <c>CIUDAD_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByCIUDAD_ID(decimal ciudad_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByCIUDAD_ID(decimal ciudad_id, bool ciudad_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_CIUDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="ciudad_id">The <c>CIUDAD_ID</c> column value.</param>
		/// <param name="ciudad_idNull">true if the method ignores the ciudad_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_DEPART_ID</c> foreign key.
		/// </summary>
		/// <param name="departamento_id">The <c>DEPARTAMENTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByDEPARTAMENTO_ID(decimal departamento_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByDEPARTAMENTO_ID(decimal departamento_id, bool departamento_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_DEPART_ID</c> foreign key.
		/// </summary>
		/// <param name="departamento_id">The <c>DEPARTAMENTO_ID</c> column value.</param>
		/// <param name="departamento_idNull">true if the method ignores the departamento_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByPERSONA_ID(decimal persona_id, bool persona_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_PRESEN_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByPRESENTACION_ID(decimal presentacion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByPRESENTACION_ID(decimal presentacion_id, bool presentacion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_PRESEN_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <param name="presentacion_idNull">true if the method ignores the presentacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_PROD_BAL_ID</c> foreign key.
		/// </summary>
		/// <param name="prod_balan_id">The <c>PROD_BALAN_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByPROD_BALAN_ID(decimal prod_balan_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_PROD_BAL_ID</c> foreign key.
		/// </summary>
		/// <param name="prod_balan_id">The <c>PROD_BALAN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_PROVEE_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public PROD_BALAN_DETALLESRow[] GetByPROVEEDOR_ID(decimal proveedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByPROVEEDOR_ID(decimal proveedor_id, bool proveedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_PROVEE_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_UNIDAD_BAS</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_bascula">The <c>UNIDAD_MEDIDA_BASCULA</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByUNIDAD_MEDIDA_BASCULA(string unidad_medida_bascula)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_UNIDAD_BAS</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_bascula">The <c>UNIDAD_MEDIDA_BASCULA</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="PROD_BALAN_DETALLESRow"/> objects 
		/// by the <c>FK_PROD_BALAN_DET_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		public virtual PROD_BALAN_DETALLESRow[] GetByUNIDAD_MEDIDA_ID(string unidad_medida_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_PROD_BALAN_DET_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PROD_BALAN_DETALLESRow"/> object to be inserted.</param>
		public virtual void Insert(PROD_BALAN_DETALLESRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.PROD_BALAN_DETALLES (" +
				"ID, " +
				"PROD_BALAN_ID, " +
				"CHAPA_CAMION, " +
				"CHAPA_CARRETA, " +
		...
		/// <summary>
		/// Updates a record in the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PROD_BALAN_DETALLESRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(PROD_BALAN_DETALLESRow value)
		{
			
			string sqlStr = "UPDATE TRC.PROD_BALAN_DETALLES SET " +
		...
		/// <summary>
		/// Updates the <c>PROD_BALAN_DETALLES</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>PROD_BALAN_DETALLES</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <param name="value">The <see cref="PROD_BALAN_DETALLESRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(PROD_BALAN_DETALLESRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>PROD_BALAN_DETALLES</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_CIUDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="ciudad_id">The <c>CIUDAD_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_CIUDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="ciudad_id">The <c>CIUDAD_ID</c> column value.</param>
		/// <param name="ciudad_idNull">true if the method ignores the ciudad_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_DEPART_ID</c> foreign key.
		/// </summary>
		/// <param name="departamento_id">The <c>DEPARTAMENTO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_DEPART_ID</c> foreign key.
		/// </summary>
		/// <param name="departamento_id">The <c>DEPARTAMENTO_ID</c> column value.</param>
		/// <param name="departamento_idNull">true if the method ignores the departamento_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_PRESEN_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_PRESEN_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <param name="presentacion_idNull">true if the method ignores the presentacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_PROD_BAL_ID</c> foreign key.
		/// </summary>
		/// <param name="prod_balan_id">The <c>PROD_BALAN_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_PROD_BAL_ID</c> foreign key.
		/// </summary>
		/// <param name="prod_balan_id">The <c>PROD_BALAN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_PROVEE_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_PROVEE_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_UNIDAD_BAS</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_bascula">The <c>UNIDAD_MEDIDA_BASCULA</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_UNIDAD_BAS</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_bascula">The <c>UNIDAD_MEDIDA_BASCULA</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>PROD_BALAN_DETALLES</c> table using the 
		/// <c>FK_PROD_BALAN_DET_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_PROD_BALAN_DET_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>PROD_BALAN_DETALLES</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>PROD_BALAN_DETALLES</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.PROD_BALAN_DETALLES";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		protected PROD_BALAN_DETALLESRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		protected PROD_BALAN_DETALLESRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="PROD_BALAN_DETALLESRow"/> objects.</returns>
		protected virtual PROD_BALAN_DETALLESRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					PROD_BALAN_DETALLESRow record = new PROD_BALAN_DETALLESRow();
			...
			return (PROD_BALAN_DETALLESRow[])(recordList.ToArray(typeof(PROD_BALAN_DETALLESRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="PROD_BALAN_DETALLESRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="PROD_BALAN_DETALLESRow"/> object.</returns>
		protected virtual PROD_BALAN_DETALLESRow MapRow(DataRow row)
		{
			PROD_BALAN_DETALLESRow mappedObject = new PROD_BALAN_DETALLESRow();
		...
		/// the <c>PROD_BALAN_DETALLES</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "PROD_BALAN_DETALLES";
			DataColumn dataColumn;
	...
	} // End of PROD_BALAN_DETALLESCollection_Base class
}  // End of namespace
