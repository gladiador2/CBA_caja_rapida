// <fileinfo name="FACTURAS_PROV_DET_CC_INFO_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FACTURAS_PROV_DET_CC_INFO_CRow"/> that 
	/// represents a record in the <c>FACTURAS_PROV_DET_CC_INFO_C</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FACTURAS_PROV_DET_CC_INFO_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FACTURAS_PROV_DET_CC_INFO_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FACTURAS_PROV_DET_CC_INFO_CRow_Base"/> class.
		/// </summary>
		public FACTURAS_PROV_DET_CC_INFO_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(FACTURAS_PROV_DET_CC_INFO_CRow_Base original)
		{
	...
	} // End of FACTURAS_PROV_DET_CC_INFO_CRow_Base class
} // End of namespace
