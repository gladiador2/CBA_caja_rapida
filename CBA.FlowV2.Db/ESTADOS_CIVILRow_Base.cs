// <fileinfo name="ESTADOS_CIVILRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ESTADOS_CIVILRow"/> that 
	/// represents a record in the <c>ESTADOS_CIVIL</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ESTADOS_CIVILRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ESTADOS_CIVILRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ESTADOS_CIVILRow_Base"/> class.
		/// </summary>
		public ESTADOS_CIVILRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ESTADOS_CIVILRow_Base original)
		{
	...
	} // End of ESTADOS_CIVILRow_Base class
} // End of namespace
