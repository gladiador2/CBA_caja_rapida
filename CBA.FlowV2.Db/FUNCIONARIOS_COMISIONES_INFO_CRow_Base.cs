// <fileinfo name="FUNCIONARIOS_COMISIONES_INFO_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FUNCIONARIOS_COMISIONES_INFO_CRow"/> that 
	/// represents a record in the <c>FUNCIONARIOS_COMISIONES_INFO_C</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="FUNCIONARIOS_COMISIONES_INFO_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FUNCIONARIOS_COMISIONES_INFO_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FUNCIONARIOS_COMISIONES_INFO_CRow_Base"/> class.
		/// </summary>
		public FUNCIONARIOS_COMISIONES_INFO_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(FUNCIONARIOS_COMISIONES_INFO_CRow_Base original)
		{
	...
	} // End of FUNCIONARIOS_COMISIONES_INFO_CRow_Base class
} // End of namespace
