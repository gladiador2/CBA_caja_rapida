// <fileinfo name="REMISIONES_FC_RELACIONRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="REMISIONES_FC_RELACIONRow"/> that 
	/// represents a record in the <c>REMISIONES_FC_RELACION</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="REMISIONES_FC_RELACIONRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class REMISIONES_FC_RELACIONRow_Base
	{
		private decimal _id;
		private decimal _remision_detalle_id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="REMISIONES_FC_RELACIONRow_Base"/> class.
		/// </summary>
		public REMISIONES_FC_RELACIONRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(REMISIONES_FC_RELACIONRow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.REMISION_DETALLE_ID != original.REMISION_DETALLE_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>REMISION_DETALLE_ID</c> column value.
		/// </summary>
		/// <value>The <c>REMISION_DETALLE_ID</c> column value.</value>
		public decimal REMISION_DETALLE_ID
		{
			get { return _remision_detalle_id; }
			set { _remision_detalle_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(ID);
			dynStr.Append("@CBA@REMISION_DETALLE_ID=");
			dynStr.Append(REMISION_DETALLE_ID);
	...
	} // End of REMISIONES_FC_RELACIONRow_Base class
} // End of namespace
