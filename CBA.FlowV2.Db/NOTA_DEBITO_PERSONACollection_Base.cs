// <fileinfo name="NOTA_DEBITO_PERSONACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="NOTA_DEBITO_PERSONACollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="NOTA_DEBITO_PERSONACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class NOTA_DEBITO_PERSONACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NOTA_DEBITO_PERSONACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public NOTA_DEBITO_PERSONACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetAll()
		{
		...
		/// includes all records from the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="NOTA_DEBITO_PERSONARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="NOTA_DEBITO_PERSONARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public NOTA_DEBITO_PERSONARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			NOTA_DEBITO_PERSONARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects that 
		...
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public NOTA_DEBITO_PERSONARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.NOTA_DEBITO_PERSONA";
		...
		/// <summary>
		/// Gets <see cref="NOTA_DEBITO_PERSONARow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="NOTA_DEBITO_PERSONARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual NOTA_DEBITO_PERSONARow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			NOTA_DEBITO_PERSONARow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_AUTONUMERACION</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// return records by the <c>FK_ND_CLIENTE_AUTONUMERACION</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public NOTA_DEBITO_PERSONARow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id)
		{
		...
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetByCTACTE_CAJA_SUCURSAL_ID(decimal ctacte_caja_sucursal_id, bool ctacte_caja_sucursal_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_ND_CLIENTE_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_ND_CLIENTE_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_ND_CLIENTE_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_PERSONA</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_ND_CLIENTE_PERSONA</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTA_DEBITO_PERSONARow"/> objects 
		/// by the <c>FK_ND_CLIENTE_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		public virtual NOTA_DEBITO_PERSONARow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_ND_CLIENTE_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTA_DEBITO_PERSONARow"/> object to be inserted.</param>
		public virtual void Insert(NOTA_DEBITO_PERSONARow value)
		{
						
			string sqlStr = "INSERT INTO TRC.NOTA_DEBITO_PERSONA (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
				"PERSONA_ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTA_DEBITO_PERSONARow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(NOTA_DEBITO_PERSONARow value)
		{
			
			string sqlStr = "UPDATE TRC.NOTA_DEBITO_PERSONA SET " +
		...
		/// <summary>
		/// Updates the <c>NOTA_DEBITO_PERSONA</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>NOTA_DEBITO_PERSONA</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTA_DEBITO_PERSONARow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(NOTA_DEBITO_PERSONARow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>NOTA_DEBITO_PERSONA</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_AUTONUMERACION</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_AUTONUMERACION</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_CAJA_SUC</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_sucursal_id">The <c>CTACTE_CAJA_SUCURSAL_ID</c> column value.</param>
		/// <param name="ctacte_caja_sucursal_idNull">true if the method ignores the ctacte_caja_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_CASO</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_PERSONA</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_PERSONA</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTA_DEBITO_PERSONA</c> table using the 
		/// <c>FK_ND_CLIENTE_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_ND_CLIENTE_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>NOTA_DEBITO_PERSONA</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>NOTA_DEBITO_PERSONA</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.NOTA_DEBITO_PERSONA";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		protected NOTA_DEBITO_PERSONARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		protected NOTA_DEBITO_PERSONARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="NOTA_DEBITO_PERSONARow"/> objects.</returns>
		protected virtual NOTA_DEBITO_PERSONARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					NOTA_DEBITO_PERSONARow record = new NOTA_DEBITO_PERSONARow();
			...
			return (NOTA_DEBITO_PERSONARow[])(recordList.ToArray(typeof(NOTA_DEBITO_PERSONARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="NOTA_DEBITO_PERSONARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="NOTA_DEBITO_PERSONARow"/> object.</returns>
		protected virtual NOTA_DEBITO_PERSONARow MapRow(DataRow row)
		{
			NOTA_DEBITO_PERSONARow mappedObject = new NOTA_DEBITO_PERSONARow();
		...
		/// the <c>NOTA_DEBITO_PERSONA</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "NOTA_DEBITO_PERSONA";
			DataColumn dataColumn;
	...
	} // End of NOTA_DEBITO_PERSONACollection_Base class
}  // End of namespace
