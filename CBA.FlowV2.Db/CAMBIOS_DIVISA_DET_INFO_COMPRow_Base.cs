// <fileinfo name="CAMBIOS_DIVISA_DET_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CAMBIOS_DIVISA_DET_INFO_COMPRow"/> that 
	/// represents a record in the <c>CAMBIOS_DIVISA_DET_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CAMBIOS_DIVISA_DET_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CAMBIOS_DIVISA_DET_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CAMBIOS_DIVISA_DET_INFO_COMPRow_Base"/> class.
		/// </summary>
		public CAMBIOS_DIVISA_DET_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CAMBIOS_DIVISA_DET_INFO_COMPRow_Base original)
		{
	...
	} // End of CAMBIOS_DIVISA_DET_INFO_COMPRow_Base class
} // End of namespace
