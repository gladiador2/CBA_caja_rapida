// <fileinfo name="DEPOSITO_PREPARACION_ESTADORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DEPOSITO_PREPARACION_ESTADORow"/> that 
	/// represents a record in the <c>DEPOSITO_PREPARACION_ESTADO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="DEPOSITO_PREPARACION_ESTADORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DEPOSITO_PREPARACION_ESTADORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DEPOSITO_PREPARACION_ESTADORow_Base"/> class.
		/// </summary>
		public DEPOSITO_PREPARACION_ESTADORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(DEPOSITO_PREPARACION_ESTADORow_Base original)
		{
	...
	} // End of DEPOSITO_PREPARACION_ESTADORow_Base class
} // End of namespace
