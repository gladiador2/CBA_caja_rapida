// <fileinfo name="IMPORTACIONESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="IMPORTACIONESRow"/> that 
	/// represents a record in the <c>IMPORTACIONES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="IMPORTACIONESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class IMPORTACIONESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="IMPORTACIONESRow_Base"/> class.
		/// </summary>
		public IMPORTACIONESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(IMPORTACIONESRow_Base original)
		{
	...
	} // End of IMPORTACIONESRow_Base class
} // End of namespace
