// <fileinfo name="PROVEEDORES_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PROVEEDORES_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>PROVEEDORES_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PROVEEDORES_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PROVEEDORES_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PROVEEDORES_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public PROVEEDORES_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PROVEEDORES_INFO_COMPLETARow_Base original)
		{
			...
			if (this.CONDICION_HABITUAL_PAGO_NOMBRE != original.CONDICION_HABITUAL_PAGO_NOMBRE) return true;
			if (this.PAIS_ID != original.PAIS_ID) return true;
			if (this.PAIS_NOMBRE != original.PAIS_NOMBRE) return true;
			if (this.PAIS_ABREVIATURA != original.PAIS_ABREVIATURA) return true;
			...
			if (this.DEPARTAMENTO1_NOMBRE != original.DEPARTAMENTO1_NOMBRE) return true;
			if (this.DEPARTAMENTO1_ABREVIATURA != original.DEPARTAMENTO1_ABREVIATURA) return true;
			...
			if (this.CIUDAD1_ABREVIATURA != original.CIUDAD1_ABREVIATURA) return true;
			...
			if (this.BARRIO1_ABREVIATURA != original.BARRIO1_ABREVIATURA) return true;
			...
			if (this.DEPARTAMENTO2_ABREVIATURA != original.DEPARTAMENTO2_ABREVIATURA) return true;
			...
			if (this.CIUDAD2_ABREVIATURA != original.CIUDAD2_ABREVIATURA) return true;
			...
			if (this.BARRIO2_ABREVIATURA != original.BARRIO2_ABREVIATURA) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CONDICION_HABITUAL_PAGO_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CONDICION_HABITUAL_PAGO_NOMBRE</c> column value.</value>
		public string CONDICION_HABITUAL_PAGO_NOMBRE
		{
			get { return _condicion_habitual_pago_nombre; }
			set { _condicion_habitual_pago_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>PAIS_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PAIS_ABREVIATURA</c> column value.</value>
		public string PAIS_ABREVIATURA
		{
			get { return _pais_abreviatura; }
			set { _pais_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENTO1_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENTO1_NOMBRE</c> column value.</value>
		public string DEPARTAMENTO1_NOMBRE
		{
			get { return _departamento1_nombre; }
			set { _departamento1_nombre = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENTO1_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENTO1_ABREVIATURA</c> column value.</value>
		public string DEPARTAMENTO1_ABREVIATURA
		{
			get { return _departamento1_abreviatura; }
			set { _departamento1_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CIUDAD1_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CIUDAD1_ABREVIATURA</c> column value.</value>
		public string CIUDAD1_ABREVIATURA
		{
			get { return _ciudad1_abreviatura; }
			set { _ciudad1_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>BARRIO1_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BARRIO1_ABREVIATURA</c> column value.</value>
		public string BARRIO1_ABREVIATURA
		{
			get { return _barrio1_abreviatura; }
			set { _barrio1_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENTO2_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENTO2_ABREVIATURA</c> column value.</value>
		public string DEPARTAMENTO2_ABREVIATURA
		{
			get { return _departamento2_abreviatura; }
			set { _departamento2_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CIUDAD2_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CIUDAD2_ABREVIATURA</c> column value.</value>
		public string CIUDAD2_ABREVIATURA
		{
			get { return _ciudad2_abreviatura; }
			set { _ciudad2_abreviatura = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>BARRIO2_ABREVIATURA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BARRIO2_ABREVIATURA</c> column value.</value>
		public string BARRIO2_ABREVIATURA
		{
			get { return _barrio2_abreviatura; }
			set { _barrio2_abreviatura = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CONDICION_HABITUAL_PAGO_NOMBRE=");
			dynStr.Append(CONDICION_HABITUAL_PAGO_NOMBRE);
			dynStr.Append("@CBA@PAIS_ID=");
			dynStr.Append(PAIS_ID);
			dynStr.Append("@CBA@PAIS_NOMBRE=");
			dynStr.Append(PAIS_NOMBRE);
			dynStr.Append("@CBA@PAIS_ABREVIATURA=");
			dynStr.Append(PAIS_ABREVIATURA);
			dynStr.Append("@CBA@DEPARTAMENTO1_ID=");
			dynStr.Append(IsDEPARTAMENTO1_IDNull ? (object)"<NULL>" : DEPARTAMENTO1_ID);
			dynStr.Append("@CBA@DEPARTAMENTO1_NOMBRE=");
			dynStr.Append(DEPARTAMENTO1_NOMBRE);
			dynStr.Append("@CBA@DEPARTAMENTO1_ABREVIATURA=");
			dynStr.Append(DEPARTAMENTO1_ABREVIATURA);
			...
			dynStr.Append("@CBA@CIUDAD1_ABREVIATURA=");
			dynStr.Append(CIUDAD1_ABREVIATURA);
			...
			dynStr.Append("@CBA@BARRIO1_ABREVIATURA=");
			dynStr.Append(BARRIO1_ABREVIATURA);
			...
			dynStr.Append("@CBA@DEPARTAMENTO2_ABREVIATURA=");
			dynStr.Append(DEPARTAMENTO2_ABREVIATURA);
			...
			dynStr.Append("@CBA@CIUDAD2_ABREVIATURA=");
			dynStr.Append(CIUDAD2_ABREVIATURA);
			...
			dynStr.Append("@CBA@BARRIO2_ABREVIATURA=");
			dynStr.Append(BARRIO2_ABREVIATURA);
	...
	} // End of PROVEEDORES_INFO_COMPLETARow_Base class
} // End of namespace
