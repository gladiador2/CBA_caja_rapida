// <fileinfo name="DESCUENTO_DOCUMENTOS_PAGOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> that 
	/// represents a record in the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DESCUENTO_DOCUMENTOS_PAGOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow_Base"/> class.
		/// </summary>
		public DESCUENTO_DOCUMENTOS_PAGOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(DESCUENTO_DOCUMENTOS_PAGOSRow_Base original)
		{
	...
	} // End of DESCUENTO_DOCUMENTOS_PAGOSRow_Base class
} // End of namespace
