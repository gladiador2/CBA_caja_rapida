// <fileinfo name="IMPORTACIONES_GASTOS_INFO_COMRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="IMPORTACIONES_GASTOS_INFO_COMRow"/> that 
	/// represents a record in the <c>IMPORTACIONES_GASTOS_INFO_COM</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="IMPORTACIONES_GASTOS_INFO_COMRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class IMPORTACIONES_GASTOS_INFO_COMRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="IMPORTACIONES_GASTOS_INFO_COMRow_Base"/> class.
		/// </summary>
		public IMPORTACIONES_GASTOS_INFO_COMRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(IMPORTACIONES_GASTOS_INFO_COMRow_Base original)
		{
	...
	} // End of IMPORTACIONES_GASTOS_INFO_COMRow_Base class
} // End of namespace
