// <fileinfo name="NOTAS_CREDITO_PERSONAS_DETCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="NOTAS_CREDITO_PERSONAS_DETCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="NOTAS_CREDITO_PERSONAS_DETCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class NOTAS_CREDITO_PERSONAS_DETCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="NOTAS_CREDITO_PERSONAS_DETCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public NOTAS_CREDITO_PERSONAS_DETCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetAll()
		{
		...
		/// includes all records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			NOTAS_CREDITO_PERSONAS_DETRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects that 
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.NOTAS_CREDITO_PERSONAS_DET";
		...
		/// <summary>
		/// Gets <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			NOTAS_CREDITO_PERSONAS_DETRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CR_DET_FACT_CL_DET_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_detalle_id">The <c>FACTURA_CLIENTE_DETALLE_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_CLIENTE_DETALLE_ID(decimal factura_cliente_detalle_id)
		{
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_CLIENTE_DETALLE_ID(decimal factura_cliente_detalle_id, bool factura_cliente_detalle_idNull)
		{
		...
		/// return records by the <c>FK_NOTA_CR_DET_FACT_CL_DET_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_detalle_id">The <c>FACTURA_CLIENTE_DETALLE_ID</c> column value.</param>
		/// <param name="factura_cliente_detalle_idNull">true if the method ignores the factura_cliente_detalle_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByACTIVO_ID(decimal activo_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByACTIVO_ID(decimal activo_id, bool activo_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <param name="activo_idNull">true if the method ignores the activo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_ARTIC_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByARTICULO_ID(decimal articulo_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByARTICULO_ID(decimal articulo_id, bool articulo_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_ARTIC_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_DEP_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_DEPOSITO_ID(decimal factura_deposito_id)
		{
			return GetByFACTURA_DEPOSITO_ID(factura_deposito_id, false);
		}
		...
		/// </summary>
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <param name="factura_deposito_idNull">true if the method ignores the factura_deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_DEPOSITO_ID(decimal factura_deposito_id, bool factura_deposito_idNull)
		{
			return MapRecords(CreateGetByFACTURA_DEPOSITO_IDCommand(factura_deposito_id, factura_deposito_idNull));
		}
		...
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByFACTURA_DEPOSITO_IDAsDataTable(decimal factura_deposito_id)
		{
			return GetByFACTURA_DEPOSITO_IDAsDataTable(factura_deposito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByFACTURA_DEPOSITO_IDAsDataTable(decimal factura_deposito_id, bool factura_deposito_idNull)
		{
			return MapRecordsToDataTable(CreateGetByFACTURA_DEPOSITO_IDCommand(factura_deposito_id, factura_deposito_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_DEP_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <param name="factura_deposito_idNull">true if the method ignores the factura_deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByFACTURA_DEPOSITO_IDCommand(decimal factura_deposito_id, bool factura_deposito_idNull)
		{
			string whereSql = "";
			if(factura_deposito_idNull)
				whereSql += "FACTURA_DEPOSITO_ID IS NULL";
			else
				whereSql += "FACTURA_DEPOSITO_ID=" + _db.CreateSqlParameterName("FACTURA_DEPOSITO_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!factura_deposito_idNull)
				AddParameter(cmd, "FACTURA_DEPOSITO_ID", factura_deposito_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_FC_CL_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_id">The <c>FACTURA_CLIENTE_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_CLIENTE_ID(decimal factura_cliente_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_CLIENTE_ID(decimal factura_cliente_id, bool factura_cliente_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_FC_CL_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_id">The <c>FACTURA_CLIENTE_ID</c> column value.</param>
		/// <param name="factura_cliente_idNull">true if the method ignores the factura_cliente_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByLOTE_ID(decimal lote_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByLOTE_ID(decimal lote_id, bool lote_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_NOTA_ID</c> foreign key.
		/// </summary>
		/// <param name="nota_credito_persona_id">The <c>NOTA_CREDITO_PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByNOTA_CREDITO_PERSONA_ID(decimal nota_credito_persona_id)
		{
			return MapRecords(CreateGetByNOTA_CREDITO_PERSONA_IDCommand(nota_credito_persona_id));
		}
		...
		/// <param name="nota_credito_persona_id">The <c>NOTA_CREDITO_PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByNOTA_CREDITO_PERSONA_IDAsDataTable(decimal nota_credito_persona_id)
		{
			return MapRecordsToDataTable(CreateGetByNOTA_CREDITO_PERSONA_IDCommand(nota_credito_persona_id));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_NOTA_ID</c> foreign key.
		/// </summary>
		/// <param name="nota_credito_persona_id">The <c>NOTA_CREDITO_PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByNOTA_CREDITO_PERSONA_IDCommand(decimal nota_credito_persona_id)
		{
			string whereSql = "";
			whereSql += "NOTA_CREDITO_PERSONA_ID=" + _db.CreateSqlParameterName("NOTA_CREDITO_PERSONA_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "NOTA_CREDITO_PERSONA_ID", nota_credito_persona_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_PER_IMP_ID</c> foreign key.
		/// </summary>
		/// <param name="impuesto_id">The <c>IMPUESTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByIMPUESTO_ID(decimal impuesto_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_PER_IMP_ID</c> foreign key.
		/// </summary>
		/// <param name="impuesto_id">The <c>IMPUESTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_PERS_SU_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_SUCURSAL_ID(decimal factura_sucursal_id)
		{
			return GetByFACTURA_SUCURSAL_ID(factura_sucursal_id, false);
		}
		...
		/// </summary>
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <param name="factura_sucursal_idNull">true if the method ignores the factura_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByFACTURA_SUCURSAL_ID(decimal factura_sucursal_id, bool factura_sucursal_idNull)
		{
			return MapRecords(CreateGetByFACTURA_SUCURSAL_IDCommand(factura_sucursal_id, factura_sucursal_idNull));
		}
		...
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByFACTURA_SUCURSAL_IDAsDataTable(decimal factura_sucursal_id)
		{
			return GetByFACTURA_SUCURSAL_IDAsDataTable(factura_sucursal_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByFACTURA_SUCURSAL_IDAsDataTable(decimal factura_sucursal_id, bool factura_sucursal_idNull)
		{
			return MapRecordsToDataTable(CreateGetByFACTURA_SUCURSAL_IDCommand(factura_sucursal_id, factura_sucursal_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_PERS_SU_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <param name="factura_sucursal_idNull">true if the method ignores the factura_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByFACTURA_SUCURSAL_IDCommand(decimal factura_sucursal_id, bool factura_sucursal_idNull)
		{
			string whereSql = "";
			if(factura_sucursal_idNull)
				whereSql += "FACTURA_SUCURSAL_ID IS NULL";
			else
				whereSql += "FACTURA_SUCURSAL_ID=" + _db.CreateSqlParameterName("FACTURA_SUCURSAL_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!factura_sucursal_idNull)
				AddParameter(cmd, "FACTURA_SUCURSAL_ID", factura_sucursal_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects 
		/// by the <c>FK_NOTA_CREDITO_DET_TEXT_PR_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public NOTAS_CREDITO_PERSONAS_DETRow[] GetByTEXTO_PREDEFINIDO_ID(decimal texto_predefinido_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		public virtual NOTAS_CREDITO_PERSONAS_DETRow[] GetByTEXTO_PREDEFINIDO_ID(decimal texto_predefinido_id, bool texto_predefinido_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_NOTA_CREDITO_DET_TEXT_PR_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <param name="texto_predefinido_idNull">true if the method ignores the texto_predefinido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> object to be inserted.</param>
		public virtual void Insert(NOTAS_CREDITO_PERSONAS_DETRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.NOTAS_CREDITO_PERSONAS_DET (" +
				"ID, " +
				"NOTA_CREDITO_PERSONA_ID, " +
				"FACTURA_CLIENTE_ID, " +
				...
				_db.CreateSqlParameterName("NOTA_CREDITO_PERSONA_ID") + ", " +
				_db.CreateSqlParameterName("FACTURA_CLIENTE_ID") + ", " +
				_db.CreateSqlParameterName("FACTURA_CLIENTE_DETALLE_ID") + ", " +
				_db.CreateSqlParameterName("FACTURA_SUCURSAL_ID") + ", " +
				_db.CreateSqlParameterName("FACTURA_DEPOSITO_ID") + ", " +
			...
			AddParameter(cmd, "NOTA_CREDITO_PERSONA_ID", value.NOTA_CREDITO_PERSONA_ID);
			...
			AddParameter(cmd, "FACTURA_SUCURSAL_ID",
				value.IsFACTURA_SUCURSAL_IDNull ? DBNull.Value : (object)value.FACTURA_SUCURSAL_ID);
			AddParameter(cmd, "FACTURA_DEPOSITO_ID",
				value.IsFACTURA_DEPOSITO_IDNull ? DBNull.Value : (object)value.FACTURA_DEPOSITO_ID);
			...
			AddParameter(cmd, "IMPUESTO_MONTO", value.IMPUESTO_MONTO);
		...
		/// <summary>
		/// Updates a record in the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(NOTAS_CREDITO_PERSONAS_DETRow value)
		{
			
			string sqlStr = "UPDATE TRC.NOTAS_CREDITO_PERSONAS_DET SET " +
				"NOTA_CREDITO_PERSONA_ID=" + _db.CreateSqlParameterName("NOTA_CREDITO_PERSONA_ID") + ", " +
				...
				"FACTURA_SUCURSAL_ID=" + _db.CreateSqlParameterName("FACTURA_SUCURSAL_ID") + ", " +
				"FACTURA_DEPOSITO_ID=" + _db.CreateSqlParameterName("FACTURA_DEPOSITO_ID") + ", " +
		...
		/// <summary>
		/// Updates the <c>NOTAS_CREDITO_PERSONAS_DET</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>NOTAS_CREDITO_PERSONAS_DET</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(NOTAS_CREDITO_PERSONAS_DETRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CR_DET_FACT_CL_DET_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_detalle_id">The <c>FACTURA_CLIENTE_DETALLE_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CR_DET_FACT_CL_DET_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_detalle_id">The <c>FACTURA_CLIENTE_DETALLE_ID</c> column value.</param>
		/// <param name="factura_cliente_detalle_idNull">true if the method ignores the factura_cliente_detalle_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <param name="activo_idNull">true if the method ignores the activo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_ARTIC_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_ARTIC_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_DEP_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByFACTURA_DEPOSITO_ID(decimal factura_deposito_id)
		{
			return DeleteByFACTURA_DEPOSITO_ID(factura_deposito_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByFACTURA_DEPOSITO_ID(decimal factura_deposito_id, bool factura_deposito_idNull)
		{
			return CreateDeleteByFACTURA_DEPOSITO_IDCommand(factura_deposito_id, factura_deposito_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_DEP_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_deposito_id">The <c>FACTURA_DEPOSITO_ID</c> column value.</param>
		/// <param name="factura_deposito_idNull">true if the method ignores the factura_deposito_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByFACTURA_DEPOSITO_IDCommand(decimal factura_deposito_id, bool factura_deposito_idNull)
		{
			string whereSql = "";
			if(factura_deposito_idNull)
				whereSql += "FACTURA_DEPOSITO_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_FC_CL_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_id">The <c>FACTURA_CLIENTE_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_FC_CL_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_cliente_id">The <c>FACTURA_CLIENTE_ID</c> column value.</param>
		/// <param name="factura_cliente_idNull">true if the method ignores the factura_cliente_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_NOTA_ID</c> foreign key.
		/// </summary>
		/// <param name="nota_credito_persona_id">The <c>NOTA_CREDITO_PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByNOTA_CREDITO_PERSONA_ID(decimal nota_credito_persona_id)
		{
			return CreateDeleteByNOTA_CREDITO_PERSONA_IDCommand(nota_credito_persona_id).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_NOTA_ID</c> foreign key.
		/// </summary>
		/// <param name="nota_credito_persona_id">The <c>NOTA_CREDITO_PERSONA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByNOTA_CREDITO_PERSONA_IDCommand(decimal nota_credito_persona_id)
		{
			string whereSql = "";
			whereSql += "NOTA_CREDITO_PERSONA_ID=" + _db.CreateSqlParameterName("NOTA_CREDITO_PERSONA_ID");
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_PER_IMP_ID</c> foreign key.
		/// </summary>
		/// <param name="impuesto_id">The <c>IMPUESTO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_PER_IMP_ID</c> foreign key.
		/// </summary>
		/// <param name="impuesto_id">The <c>IMPUESTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_PERS_SU_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByFACTURA_SUCURSAL_ID(decimal factura_sucursal_id)
		{
			return DeleteByFACTURA_SUCURSAL_ID(factura_sucursal_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByFACTURA_SUCURSAL_ID(decimal factura_sucursal_id, bool factura_sucursal_idNull)
		{
			return CreateDeleteByFACTURA_SUCURSAL_IDCommand(factura_sucursal_id, factura_sucursal_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_PERS_SU_ID</c> foreign key.
		/// </summary>
		/// <param name="factura_sucursal_id">The <c>FACTURA_SUCURSAL_ID</c> column value.</param>
		/// <param name="factura_sucursal_idNull">true if the method ignores the factura_sucursal_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByFACTURA_SUCURSAL_IDCommand(decimal factura_sucursal_id, bool factura_sucursal_idNull)
		{
			string whereSql = "";
			if(factura_sucursal_idNull)
				whereSql += "FACTURA_SUCURSAL_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table using the 
		/// <c>FK_NOTA_CREDITO_DET_TEXT_PR_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_NOTA_CREDITO_DET_TEXT_PR_ID</c> foreign key.
		/// </summary>
		/// <param name="texto_predefinido_id">The <c>TEXTO_PREDEFINIDO_ID</c> column value.</param>
		/// <param name="texto_predefinido_idNull">true if the method ignores the texto_predefinido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>NOTAS_CREDITO_PERSONAS_DET</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>NOTAS_CREDITO_PERSONAS_DET</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.NOTAS_CREDITO_PERSONAS_DET";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		protected NOTAS_CREDITO_PERSONAS_DETRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		protected NOTAS_CREDITO_PERSONAS_DETRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> objects.</returns>
		protected virtual NOTAS_CREDITO_PERSONAS_DETRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					NOTAS_CREDITO_PERSONAS_DETRow record = new NOTAS_CREDITO_PERSONAS_DETRow();
			...
			return (NOTAS_CREDITO_PERSONAS_DETRow[])(recordList.ToArray(typeof(NOTAS_CREDITO_PERSONAS_DETRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="NOTAS_CREDITO_PERSONAS_DETRow"/> object.</returns>
		protected virtual NOTAS_CREDITO_PERSONAS_DETRow MapRow(DataRow row)
		{
			NOTAS_CREDITO_PERSONAS_DETRow mappedObject = new NOTAS_CREDITO_PERSONAS_DETRow();
		...
		/// the <c>NOTAS_CREDITO_PERSONAS_DET</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "NOTAS_CREDITO_PERSONAS_DET";
			DataColumn dataColumn;
	...
	} // End of NOTAS_CREDITO_PERSONAS_DETCollection_Base class
}  // End of namespace
