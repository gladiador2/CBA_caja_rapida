// <fileinfo name="DESCUENTO_DOCUMENTOS_PAGOSCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DESCUENTO_DOCUMENTOS_PAGOSCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="DESCUENTO_DOCUMENTOS_PAGOSCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DESCUENTO_DOCUMENTOS_PAGOSCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DESCUENTO_DOCUMENTOS_PAGOSCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public DESCUENTO_DOCUMENTOS_PAGOSCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetAll()
		{
		...
		/// includes all records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			DESCUENTO_DOCUMENTOS_PAGOSRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects that 
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.DESCUENTO_DOCUMENTOS_PAGOS";
		...
		/// <summary>
		/// Gets <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			DESCUENTO_DOCUMENTOS_PAGOSRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAG_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByCTACTE_VALOR_ID(decimal ctacte_valor_id)
		{
		...
		/// return records by the <c>FK_DESC_DOCS_PAG_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_BANCARIA</c> foreign key.
		/// </summary>
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByDEPOSITO_CTACTE_BANCARIA_ID(decimal deposito_ctacte_bancaria_id)
		{
			return GetByDEPOSITO_CTACTE_BANCARIA_ID(deposito_ctacte_bancaria_id, false);
		}
		...
		/// </summary>
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <param name="deposito_ctacte_bancaria_idNull">true if the method ignores the deposito_ctacte_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByDEPOSITO_CTACTE_BANCARIA_ID(decimal deposito_ctacte_bancaria_id, bool deposito_ctacte_bancaria_idNull)
		{
			return MapRecords(CreateGetByDEPOSITO_CTACTE_BANCARIA_IDCommand(deposito_ctacte_bancaria_id, deposito_ctacte_bancaria_idNull));
		}
		...
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByDEPOSITO_CTACTE_BANCARIA_IDAsDataTable(decimal deposito_ctacte_bancaria_id)
		{
			return GetByDEPOSITO_CTACTE_BANCARIA_IDAsDataTable(deposito_ctacte_bancaria_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByDEPOSITO_CTACTE_BANCARIA_IDAsDataTable(decimal deposito_ctacte_bancaria_id, bool deposito_ctacte_bancaria_idNull)
		{
			return MapRecordsToDataTable(CreateGetByDEPOSITO_CTACTE_BANCARIA_IDCommand(deposito_ctacte_bancaria_id, deposito_ctacte_bancaria_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_BANCARIA</c> foreign key.
		/// </summary>
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <param name="deposito_ctacte_bancaria_idNull">true if the method ignores the deposito_ctacte_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByDEPOSITO_CTACTE_BANCARIA_IDCommand(decimal deposito_ctacte_bancaria_id, bool deposito_ctacte_bancaria_idNull)
		{
			string whereSql = "";
			if(deposito_ctacte_bancaria_idNull)
				whereSql += "DEPOSITO_CTACTE_BANCARIA_ID IS NULL";
			else
				whereSql += "DEPOSITO_CTACTE_BANCARIA_ID=" + _db.CreateSqlParameterName("DEPOSITO_CTACTE_BANCARIA_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!deposito_ctacte_bancaria_idNull)
				AddParameter(cmd, "DEPOSITO_CTACTE_BANCARIA_ID", deposito_ctacte_bancaria_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_CHQ_BANC_ID</c> foreign key.
		/// </summary>
		/// <param name="cheque_ctacte_banco_id">The <c>CHEQUE_CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByCHEQUE_CTACTE_BANCO_ID(decimal cheque_ctacte_banco_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByCHEQUE_CTACTE_BANCO_ID(decimal cheque_ctacte_banco_id, bool cheque_ctacte_banco_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_CHQ_BANC_ID</c> foreign key.
		/// </summary>
		/// <param name="cheque_ctacte_banco_id">The <c>CHEQUE_CTACTE_BANCO_ID</c> column value.</param>
		/// <param name="cheque_ctacte_banco_idNull">true if the method ignores the cheque_ctacte_banco_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_CHQ_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id, bool ctacte_cheque_recibido_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_CHQ_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_DEPOS</c> foreign key.
		/// </summary>
		/// <param name="deposito_bancario_id">The <c>DEPOSITO_BANCARIO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByDEPOSITO_BANCARIO_ID(decimal deposito_bancario_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByDEPOSITO_BANCARIO_ID(decimal deposito_bancario_id, bool deposito_bancario_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_DEPOS</c> foreign key.
		/// </summary>
		/// <param name="deposito_bancario_id">The <c>DEPOSITO_BANCARIO_ID</c> column value.</param>
		/// <param name="deposito_bancario_idNull">true if the method ignores the deposito_bancario_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByDESCUENTO_DOCUMENTO_ID(decimal descuento_documento_id)
		{
			return MapRecords(CreateGetByDESCUENTO_DOCUMENTO_IDCommand(descuento_documento_id));
		}
		...
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByDESCUENTO_DOCUMENTO_IDAsDataTable(decimal descuento_documento_id)
		{
			return MapRecordsToDataTable(CreateGetByDESCUENTO_DOCUMENTO_IDCommand(descuento_documento_id));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByDESCUENTO_DOCUMENTO_IDCommand(decimal descuento_documento_id)
		{
			string whereSql = "";
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects 
		/// by the <c>FK_DESC_DOCS_PAGOS_TRANSF_ID</c> foreign key.
		/// </summary>
		/// <param name="transferencia_bancaria_id">The <c>TRANSFERENCIA_BANCARIA_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByTRANSFERENCIA_BANCARIA_ID(decimal transferencia_bancaria_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] GetByTRANSFERENCIA_BANCARIA_ID(decimal transferencia_bancaria_id, bool transferencia_bancaria_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_PAGOS_TRANSF_ID</c> foreign key.
		/// </summary>
		/// <param name="transferencia_bancaria_id">The <c>TRANSFERENCIA_BANCARIA_ID</c> column value.</param>
		/// <param name="transferencia_bancaria_idNull">true if the method ignores the transferencia_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> object to be inserted.</param>
		public virtual void Insert(DESCUENTO_DOCUMENTOS_PAGOSRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.DESCUENTO_DOCUMENTOS_PAGOS (" +
				"ID, " +
				"CTACTE_VALOR_ID, " +
				"CHEQUE_CTACTE_BANCO_ID, " +
				"CHEQUE_FECHA_POSTDATADO, " +
				...
				_db.CreateSqlParameterName("CHEQUE_FECHA_POSTDATADO") + ", " +
				...
				_db.CreateSqlParameterName("DEPOSITO_CTACTE_BANCARIA_ID") + ", " +
			...
			AddParameter(cmd, "CHEQUE_FECHA_POSTDATADO",
				value.IsCHEQUE_FECHA_POSTDATADONull ? DBNull.Value : (object)value.CHEQUE_FECHA_POSTDATADO);
			...
			AddParameter(cmd, "DESCUENTO_DOCUMENTO_ID", value.DESCUENTO_DOCUMENTO_ID);
			...
			AddParameter(cmd, "DEPOSITO_CTACTE_BANCARIA_ID",
				value.IsDEPOSITO_CTACTE_BANCARIA_IDNull ? DBNull.Value : (object)value.DEPOSITO_CTACTE_BANCARIA_ID);
		...
		/// <summary>
		/// Updates a record in the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(DESCUENTO_DOCUMENTOS_PAGOSRow value)
		{
			
			string sqlStr = "UPDATE TRC.DESCUENTO_DOCUMENTOS_PAGOS SET " +
				...
				"CHEQUE_FECHA_POSTDATADO=" + _db.CreateSqlParameterName("CHEQUE_FECHA_POSTDATADO") + ", " +
				...
				"DEPOSITO_CTACTE_BANCARIA_ID=" + _db.CreateSqlParameterName("DEPOSITO_CTACTE_BANCARIA_ID") + ", " +
		...
		/// <summary>
		/// Updates the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(DESCUENTO_DOCUMENTOS_PAGOSRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAG_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAG_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_BANCARIA</c> foreign key.
		/// </summary>
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByDEPOSITO_CTACTE_BANCARIA_ID(decimal deposito_ctacte_bancaria_id)
		{
			return DeleteByDEPOSITO_CTACTE_BANCARIA_ID(deposito_ctacte_bancaria_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByDEPOSITO_CTACTE_BANCARIA_ID(decimal deposito_ctacte_bancaria_id, bool deposito_ctacte_bancaria_idNull)
		{
			return CreateDeleteByDEPOSITO_CTACTE_BANCARIA_IDCommand(deposito_ctacte_bancaria_id, deposito_ctacte_bancaria_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_BANCARIA</c> foreign key.
		/// </summary>
		/// <param name="deposito_ctacte_bancaria_id">The <c>DEPOSITO_CTACTE_BANCARIA_ID</c> column value.</param>
		/// <param name="deposito_ctacte_bancaria_idNull">true if the method ignores the deposito_ctacte_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByDEPOSITO_CTACTE_BANCARIA_IDCommand(decimal deposito_ctacte_bancaria_id, bool deposito_ctacte_bancaria_idNull)
		{
			string whereSql = "";
			if(deposito_ctacte_bancaria_idNull)
				whereSql += "DEPOSITO_CTACTE_BANCARIA_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_CHQ_BANC_ID</c> foreign key.
		/// </summary>
		/// <param name="cheque_ctacte_banco_id">The <c>CHEQUE_CTACTE_BANCO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_CHQ_BANC_ID</c> foreign key.
		/// </summary>
		/// <param name="cheque_ctacte_banco_id">The <c>CHEQUE_CTACTE_BANCO_ID</c> column value.</param>
		/// <param name="cheque_ctacte_banco_idNull">true if the method ignores the cheque_ctacte_banco_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_CHQ_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_CHQ_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_DEPOS</c> foreign key.
		/// </summary>
		/// <param name="deposito_bancario_id">The <c>DEPOSITO_BANCARIO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_DEPOS</c> foreign key.
		/// </summary>
		/// <param name="deposito_bancario_id">The <c>DEPOSITO_BANCARIO_ID</c> column value.</param>
		/// <param name="deposito_bancario_idNull">true if the method ignores the deposito_bancario_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByDESCUENTO_DOCUMENTO_ID(decimal descuento_documento_id)
		{
			return CreateDeleteByDESCUENTO_DOCUMENTO_IDCommand(descuento_documento_id).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByDESCUENTO_DOCUMENTO_IDCommand(decimal descuento_documento_id)
		{
			string whereSql = "";
			whereSql += "DESCUENTO_DOCUMENTO_ID=" + _db.CreateSqlParameterName("DESCUENTO_DOCUMENTO_ID");
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table using the 
		/// <c>FK_DESC_DOCS_PAGOS_TRANSF_ID</c> foreign key.
		/// </summary>
		/// <param name="transferencia_bancaria_id">The <c>TRANSFERENCIA_BANCARIA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_PAGOS_TRANSF_ID</c> foreign key.
		/// </summary>
		/// <param name="transferencia_bancaria_id">The <c>TRANSFERENCIA_BANCARIA_ID</c> column value.</param>
		/// <param name="transferencia_bancaria_idNull">true if the method ignores the transferencia_bancaria_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>DESCUENTO_DOCUMENTOS_PAGOS</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>DESCUENTO_DOCUMENTOS_PAGOS</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.DESCUENTO_DOCUMENTOS_PAGOS";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		protected DESCUENTO_DOCUMENTOS_PAGOSRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		protected DESCUENTO_DOCUMENTOS_PAGOSRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> objects.</returns>
		protected virtual DESCUENTO_DOCUMENTOS_PAGOSRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					DESCUENTO_DOCUMENTOS_PAGOSRow record = new DESCUENTO_DOCUMENTOS_PAGOSRow();
			...
			return (DESCUENTO_DOCUMENTOS_PAGOSRow[])(recordList.ToArray(typeof(DESCUENTO_DOCUMENTOS_PAGOSRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="DESCUENTO_DOCUMENTOS_PAGOSRow"/> object.</returns>
		protected virtual DESCUENTO_DOCUMENTOS_PAGOSRow MapRow(DataRow row)
		{
			DESCUENTO_DOCUMENTOS_PAGOSRow mappedObject = new DESCUENTO_DOCUMENTOS_PAGOSRow();
		...
		/// the <c>DESCUENTO_DOCUMENTOS_PAGOS</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "DESCUENTO_DOCUMENTOS_PAGOS";
			DataColumn dataColumn;
	...
	} // End of DESCUENTO_DOCUMENTOS_PAGOSCollection_Base class
}  // End of namespace
