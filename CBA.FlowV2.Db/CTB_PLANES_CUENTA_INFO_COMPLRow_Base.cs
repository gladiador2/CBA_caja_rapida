// <fileinfo name="CTB_PLANES_CUENTA_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_PLANES_CUENTA_INFO_COMPLRow"/> that 
	/// represents a record in the <c>CTB_PLANES_CUENTA_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_PLANES_CUENTA_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_PLANES_CUENTA_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		private string _usuario_inactivado_nombre;
		private string _estado;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_PLANES_CUENTA_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public CTB_PLANES_CUENTA_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_PLANES_CUENTA_INFO_COMPLRow_Base original)
		{
			...
			if (this.USUARIO_INACTIVADO_NOMBRE != original.USUARIO_INACTIVADO_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>USUARIO_INACTIVADO_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>USUARIO_INACTIVADO_NOMBRE</c> column value.</value>
		public string USUARIO_INACTIVADO_NOMBRE
		{
			get { return _usuario_inactivado_nombre; }
			set { _usuario_inactivado_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@USUARIO_INACTIVADO_NOMBRE=");
			dynStr.Append(USUARIO_INACTIVADO_NOMBRE);
			dynStr.Append("@CBA@ESTADO=");
			dynStr.Append(ESTADO);
			return dynStr.ToString();
		}
	} // End of CTB_PLANES_CUENTA_INFO_COMPLRow_Base class
} // End of namespace
