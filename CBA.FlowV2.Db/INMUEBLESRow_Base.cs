// <fileinfo name="INMUEBLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="INMUEBLESRow"/> that 
	/// represents a record in the <c>INMUEBLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="INMUEBLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class INMUEBLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="INMUEBLESRow_Base"/> class.
		/// </summary>
		public INMUEBLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(INMUEBLESRow_Base original)
		{
	...
	} // End of INMUEBLESRow_Base class
} // End of namespace
