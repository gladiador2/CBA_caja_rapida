// <fileinfo name="APLICACION_DOCUMENTOS_VALCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="APLICACION_DOCUMENTOS_VALCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="APLICACION_DOCUMENTOS_VALCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class APLICACION_DOCUMENTOS_VALCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="APLICACION_DOCUMENTOS_VALCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public APLICACION_DOCUMENTOS_VALCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetAll()
		{
		...
		/// includes all records from the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="APLICACION_DOCUMENTOS_VALRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public APLICACION_DOCUMENTOS_VALRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			APLICACION_DOCUMENTOS_VALRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects that 
		...
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public APLICACION_DOCUMENTOS_VALRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.APLICACION_DOCUMENTOS_VAL";
		...
		/// <summary>
		/// Gets <see cref="APLICACION_DOCUMENTOS_VALRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="APLICACION_DOCUMENTOS_VALRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			APLICACION_DOCUMENTOS_VALRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects 
		/// by the <c>FK_APLIC_DOCUMEN_VAL_APLIC_DOC</c> foreign key.
		/// </summary>
		/// <param name="aplicacion_documento_id">The <c>APLICACION_DOCUMENTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetByAPLICACION_DOCUMENTO_ID(decimal aplicacion_documento_id)
		{
		...
		/// return records by the <c>FK_APLIC_DOCUMEN_VAL_APLIC_DOC</c> foreign key.
		/// </summary>
		/// <param name="aplicacion_documento_id">The <c>APLICACION_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects 
		/// by the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PE</c> foreign key.
		/// </summary>
		/// <param name="ctacte_persona_id">The <c>CTACTE_PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public APLICACION_DOCUMENTOS_VALRow[] GetByCTACTE_PERSONA_ID(decimal ctacte_persona_id)
		{
		...
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetByCTACTE_PERSONA_ID(decimal ctacte_persona_id, bool ctacte_persona_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PE</c> foreign key.
		/// </summary>
		/// <param name="ctacte_persona_id">The <c>CTACTE_PERSONA_ID</c> column value.</param>
		/// <param name="ctacte_persona_idNull">true if the method ignores the ctacte_persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects 
		/// by the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_proveedor_id">The <c>CTACTE_PROVEEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public APLICACION_DOCUMENTOS_VALRow[] GetByCTACTE_PROVEEDOR_ID(decimal ctacte_proveedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetByCTACTE_PROVEEDOR_ID(decimal ctacte_proveedor_id, bool ctacte_proveedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_proveedor_id">The <c>CTACTE_PROVEEDOR_ID</c> column value.</param>
		/// <param name="ctacte_proveedor_idNull">true if the method ignores the ctacte_proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects 
		/// by the <c>FK_APLIC_DOCUMEN_VAL_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		public virtual APLICACION_DOCUMENTOS_VALRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_APLIC_DOCUMEN_VAL_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <param name="value">The <see cref="APLICACION_DOCUMENTOS_VALRow"/> object to be inserted.</param>
		public virtual void Insert(APLICACION_DOCUMENTOS_VALRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.APLICACION_DOCUMENTOS_VAL (" +
				"ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <param name="value">The <see cref="APLICACION_DOCUMENTOS_VALRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(APLICACION_DOCUMENTOS_VALRow value)
		{
			
			string sqlStr = "UPDATE TRC.APLICACION_DOCUMENTOS_VAL SET " +
		...
		/// <summary>
		/// Updates the <c>APLICACION_DOCUMENTOS_VAL</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>APLICACION_DOCUMENTOS_VAL</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <param name="value">The <see cref="APLICACION_DOCUMENTOS_VALRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(APLICACION_DOCUMENTOS_VALRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>APLICACION_DOCUMENTOS_VAL</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>APLICACION_DOCUMENTOS_VAL</c> table using the 
		/// <c>FK_APLIC_DOCUMEN_VAL_APLIC_DOC</c> foreign key.
		/// </summary>
		/// <param name="aplicacion_documento_id">The <c>APLICACION_DOCUMENTO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_APLIC_DOCUMEN_VAL_APLIC_DOC</c> foreign key.
		/// </summary>
		/// <param name="aplicacion_documento_id">The <c>APLICACION_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>APLICACION_DOCUMENTOS_VAL</c> table using the 
		/// <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PE</c> foreign key.
		/// </summary>
		/// <param name="ctacte_persona_id">The <c>CTACTE_PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PE</c> foreign key.
		/// </summary>
		/// <param name="ctacte_persona_id">The <c>CTACTE_PERSONA_ID</c> column value.</param>
		/// <param name="ctacte_persona_idNull">true if the method ignores the ctacte_persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>APLICACION_DOCUMENTOS_VAL</c> table using the 
		/// <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_proveedor_id">The <c>CTACTE_PROVEEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_APLIC_DOCUMEN_VAL_CTACTE_PR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_proveedor_id">The <c>CTACTE_PROVEEDOR_ID</c> column value.</param>
		/// <param name="ctacte_proveedor_idNull">true if the method ignores the ctacte_proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>APLICACION_DOCUMENTOS_VAL</c> table using the 
		/// <c>FK_APLIC_DOCUMEN_VAL_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_APLIC_DOCUMEN_VAL_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>APLICACION_DOCUMENTOS_VAL</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>APLICACION_DOCUMENTOS_VAL</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.APLICACION_DOCUMENTOS_VAL";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		protected APLICACION_DOCUMENTOS_VALRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		protected APLICACION_DOCUMENTOS_VALRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="APLICACION_DOCUMENTOS_VALRow"/> objects.</returns>
		protected virtual APLICACION_DOCUMENTOS_VALRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					APLICACION_DOCUMENTOS_VALRow record = new APLICACION_DOCUMENTOS_VALRow();
			...
			return (APLICACION_DOCUMENTOS_VALRow[])(recordList.ToArray(typeof(APLICACION_DOCUMENTOS_VALRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="APLICACION_DOCUMENTOS_VALRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="APLICACION_DOCUMENTOS_VALRow"/> object.</returns>
		protected virtual APLICACION_DOCUMENTOS_VALRow MapRow(DataRow row)
		{
			APLICACION_DOCUMENTOS_VALRow mappedObject = new APLICACION_DOCUMENTOS_VALRow();
		...
		/// the <c>APLICACION_DOCUMENTOS_VAL</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "APLICACION_DOCUMENTOS_VAL";
			DataColumn dataColumn;
	...
	} // End of APLICACION_DOCUMENTOS_VALCollection_Base class
}  // End of namespace
