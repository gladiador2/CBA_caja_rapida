// <fileinfo name="LEGAJOCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="LEGAJOCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="LEGAJOCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class LEGAJOCollection_Base
	{
		// Constants
		public const string IDColumnName = "ID";
		public const string ENTRADA_IDColumnName = "ENTRADA_ID";
		public const string SUBENTRADA_IDColumnName = "SUBENTRADA_ID";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LEGAJOCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public LEGAJOCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>LEGAJO</c> table.
		/// </summary>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetAll()
		{
		...
		/// includes all records from the <c>LEGAJO</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>LEGAJO</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="LEGAJORow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="LEGAJORow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public LEGAJORow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			LEGAJORow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="LEGAJORow"/> objects that 
		...
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public LEGAJORow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.LEGAJO";
		...
		/// <summary>
		/// Gets <see cref="LEGAJORow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="LEGAJORow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual LEGAJORow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			LEGAJORow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="LEGAJORow"/> objects 
		/// by the <c>FK_LEGAJO_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public LEGAJORow[] GetByACTIVO_ID(decimal activo_id)
		{
		...
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetByACTIVO_ID(decimal activo_id, bool activo_idNull)
		{
		...
		/// return records by the <c>FK_LEGAJO_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <param name="activo_idNull">true if the method ignores the activo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="LEGAJORow"/> objects 
		/// by the <c>FK_LEGAJO_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public LEGAJORow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetByPERSONA_ID(decimal persona_id, bool persona_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_LEGAJO_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="LEGAJORow"/> objects 
		/// by the <c>FK_LEGAJO_PROVEEDOR_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public LEGAJORow[] GetByPROVEEDOR_ID(decimal proveedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetByPROVEEDOR_ID(decimal proveedor_id, bool proveedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_LEGAJO_PROVEEDOR_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="LEGAJORow"/> objects 
		/// by the <c>FK_LEGAJO_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_creacion_id">The <c>USUARIO_CREACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public LEGAJORow[] GetByUSUARIO_CREACION_ID(decimal usuario_creacion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		public virtual LEGAJORow[] GetByUSUARIO_CREACION_ID(decimal usuario_creacion_id, bool usuario_creacion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_LEGAJO_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_creacion_id">The <c>USUARIO_CREACION_ID</c> column value.</param>
		/// <param name="usuario_creacion_idNull">true if the method ignores the usuario_creacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>LEGAJO</c> table.
		/// </summary>
		/// <param name="value">The <see cref="LEGAJORow"/> object to be inserted.</param>
		public virtual void Insert(LEGAJORow value)
		{
						
			string sqlStr = "INSERT INTO TRC.LEGAJO (" +
				"ID, " +
				"ENTRADA_ID, " +
				"SUBENTRADA_ID, " +
				"PERSONA_ID, " +
				...
				_db.CreateSqlParameterName("ENTRADA_ID") + ", " +
				_db.CreateSqlParameterName("SUBENTRADA_ID") + ", " +
			...
			AddParameter(cmd, "ENTRADA_ID", value.ENTRADA_ID);
			AddParameter(cmd, "SUBENTRADA_ID", value.SUBENTRADA_ID);
		...
		/// <summary>
		/// Updates a record in the <c>LEGAJO</c> table.
		/// </summary>
		/// <param name="value">The <see cref="LEGAJORow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(LEGAJORow value)
		{
			
			string sqlStr = "UPDATE TRC.LEGAJO SET " +
				"ENTRADA_ID=" + _db.CreateSqlParameterName("ENTRADA_ID") + ", " +
				"SUBENTRADA_ID=" + _db.CreateSqlParameterName("SUBENTRADA_ID") + ", " +
		...
		/// <summary>
		/// Updates the <c>LEGAJO</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>LEGAJO</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>LEGAJO</c> table.
		/// </summary>
		/// <param name="value">The <see cref="LEGAJORow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(LEGAJORow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>LEGAJO</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>LEGAJO</c> table using the 
		/// <c>FK_LEGAJO_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_LEGAJO_ACTIVO_ID</c> foreign key.
		/// </summary>
		/// <param name="activo_id">The <c>ACTIVO_ID</c> column value.</param>
		/// <param name="activo_idNull">true if the method ignores the activo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>LEGAJO</c> table using the 
		/// <c>FK_LEGAJO_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_LEGAJO_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>LEGAJO</c> table using the 
		/// <c>FK_LEGAJO_PROVEEDOR_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_LEGAJO_PROVEEDOR_ID</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>LEGAJO</c> table using the 
		/// <c>FK_LEGAJO_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_creacion_id">The <c>USUARIO_CREACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_LEGAJO_USUARIO_ID</c> foreign key.
		/// </summary>
		/// <param name="usuario_creacion_id">The <c>USUARIO_CREACION_ID</c> column value.</param>
		/// <param name="usuario_creacion_idNull">true if the method ignores the usuario_creacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>LEGAJO</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>LEGAJO</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.LEGAJO";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>LEGAJO</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		protected LEGAJORow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		protected LEGAJORow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="LEGAJORow"/> objects.</returns>
		protected virtual LEGAJORow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int entrada_idColumnIndex = reader.GetOrdinal("ENTRADA_ID");
			int subentrada_idColumnIndex = reader.GetOrdinal("SUBENTRADA_ID");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					LEGAJORow record = new LEGAJORow();
					recordList.Add(record);

					record.ID = Math.Round(Convert.ToDecimal(reader.GetValue(idColumnIndex)), 9);
					record.ENTRADA_ID = Math.Round(Convert.ToDecimal(reader.GetValue(entrada_idColumnIndex)), 9);
					record.SUBENTRADA_ID = Math.Round(Convert.ToDecimal(reader.GetValue(subentrada_idColumnIndex)), 9);
			...
			return (LEGAJORow[])(recordList.ToArray(typeof(LEGAJORow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="LEGAJORow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="LEGAJORow"/> object.</returns>
		protected virtual LEGAJORow MapRow(DataRow row)
		{
			LEGAJORow mappedObject = new LEGAJORow();
			...
			// Column "ENTRADA_ID"
			dataColumn = dataTable.Columns["ENTRADA_ID"];
			if(!row.IsNull(dataColumn))
				mappedObject.ENTRADA_ID = (decimal)row[dataColumn];
			// Column "SUBENTRADA_ID"
			dataColumn = dataTable.Columns["SUBENTRADA_ID"];
			if(!row.IsNull(dataColumn))
				mappedObject.SUBENTRADA_ID = (decimal)row[dataColumn];
			// Column "PERSONA_ID"
		...
		/// the <c>LEGAJO</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "LEGAJO";
			DataColumn dataColumn;
			dataColumn = dataTable.Columns.Add("ID", typeof(decimal));
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("ENTRADA_ID", typeof(decimal));
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("SUBENTRADA_ID", typeof(decimal));
			dataColumn.AllowDBNull = false;
	...
	} // End of LEGAJOCollection_Base class
}  // End of namespace
