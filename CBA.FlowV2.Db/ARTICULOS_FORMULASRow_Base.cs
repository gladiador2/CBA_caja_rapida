// <fileinfo name="ARTICULOS_FORMULASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_FORMULASRow"/> that 
	/// represents a record in the <c>ARTICULOS_FORMULAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_FORMULASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_FORMULASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_FORMULASRow_Base"/> class.
		/// </summary>
		public ARTICULOS_FORMULASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_FORMULASRow_Base original)
		{
	...
	} // End of ARTICULOS_FORMULASRow_Base class
} // End of namespace
