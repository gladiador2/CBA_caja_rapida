// <fileinfo name="DESCUENTO_DOCUMENTOS_CLIENTERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DESCUENTO_DOCUMENTOS_CLIENTERow"/> that 
	/// represents a record in the <c>DESCUENTO_DOCUMENTOS_CLIENTE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="DESCUENTO_DOCUMENTOS_CLIENTERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DESCUENTO_DOCUMENTOS_CLIENTERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DESCUENTO_DOCUMENTOS_CLIENTERow_Base"/> class.
		/// </summary>
		public DESCUENTO_DOCUMENTOS_CLIENTERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(DESCUENTO_DOCUMENTOS_CLIENTERow_Base original)
		{
	...
	} // End of DESCUENTO_DOCUMENTOS_CLIENTERow_Base class
} // End of namespace
