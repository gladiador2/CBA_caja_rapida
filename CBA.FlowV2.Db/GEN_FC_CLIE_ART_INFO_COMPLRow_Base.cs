// <fileinfo name="GEN_FC_CLIE_ART_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="GEN_FC_CLIE_ART_INFO_COMPLRow"/> that 
	/// represents a record in the <c>GEN_FC_CLIE_ART_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="GEN_FC_CLIE_ART_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class GEN_FC_CLIE_ART_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="GEN_FC_CLIE_ART_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public GEN_FC_CLIE_ART_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(GEN_FC_CLIE_ART_INFO_COMPLRow_Base original)
		{
	...
	} // End of GEN_FC_CLIE_ART_INFO_COMPLRow_Base class
} // End of namespace
