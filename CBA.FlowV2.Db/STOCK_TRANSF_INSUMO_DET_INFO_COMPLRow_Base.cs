// <fileinfo name="STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow"/> that 
	/// represents a record in the <c>STOCK_TRANSF_INSUMO_DET_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base original)
		{
	...
	} // End of STOCK_TRANSF_INSUMO_DET_INFO_COMPLRow_Base class
} // End of namespace
