// <fileinfo name="CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_ASIENTOS_AUTO_DET_INFO_COMRow"/> that 
	/// represents a record in the <c>CTB_ASIENTOS_AUTO_DET_INFO_COM</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_ASIENTOS_AUTO_DET_INFO_COMRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base
	{
		private decimal _id;
		...
		private decimal _cantidad_cuentas_relacionadas;
		private bool _cantidad_cuentas_relacionadasNull = true;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base"/> class.
		/// </summary>
		public CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base original)
		{
			...
			if (this.IsCANTIDAD_CUENTAS_RELACIONADASNull != original.IsCANTIDAD_CUENTAS_RELACIONADASNull) return true;
			if (!this.IsCANTIDAD_CUENTAS_RELACIONADASNull && !original.IsCANTIDAD_CUENTAS_RELACIONADASNull)
				if (this.CANTIDAD_CUENTAS_RELACIONADAS != original.CANTIDAD_CUENTAS_RELACIONADAS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CANTIDAD_CUENTAS_RELACIONADAS</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CANTIDAD_CUENTAS_RELACIONADAS</c> column value.</value>
		public decimal CANTIDAD_CUENTAS_RELACIONADAS
		{
			get
			{
				if(IsCANTIDAD_CUENTAS_RELACIONADASNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _cantidad_cuentas_relacionadas;
			}
			set
			{
				_cantidad_cuentas_relacionadasNull = false;
				_cantidad_cuentas_relacionadas = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CANTIDAD_CUENTAS_RELACIONADAS"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCANTIDAD_CUENTAS_RELACIONADASNull
		{
			get { return _cantidad_cuentas_relacionadasNull; }
			set { _cantidad_cuentas_relacionadasNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CANTIDAD_CUENTAS_RELACIONADAS=");
			dynStr.Append(IsCANTIDAD_CUENTAS_RELACIONADASNull ? (object)"<NULL>" : CANTIDAD_CUENTAS_RELACIONADAS);
	...
	} // End of CTB_ASIENTOS_AUTO_DET_INFO_COMRow_Base class
} // End of namespace
