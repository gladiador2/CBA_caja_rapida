// <fileinfo name="ARTICULOS_LINEASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_LINEASRow"/> that 
	/// represents a record in the <c>ARTICULOS_LINEAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_LINEASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_LINEASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_LINEASRow_Base"/> class.
		/// </summary>
		public ARTICULOS_LINEASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_LINEASRow_Base original)
		{
	...
	} // End of ARTICULOS_LINEASRow_Base class
} // End of namespace
