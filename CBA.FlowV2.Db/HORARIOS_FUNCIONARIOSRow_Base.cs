// <fileinfo name="HORARIOS_FUNCIONARIOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="HORARIOS_FUNCIONARIOSRow"/> that 
	/// represents a record in the <c>HORARIOS_FUNCIONARIOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="HORARIOS_FUNCIONARIOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class HORARIOS_FUNCIONARIOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="HORARIOS_FUNCIONARIOSRow_Base"/> class.
		/// </summary>
		public HORARIOS_FUNCIONARIOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(HORARIOS_FUNCIONARIOSRow_Base original)
		{
	...
	} // End of HORARIOS_FUNCIONARIOSRow_Base class
} // End of namespace
