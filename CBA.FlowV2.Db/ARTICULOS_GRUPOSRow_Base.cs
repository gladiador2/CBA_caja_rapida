// <fileinfo name="ARTICULOS_GRUPOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_GRUPOSRow"/> that 
	/// represents a record in the <c>ARTICULOS_GRUPOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_GRUPOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_GRUPOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_GRUPOSRow_Base"/> class.
		/// </summary>
		public ARTICULOS_GRUPOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_GRUPOSRow_Base original)
		{
	...
	} // End of ARTICULOS_GRUPOSRow_Base class
} // End of namespace
