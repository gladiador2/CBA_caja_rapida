// <fileinfo name="STOCK_BOXRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_BOXRow"/> that 
	/// represents a record in the <c>STOCK_BOX</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_BOXRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_BOXRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_BOXRow_Base"/> class.
		/// </summary>
		public STOCK_BOXRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_BOXRow_Base original)
		{
	...
	} // End of STOCK_BOXRow_Base class
} // End of namespace
