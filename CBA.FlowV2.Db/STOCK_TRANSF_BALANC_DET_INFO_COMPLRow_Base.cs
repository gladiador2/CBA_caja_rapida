// <fileinfo name="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/> that 
	/// represents a record in the <c>STOCK_TRANSF_BALANC_DET_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base
	{
		private decimal _id;
		private decimal _transferencia_balanc_id;
		private bool _transferencia_balanc_idNull = true;
		...
		private decimal _nro_celda;
		private bool _nro_celdaNull = true;
		private decimal _deposito_origen_id;
		private bool _deposito_origen_idNull = true;
		private string _deposito_origen;

		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.IsTRANSFERENCIA_BALANC_IDNull != original.IsTRANSFERENCIA_BALANC_IDNull) return true;
			if (!this.IsTRANSFERENCIA_BALANC_IDNull && !original.IsTRANSFERENCIA_BALANC_IDNull)
			...
			if (this.IsNRO_CELDANull != original.IsNRO_CELDANull) return true;
			if (!this.IsNRO_CELDANull && !original.IsNRO_CELDANull)
				if (this.NRO_CELDA != original.NRO_CELDA) return true;
			if (this.IsDEPOSITO_ORIGEN_IDNull != original.IsDEPOSITO_ORIGEN_IDNull) return true;
			if (!this.IsDEPOSITO_ORIGEN_IDNull && !original.IsDEPOSITO_ORIGEN_IDNull)
		...
		public decimal TRANSFERENCIA_BALANC_ID
		{
			get
			{
				if(IsTRANSFERENCIA_BALANC_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _transferencia_balanc_id;
			}
			set
			{
				_transferencia_balanc_idNull = false;
				_transferencia_balanc_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="TRANSFERENCIA_BALANC_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsTRANSFERENCIA_BALANC_IDNull
		{
			get { return _transferencia_balanc_idNull; }
			set { _transferencia_balanc_idNull = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>NRO_CELDA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>NRO_CELDA</c> column value.</value>
		public decimal NRO_CELDA
		{
			get
			{
				if(IsNRO_CELDANull)
			...
			set
			{
				_nro_celdaNull = false;
				_nro_celda = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="NRO_CELDA"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsNRO_CELDANull
		{
			get { return _nro_celdaNull; }
			set { _nro_celdaNull = value; }
		}
		...
		public decimal DEPOSITO_ORIGEN_ID
		{
			get
			{
				if(IsDEPOSITO_ORIGEN_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _deposito_origen_id;
			}
			set
			{
				_deposito_origen_idNull = false;
				_deposito_origen_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="DEPOSITO_ORIGEN_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsDEPOSITO_ORIGEN_IDNull
		{
			get { return _deposito_origen_idNull; }
			set { _deposito_origen_idNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(IsTRANSFERENCIA_BALANC_IDNull ? (object)"<NULL>" : TRANSFERENCIA_BALANC_ID);
			...
			dynStr.Append("@CBA@NRO_CELDA=");
			dynStr.Append(IsNRO_CELDANull ? (object)"<NULL>" : NRO_CELDA);
			dynStr.Append("@CBA@DEPOSITO_ORIGEN_ID=");
			dynStr.Append(IsDEPOSITO_ORIGEN_IDNull ? (object)"<NULL>" : DEPOSITO_ORIGEN_ID);
			dynStr.Append("@CBA@DEPOSITO_ORIGEN=");
			dynStr.Append(DEPOSITO_ORIGEN);
			return dynStr.ToString();
		}
	} // End of STOCK_TRANSF_BALANC_DET_INFO_COMPLRow_Base class
} // End of namespace
