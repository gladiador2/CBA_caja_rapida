// <fileinfo name="CALENDARIOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CALENDARIOSRow"/> that 
	/// represents a record in the <c>CALENDARIOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CALENDARIOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CALENDARIOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CALENDARIOSRow_Base"/> class.
		/// </summary>
		public CALENDARIOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CALENDARIOSRow_Base original)
		{
	...
	} // End of CALENDARIOSRow_Base class
} // End of namespace
