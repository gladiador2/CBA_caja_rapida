// <fileinfo name="CTACTE_CAJA_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CAJA_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>CTACTE_CAJA_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_CAJA_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CAJA_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _usuario_usuario;
		private decimal _funcionario_cobrador_id;
		private string _funcionario_cobrador_nombre;
		...
		private string _ctacte_cheque_rec_datos_resum;
		private string _ctacte_cheque_recibido_numero;
		private System.DateTime _ctacte_cheque_recibido_venc;
		private bool _ctacte_cheque_recibido_vencNull = true;
		private string _ctacte_cheque_recibido_emisor;
		private decimal _ctacte_chq_recibido_estado_id;
		private bool _ctacte_chq_recibido_estado_idNull = true;
		private string _ctacte_cheque_recibido_banco;
		private string _ctacte_cheq_recibido_n_cuenta;
		private string _ctacte_chq_recibido_estado;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CAJA_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public CTACTE_CAJA_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_CAJA_INFO_COMPLETARow_Base original)
		{
			...
			if (this.USUARIO_USUARIO != original.USUARIO_USUARIO) return true;
			if (this.FUNCIONARIO_COBRADOR_ID != original.FUNCIONARIO_COBRADOR_ID) return true;
			if (this.FUNCIONARIO_COBRADOR_NOMBRE != original.FUNCIONARIO_COBRADOR_NOMBRE) return true;
			...
			if (this.CTACTE_CHEQUE_REC_DATOS_RESUM != original.CTACTE_CHEQUE_REC_DATOS_RESUM) return true;
			if (this.CTACTE_CHEQUE_RECIBIDO_NUMERO != original.CTACTE_CHEQUE_RECIBIDO_NUMERO) return true;
			if (this.IsCTACTE_CHEQUE_RECIBIDO_VENCNull != original.IsCTACTE_CHEQUE_RECIBIDO_VENCNull) return true;
			if (!this.IsCTACTE_CHEQUE_RECIBIDO_VENCNull && !original.IsCTACTE_CHEQUE_RECIBIDO_VENCNull)
				if (this.CTACTE_CHEQUE_RECIBIDO_VENC != original.CTACTE_CHEQUE_RECIBIDO_VENC) return true;
			if (this.CTACTE_CHEQUE_RECIBIDO_EMISOR != original.CTACTE_CHEQUE_RECIBIDO_EMISOR) return true;
			if (this.IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull != original.IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull) return true;
			if (!this.IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull && !original.IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull)
				if (this.CTACTE_CHQ_RECIBIDO_ESTADO_ID != original.CTACTE_CHQ_RECIBIDO_ESTADO_ID) return true;
			if (this.CTACTE_CHEQUE_RECIBIDO_BANCO != original.CTACTE_CHEQUE_RECIBIDO_BANCO) return true;
			if (this.CTACTE_CHEQ_RECIBIDO_N_CUENTA != original.CTACTE_CHEQ_RECIBIDO_N_CUENTA) return true;
			if (this.CTACTE_CHQ_RECIBIDO_ESTADO != original.CTACTE_CHQ_RECIBIDO_ESTADO) return true;
			...
			if (this.CTACTE_RECIBO_NRO != original.CTACTE_RECIBO_NRO) return true;
			...
			if (this.CTACTE_CAJA_SUCURSAL_ESTADO != original.CTACTE_CAJA_SUCURSAL_ESTADO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>USUARIO_USUARIO</c> column value.
		/// </summary>
		/// <value>The <c>USUARIO_USUARIO</c> column value.</value>
		public string USUARIO_USUARIO
		{
			get { return _usuario_usuario; }
			set { _usuario_usuario = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>FUNCIONARIO_COBRADOR_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>FUNCIONARIO_COBRADOR_NOMBRE</c> column value.</value>
		public string FUNCIONARIO_COBRADOR_NOMBRE
		{
			get { return _funcionario_cobrador_nombre; }
			set { _funcionario_cobrador_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_REC_DATOS_RESUM</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_REC_DATOS_RESUM</c> column value.</value>
		public string CTACTE_CHEQUE_REC_DATOS_RESUM
		{
			get { return _ctacte_cheque_rec_datos_resum; }
			set { _ctacte_cheque_rec_datos_resum = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_NUMERO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_NUMERO</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_NUMERO
		{
			get { return _ctacte_cheque_recibido_numero; }
			set { _ctacte_cheque_recibido_numero = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_VENC</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_VENC</c> column value.</value>
		public System.DateTime CTACTE_CHEQUE_RECIBIDO_VENC
		{
			get
			{
				if(IsCTACTE_CHEQUE_RECIBIDO_VENCNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _ctacte_cheque_recibido_venc;
			}
			set
			{
				_ctacte_cheque_recibido_vencNull = false;
				_ctacte_cheque_recibido_venc = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CTACTE_CHEQUE_RECIBIDO_VENC"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCTACTE_CHEQUE_RECIBIDO_VENCNull
		{
			get { return _ctacte_cheque_recibido_vencNull; }
			set { _ctacte_cheque_recibido_vencNull = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_EMISOR</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_EMISOR</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_EMISOR
		{
			get { return _ctacte_cheque_recibido_emisor; }
			set { _ctacte_cheque_recibido_emisor = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHQ_RECIBIDO_ESTADO_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHQ_RECIBIDO_ESTADO_ID</c> column value.</value>
		public decimal CTACTE_CHQ_RECIBIDO_ESTADO_ID
		{
			get
			{
				if(IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _ctacte_chq_recibido_estado_id;
			}
			set
			{
				_ctacte_chq_recibido_estado_idNull = false;
				_ctacte_chq_recibido_estado_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CTACTE_CHQ_RECIBIDO_ESTADO_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull
		{
			get { return _ctacte_chq_recibido_estado_idNull; }
			set { _ctacte_chq_recibido_estado_idNull = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQUE_RECIBIDO_BANCO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQUE_RECIBIDO_BANCO</c> column value.</value>
		public string CTACTE_CHEQUE_RECIBIDO_BANCO
		{
			get { return _ctacte_cheque_recibido_banco; }
			set { _ctacte_cheque_recibido_banco = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHEQ_RECIBIDO_N_CUENTA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHEQ_RECIBIDO_N_CUENTA</c> column value.</value>
		public string CTACTE_CHEQ_RECIBIDO_N_CUENTA
		{
			get { return _ctacte_cheq_recibido_n_cuenta; }
			set { _ctacte_cheq_recibido_n_cuenta = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CTACTE_CHQ_RECIBIDO_ESTADO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_CHQ_RECIBIDO_ESTADO</c> column value.</value>
		public string CTACTE_CHQ_RECIBIDO_ESTADO
		{
			get { return _ctacte_chq_recibido_estado; }
			set { _ctacte_chq_recibido_estado = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CTACTE_RECIBO_NRO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CTACTE_RECIBO_NRO</c> column value.</value>
		public string CTACTE_RECIBO_NRO
		{
			get { return _ctacte_recibo_nro; }
			set { _ctacte_recibo_nro = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CTACTE_CAJA_SUCURSAL_ESTADO</c> column value.
		/// </summary>
		/// <value>The <c>CTACTE_CAJA_SUCURSAL_ESTADO</c> column value.</value>
		public string CTACTE_CAJA_SUCURSAL_ESTADO
		{
			get { return _ctacte_caja_sucursal_estado; }
			set { _ctacte_caja_sucursal_estado = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@USUARIO_USUARIO=");
			dynStr.Append(USUARIO_USUARIO);
			dynStr.Append("@CBA@FUNCIONARIO_COBRADOR_ID=");
			dynStr.Append(FUNCIONARIO_COBRADOR_ID);
			dynStr.Append("@CBA@FUNCIONARIO_COBRADOR_NOMBRE=");
			dynStr.Append(FUNCIONARIO_COBRADOR_NOMBRE);
			...
			dynStr.Append("@CBA@CTACTE_CHEQUE_REC_DATOS_RESUM=");
			dynStr.Append(CTACTE_CHEQUE_REC_DATOS_RESUM);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_NUMERO=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_NUMERO);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_VENC=");
			dynStr.Append(IsCTACTE_CHEQUE_RECIBIDO_VENCNull ? (object)"<NULL>" : CTACTE_CHEQUE_RECIBIDO_VENC);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_EMISOR=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_EMISOR);
			dynStr.Append("@CBA@CTACTE_CHQ_RECIBIDO_ESTADO_ID=");
			dynStr.Append(IsCTACTE_CHQ_RECIBIDO_ESTADO_IDNull ? (object)"<NULL>" : CTACTE_CHQ_RECIBIDO_ESTADO_ID);
			dynStr.Append("@CBA@CTACTE_CHEQUE_RECIBIDO_BANCO=");
			dynStr.Append(CTACTE_CHEQUE_RECIBIDO_BANCO);
			dynStr.Append("@CBA@CTACTE_CHEQ_RECIBIDO_N_CUENTA=");
			dynStr.Append(CTACTE_CHEQ_RECIBIDO_N_CUENTA);
			dynStr.Append("@CBA@CTACTE_CHQ_RECIBIDO_ESTADO=");
			dynStr.Append(CTACTE_CHQ_RECIBIDO_ESTADO);
			...
			dynStr.Append("@CBA@CTACTE_RECIBO_NRO=");
			dynStr.Append(CTACTE_RECIBO_NRO);
			dynStr.Append("@CBA@CTACTE_CAJA_SUCURSAL_ID=");
			dynStr.Append(IsCTACTE_CAJA_SUCURSAL_IDNull ? (object)"<NULL>" : CTACTE_CAJA_SUCURSAL_ID);
			dynStr.Append("@CBA@CTACTE_CAJA_SUCURSAL_ESTADO=");
			dynStr.Append(CTACTE_CAJA_SUCURSAL_ESTADO);
	...
	} // End of CTACTE_CAJA_INFO_COMPLETARow_Base class
} // End of namespace
