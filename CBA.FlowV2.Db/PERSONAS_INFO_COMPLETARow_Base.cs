// <fileinfo name="PERSONAS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PERSONAS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>PERSONAS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PERSONAS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PERSONAS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _moneda_limite_credito;
		...
		private string _documentacion_estado;
		...
		private string _estado_civil_descripcion;
		private string _tipo_empleo;
		private string _separacion_bienes;
		private decimal _porc_descuento_automatico;
		private decimal _persona_calificaion_id;
		private bool _persona_calificaion_idNull = true;
		...
		private string _estado_morosidad_nombre;
		...
		private string _vendedor_habitual_nombre;
		private string _vendedor_habitual_codigo;
		...
		private string _persona_padre_codigo;
		private decimal _lista_precios_id;
		private bool _lista_precios_idNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="PERSONAS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public PERSONAS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PERSONAS_INFO_COMPLETARow_Base original)
		{
			...
			if (this.TRATAMIENTO != original.TRATAMIENTO) return true;
			...
			if (this.PAIS_NACIONALIDAD != original.PAIS_NACIONALIDAD) return true;
			...
			if (this.PAIS_RESIDENCIA != original.PAIS_RESIDENCIA) return true;
			...
			if (this.ABOGADO_NOMBRE != original.ABOGADO_NOMBRE) return true;
			if (this.PROFESION_ID != original.PROFESION_ID) return true;
			if (this.PROFESION_NOMBRE != original.PROFESION_NOMBRE) return true;
			...
			if (this.DEPARTAMENT01_NOMBRE != original.DEPARTAMENT01_NOMBRE) return true;
			...
			if (this.CIUDAD1_NOMBRE != original.CIUDAD1_NOMBRE) return true;
			...
			if (this.BARRIO1_NOMBRE != original.BARRIO1_NOMBRE) return true;
			...
			if (this.DEPARTAMENTO2_NOMBRE != original.DEPARTAMENTO2_NOMBRE) return true;
			...
			if (this.CIUDAD2_NOMBRE != original.CIUDAD2_NOMBRE) return true;
			...
			if (this.BARRIO2_NOMBRE != original.BARRIO2_NOMBRE) return true;
			...
			if (this.MONEDA_LIMITE_CREDITO != original.MONEDA_LIMITE_CREDITO) return true;
			...
			if (this.DEPARTAMENTO_COBRANZA != original.DEPARTAMENTO_COBRANZA) return true;
			...
			if (this.CIUDAD_COBRANZA != original.CIUDAD_COBRANZA) return true;
			...
			if (this.BARRIO_COBRANZA != original.BARRIO_COBRANZA) return true;
			...
			if (this.DOCUMENTACION_ESTADO != original.DOCUMENTACION_ESTADO) return true;
			...
			if (this.NIVEL_CREDITO != original.NIVEL_CREDITO) return true;
			...
			if (this.ESTADO_CIVIL_DESCRIPCION != original.ESTADO_CIVIL_DESCRIPCION) return true;
			...
			if (this.IsPERSONA_CALIFICAION_IDNull != original.IsPERSONA_CALIFICAION_IDNull) return true;
			if (!this.IsPERSONA_CALIFICAION_IDNull && !original.IsPERSONA_CALIFICAION_IDNull)
				if (this.PERSONA_CALIFICAION_ID != original.PERSONA_CALIFICAION_ID) return true;
			...
			if (this.ESTADO_MOROSIDAD_NOMBRE != original.ESTADO_MOROSIDAD_NOMBRE) return true;
			if (this.DESCRIPCION_CALIFICACION != original.DESCRIPCION_CALIFICACION) return true;
			...
			if (this.VENDEDOR_HABITUAL_NOMBRE != original.VENDEDOR_HABITUAL_NOMBRE) return true;
			if (this.VENDEDOR_HABITUAL_CODIGO != original.VENDEDOR_HABITUAL_CODIGO) return true;
			...
			if (this.PERSONA_PADRE_CODIGO != original.PERSONA_PADRE_CODIGO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>TRATAMIENTO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>TRATAMIENTO</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>PAIS_NACIONALIDAD</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PAIS_NACIONALIDAD</c> column value.</value>
		...
		/// <summary>
		/// Gets or sets the <c>PAIS_RESIDENCIA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PAIS_RESIDENCIA</c> column value.</value>
		public string PAIS_RESIDENCIA
		{
			get { return _pais_residencia; }
			set { _pais_residencia = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ABOGADO_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ABOGADO_NOMBRE</c> column value.</value>
		public string ABOGADO_NOMBRE
		{
			get { return _abogado_nombre; }
			set { _abogado_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>PROFESION_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PROFESION_NOMBRE</c> column value.</value>
		public string PROFESION_NOMBRE
		{
			get { return _profesion_nombre; }
			set { _profesion_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENT01_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENT01_NOMBRE</c> column value.</value>
		public string DEPARTAMENT01_NOMBRE
		{
			get { return _departament01_nombre; }
			set { _departament01_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CIUDAD1_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CIUDAD1_NOMBRE</c> column value.</value>
		public string CIUDAD1_NOMBRE
		{
			get { return _ciudad1_nombre; }
			set { _ciudad1_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>BARRIO1_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BARRIO1_NOMBRE</c> column value.</value>
		public string BARRIO1_NOMBRE
		{
			get { return _barrio1_nombre; }
			set { _barrio1_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENTO2_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENTO2_NOMBRE</c> column value.</value>
		public string DEPARTAMENTO2_NOMBRE
		{
			get { return _departamento2_nombre; }
			set { _departamento2_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CIUDAD2_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CIUDAD2_NOMBRE</c> column value.</value>
		public string CIUDAD2_NOMBRE
		{
			get { return _ciudad2_nombre; }
			set { _ciudad2_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>BARRIO2_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BARRIO2_NOMBRE</c> column value.</value>
		public string BARRIO2_NOMBRE
		{
			get { return _barrio2_nombre; }
			set { _barrio2_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>MONEDA_LIMITE_CREDITO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>MONEDA_LIMITE_CREDITO</c> column value.</value>
		public string MONEDA_LIMITE_CREDITO
		{
			get { return _moneda_limite_credito; }
			set { _moneda_limite_credito = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPARTAMENTO_COBRANZA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DEPARTAMENTO_COBRANZA</c> column value.</value>
		public string DEPARTAMENTO_COBRANZA
		{
			get { return _departamento_cobranza; }
			set { _departamento_cobranza = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CIUDAD_COBRANZA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CIUDAD_COBRANZA</c> column value.</value>
		public string CIUDAD_COBRANZA
		{
			get { return _ciudad_cobranza; }
			set { _ciudad_cobranza = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>BARRIO_COBRANZA</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>BARRIO_COBRANZA</c> column value.</value>
		public string BARRIO_COBRANZA
		{
			get { return _barrio_cobranza; }
			set { _barrio_cobranza = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DOCUMENTACION_ESTADO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DOCUMENTACION_ESTADO</c> column value.</value>
		public string DOCUMENTACION_ESTADO
		{
			get { return _documentacion_estado; }
			set { _documentacion_estado = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>NIVEL_CREDITO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>NIVEL_CREDITO</c> column value.</value>
		public string NIVEL_CREDITO
		{
			get { return _nivel_credito; }
			set { _nivel_credito = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ESTADO_CIVIL_DESCRIPCION</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ESTADO_CIVIL_DESCRIPCION</c> column value.</value>
		public string ESTADO_CIVIL_DESCRIPCION
		{
			get { return _estado_civil_descripcion; }
			set { _estado_civil_descripcion = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>PERSONA_CALIFICAION_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PERSONA_CALIFICAION_ID</c> column value.</value>
		public decimal PERSONA_CALIFICAION_ID
		{
			get
			{
				if(IsPERSONA_CALIFICAION_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _persona_calificaion_id;
			}
			set
			{
				_persona_calificaion_idNull = false;
				_persona_calificaion_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="PERSONA_CALIFICAION_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsPERSONA_CALIFICAION_IDNull
		{
			get { return _persona_calificaion_idNull; }
			set { _persona_calificaion_idNull = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ESTADO_MOROSIDAD_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>ESTADO_MOROSIDAD_NOMBRE</c> column value.</value>
		public string ESTADO_MOROSIDAD_NOMBRE
		{
			get { return _estado_morosidad_nombre; }
			set { _estado_morosidad_nombre = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>DESCRIPCION_CALIFICACION</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>DESCRIPCION_CALIFICACION</c> column value.</value>
		public string DESCRIPCION_CALIFICACION
		{
			get { return _descripcion_calificacion; }
			set { _descripcion_calificacion = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>VENDEDOR_HABITUAL_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>VENDEDOR_HABITUAL_NOMBRE</c> column value.</value>
		public string VENDEDOR_HABITUAL_NOMBRE
		{
			get { return _vendedor_habitual_nombre; }
			set { _vendedor_habitual_nombre = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>VENDEDOR_HABITUAL_CODIGO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>VENDEDOR_HABITUAL_CODIGO</c> column value.</value>
		public string VENDEDOR_HABITUAL_CODIGO
		{
			get { return _vendedor_habitual_codigo; }
			set { _vendedor_habitual_codigo = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>PERSONA_PADRE_CODIGO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>PERSONA_PADRE_CODIGO</c> column value.</value>
		public string PERSONA_PADRE_CODIGO
		{
			get { return _persona_padre_codigo; }
			set { _persona_padre_codigo = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@TRATAMIENTO=");
			dynStr.Append(TRATAMIENTO);
			...
			dynStr.Append("@CBA@PAIS_NACIONALIDAD=");
			dynStr.Append(PAIS_NACIONALIDAD);
			dynStr.Append("@CBA@PAIS_RESIDENCIA_ID=");
			dynStr.Append(IsPAIS_RESIDENCIA_IDNull ? (object)"<NULL>" : PAIS_RESIDENCIA_ID);
			dynStr.Append("@CBA@PAIS_RESIDENCIA=");
			dynStr.Append(PAIS_RESIDENCIA);
			...
			dynStr.Append("@CBA@DEPARTAMENTO2_NOMBRE=");
			dynStr.Append(DEPARTAMENTO2_NOMBRE);
			dynStr.Append("@CBA@CIUDAD2_ID=");
			dynStr.Append(IsCIUDAD2_IDNull ? (object)"<NULL>" : CIUDAD2_ID);
			dynStr.Append("@CBA@CIUDAD2_NOMBRE=");
			dynStr.Append(CIUDAD2_NOMBRE);
			dynStr.Append("@CBA@BARRIO2_ID=");
			dynStr.Append(IsBARRIO2_IDNull ? (object)"<NULL>" : BARRIO2_ID);
			dynStr.Append("@CBA@BARRIO2_NOMBRE=");
			dynStr.Append(BARRIO2_NOMBRE);
			...
			dynStr.Append("@CBA@MONEDA_LIMITE_CREDITO=");
			dynStr.Append(MONEDA_LIMITE_CREDITO);
			...
			dynStr.Append("@CBA@DOCUMENTACION_ESTADO=");
			dynStr.Append(DOCUMENTACION_ESTADO);
			...
			dynStr.Append("@CBA@NIVEL_CREDITO=");
			dynStr.Append(NIVEL_CREDITO);
			...
			dynStr.Append("@CBA@ESTADO_CIVIL_DESCRIPCION=");
			dynStr.Append(ESTADO_CIVIL_DESCRIPCION);
			...
			dynStr.Append("@CBA@PERSONA_CALIFICAION_ID=");
			dynStr.Append(IsPERSONA_CALIFICAION_IDNull ? (object)"<NULL>" : PERSONA_CALIFICAION_ID);
			...
			dynStr.Append("@CBA@ESTADO_MOROSIDAD_NOMBRE=");
			dynStr.Append(ESTADO_MOROSIDAD_NOMBRE);
			dynStr.Append("@CBA@DESCRIPCION_CALIFICACION=");
			dynStr.Append(DESCRIPCION_CALIFICACION);
			...
			dynStr.Append("@CBA@VENDEDOR_HABITUAL_NOMBRE=");
			dynStr.Append(VENDEDOR_HABITUAL_NOMBRE);
			dynStr.Append("@CBA@VENDEDOR_HABITUAL_CODIGO=");
			dynStr.Append(VENDEDOR_HABITUAL_CODIGO);
			...
			dynStr.Append("@CBA@PERSONA_PADRE_CODIGO=");
			dynStr.Append(PERSONA_PADRE_CODIGO);
			dynStr.Append("@CBA@LISTA_PRECIOS_ID=");
			dynStr.Append(IsLISTA_PRECIOS_IDNull ? (object)"<NULL>" : LISTA_PRECIOS_ID);
			return dynStr.ToString();
		}
	} // End of PERSONAS_INFO_COMPLETARow_Base class
} // End of namespace
