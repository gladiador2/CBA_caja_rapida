// <fileinfo name="STOCK_CRITICORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_CRITICORow"/> that 
	/// represents a record in the <c>STOCK_CRITICO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_CRITICORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_CRITICORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_CRITICORow_Base"/> class.
		/// </summary>
		public STOCK_CRITICORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_CRITICORow_Base original)
		{
	...
	} // End of STOCK_CRITICORow_Base class
} // End of namespace
