// <fileinfo name="STOCK_TRANSF_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSF_INFO_COMPLRow"/> that 
	/// represents a record in the <c>STOCK_TRANSF_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSF_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSF_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		private string _sucursal_destino_abr;
		private decimal _deposito_destino_id;
		private string _deposito_destino;
		private string _deposito_destino_abr;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSF_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public STOCK_TRANSF_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSF_INFO_COMPLRow_Base original)
		{
			...
			if (this.SUCURSAL_DESTINO_ABR != original.SUCURSAL_DESTINO_ABR) return true;
			...
			if (this.DEPOSITO_DESTINO_ABR != original.DEPOSITO_DESTINO_ABR) return true;
		...
		/// <summary>
		/// Gets or sets the <c>SUCURSAL_DESTINO_ABR</c> column value.
		/// </summary>
		/// <value>The <c>SUCURSAL_DESTINO_ABR</c> column value.</value>
		public string SUCURSAL_DESTINO_ABR
		{
			get { return _sucursal_destino_abr; }
			set { _sucursal_destino_abr = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>DEPOSITO_DESTINO_ABR</c> column value.
		/// </summary>
		/// <value>The <c>DEPOSITO_DESTINO_ABR</c> column value.</value>
		public string DEPOSITO_DESTINO_ABR
		{
			get { return _deposito_destino_abr; }
			set { _deposito_destino_abr = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@SUCURSAL_DESTINO_ABR=");
			dynStr.Append(SUCURSAL_DESTINO_ABR);
			...
			dynStr.Append("@CBA@DEPOSITO_DESTINO_ABR=");
			dynStr.Append(DEPOSITO_DESTINO_ABR);
	...
	} // End of STOCK_TRANSF_INFO_COMPLRow_Base class
} // End of namespace
