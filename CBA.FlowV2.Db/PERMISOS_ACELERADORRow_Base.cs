// <fileinfo name="PERMISOS_ACELERADORRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PERMISOS_ACELERADORRow"/> that 
	/// represents a record in the <c>PERMISOS_ACELERADOR</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PERMISOS_ACELERADORRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PERMISOS_ACELERADORRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PERMISOS_ACELERADORRow_Base"/> class.
		/// </summary>
		public PERMISOS_ACELERADORRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PERMISOS_ACELERADORRow_Base original)
		{
	...
	} // End of PERMISOS_ACELERADORRow_Base class
} // End of namespace
