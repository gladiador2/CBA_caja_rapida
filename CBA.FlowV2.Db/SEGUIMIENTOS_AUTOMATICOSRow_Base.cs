// <fileinfo name="SEGUIMIENTOS_AUTOMATICOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="SEGUIMIENTOS_AUTOMATICOSRow"/> that 
	/// represents a record in the <c>SEGUIMIENTOS_AUTOMATICOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="SEGUIMIENTOS_AUTOMATICOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class SEGUIMIENTOS_AUTOMATICOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="SEGUIMIENTOS_AUTOMATICOSRow_Base"/> class.
		/// </summary>
		public SEGUIMIENTOS_AUTOMATICOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(SEGUIMIENTOS_AUTOMATICOSRow_Base original)
		{
	...
	} // End of SEGUIMIENTOS_AUTOMATICOSRow_Base class
} // End of namespace
