// <fileinfo name="LEGAJO_FUNCIONARIOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="LEGAJO_FUNCIONARIOSRow"/> that 
	/// represents a record in the <c>LEGAJO_FUNCIONARIOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="LEGAJO_FUNCIONARIOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class LEGAJO_FUNCIONARIOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LEGAJO_FUNCIONARIOSRow_Base"/> class.
		/// </summary>
		public LEGAJO_FUNCIONARIOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(LEGAJO_FUNCIONARIOSRow_Base original)
		{
	...
	} // End of LEGAJO_FUNCIONARIOSRow_Base class
} // End of namespace
