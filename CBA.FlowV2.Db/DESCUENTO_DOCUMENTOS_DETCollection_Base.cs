// <fileinfo name="DESCUENTO_DOCUMENTOS_DETCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DESCUENTO_DOCUMENTOS_DETCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="DESCUENTO_DOCUMENTOS_DETCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DESCUENTO_DOCUMENTOS_DETCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DESCUENTO_DOCUMENTOS_DETCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public DESCUENTO_DOCUMENTOS_DETCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetAll()
		{
		...
		/// includes all records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public DESCUENTO_DOCUMENTOS_DETRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			DESCUENTO_DOCUMENTOS_DETRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects that 
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_DETRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.DESCUENTO_DOCUMENTOS_DET";
		...
		/// <summary>
		/// Gets <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			DESCUENTO_DOCUMENTOS_DETRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects 
		/// by the <c>FK_DESC_DOCS_DET_CHEQUE_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_DETRow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id)
		{
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id, bool ctacte_cheque_recibido_idNull)
		{
		...
		/// return records by the <c>FK_DESC_DOCS_DET_CHEQUE_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects 
		/// by the <c>FK_DESC_DOCS_DET_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetByCTACTE_VALOR_ID(decimal ctacte_valor_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_DET_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects 
		/// by the <c>FK_DESC_DOCS_DET_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetByDESCUENTO_DOCUMENTO_ID(decimal descuento_documento_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_DET_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects 
		/// by the <c>FK_DESC_DOCS_DET_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_DET_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects 
		/// by the <c>FK_DESC_DOCS_DET_PAGARE_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public DESCUENTO_DOCUMENTOS_DETRow[] GetByCTACTE_PAGARE_DET_ID(decimal ctacte_pagare_det_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		public virtual DESCUENTO_DOCUMENTOS_DETRow[] GetByCTACTE_PAGARE_DET_ID(decimal ctacte_pagare_det_id, bool ctacte_pagare_det_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_DESC_DOCS_DET_PAGARE_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <param name="ctacte_pagare_det_idNull">true if the method ignores the ctacte_pagare_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> object to be inserted.</param>
		public virtual void Insert(DESCUENTO_DOCUMENTOS_DETRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.DESCUENTO_DOCUMENTOS_DET (" +
				"ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_DETRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(DESCUENTO_DOCUMENTOS_DETRow value)
		{
			
			string sqlStr = "UPDATE TRC.DESCUENTO_DOCUMENTOS_DET SET " +
		...
		/// <summary>
		/// Updates the <c>DESCUENTO_DOCUMENTOS_DET</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>DESCUENTO_DOCUMENTOS_DET</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(DESCUENTO_DOCUMENTOS_DETRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using the 
		/// <c>FK_DESC_DOCS_DET_CHEQUE_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_DET_CHEQUE_REC_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using the 
		/// <c>FK_DESC_DOCS_DET_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_DET_CTACTE_VAL_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using the 
		/// <c>FK_DESC_DOCS_DET_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_DET_DESC</c> foreign key.
		/// </summary>
		/// <param name="descuento_documento_id">The <c>DESCUENTO_DOCUMENTO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using the 
		/// <c>FK_DESC_DOCS_DET_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_DET_MONEDA</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table using the 
		/// <c>FK_DESC_DOCS_DET_PAGARE_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_DESC_DOCS_DET_PAGARE_ID</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <param name="ctacte_pagare_det_idNull">true if the method ignores the ctacte_pagare_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>DESCUENTO_DOCUMENTOS_DET</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>DESCUENTO_DOCUMENTOS_DET</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.DESCUENTO_DOCUMENTOS_DET";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		protected DESCUENTO_DOCUMENTOS_DETRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		protected DESCUENTO_DOCUMENTOS_DETRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> objects.</returns>
		protected virtual DESCUENTO_DOCUMENTOS_DETRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					DESCUENTO_DOCUMENTOS_DETRow record = new DESCUENTO_DOCUMENTOS_DETRow();
			...
			return (DESCUENTO_DOCUMENTOS_DETRow[])(recordList.ToArray(typeof(DESCUENTO_DOCUMENTOS_DETRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="DESCUENTO_DOCUMENTOS_DETRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="DESCUENTO_DOCUMENTOS_DETRow"/> object.</returns>
		protected virtual DESCUENTO_DOCUMENTOS_DETRow MapRow(DataRow row)
		{
			DESCUENTO_DOCUMENTOS_DETRow mappedObject = new DESCUENTO_DOCUMENTOS_DETRow();
		...
		/// the <c>DESCUENTO_DOCUMENTOS_DET</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "DESCUENTO_DOCUMENTOS_DET";
			DataColumn dataColumn;
	...
	} // End of DESCUENTO_DOCUMENTOS_DETCollection_Base class
}  // End of namespace
