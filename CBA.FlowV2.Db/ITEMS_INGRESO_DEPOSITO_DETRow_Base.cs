// <fileinfo name="ITEMS_INGRESO_DEPOSITO_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ITEMS_INGRESO_DEPOSITO_DETRow"/> that 
	/// represents a record in the <c>ITEMS_INGRESO_DEPOSITO_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ITEMS_INGRESO_DEPOSITO_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ITEMS_INGRESO_DEPOSITO_DETRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ITEMS_INGRESO_DEPOSITO_DETRow_Base"/> class.
		/// </summary>
		public ITEMS_INGRESO_DEPOSITO_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ITEMS_INGRESO_DEPOSITO_DETRow_Base original)
		{
	...
	} // End of ITEMS_INGRESO_DEPOSITO_DETRow_Base class
} // End of namespace
