// <fileinfo name="CONTENEDORES_OPERAC_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CONTENEDORES_OPERAC_INFO_COMPLRow"/> that 
	/// represents a record in the <c>CONTENEDORES_OPERAC_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CONTENEDORES_OPERAC_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CONTENEDORES_OPERAC_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CONTENEDORES_OPERAC_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public CONTENEDORES_OPERAC_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CONTENEDORES_OPERAC_INFO_COMPLRow_Base original)
		{
	...
	} // End of CONTENEDORES_OPERAC_INFO_COMPLRow_Base class
} // End of namespace
