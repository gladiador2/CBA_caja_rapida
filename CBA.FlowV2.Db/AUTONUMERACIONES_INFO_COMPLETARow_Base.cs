// <fileinfo name="AUTONUMERACIONES_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="AUTONUMERACIONES_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>AUTONUMERACIONES_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="AUTONUMERACIONES_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class AUTONUMERACIONES_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _tipo_autonumeracion_nombre;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AUTONUMERACIONES_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public AUTONUMERACIONES_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(AUTONUMERACIONES_INFO_COMPLETARow_Base original)
		{
			...
			if (this.TIPO_AUTONUMERACION_NOMBRE != original.TIPO_AUTONUMERACION_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>TIPO_AUTONUMERACION_NOMBRE</c> column value.
		/// </summary>
		/// <value>The <c>TIPO_AUTONUMERACION_NOMBRE</c> column value.</value>
		public string TIPO_AUTONUMERACION_NOMBRE
		{
			get { return _tipo_autonumeracion_nombre; }
			set { _tipo_autonumeracion_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@TIPO_AUTONUMERACION_NOMBRE=");
			dynStr.Append(TIPO_AUTONUMERACION_NOMBRE);
	...
	} // End of AUTONUMERACIONES_INFO_COMPLETARow_Base class
} // End of namespace
