// <fileinfo name="CTACTE_CAJA_COMPOSICION_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_CAJA_COMPOSICION_DETRow"/> that 
	/// represents a record in the <c>CTACTE_CAJA_COMPOSICION_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_CAJA_COMPOSICION_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_CAJA_COMPOSICION_DETRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_CAJA_COMPOSICION_DETRow_Base"/> class.
		/// </summary>
		public CTACTE_CAJA_COMPOSICION_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_CAJA_COMPOSICION_DETRow_Base original)
		{
	...
	} // End of CTACTE_CAJA_COMPOSICION_DETRow_Base class
} // End of namespace
