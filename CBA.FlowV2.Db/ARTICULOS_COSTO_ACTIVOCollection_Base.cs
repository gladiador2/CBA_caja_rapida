// <fileinfo name="ARTICULOS_COSTO_ACTIVOCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_COSTO_ACTIVOCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="ARTICULOS_COSTO_ACTIVOCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_COSTO_ACTIVOCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_COSTO_ACTIVOCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public ARTICULOS_COSTO_ACTIVOCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>ARTICULOS_COSTO_ACTIVO</c> view.
		/// </summary>
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		public virtual ARTICULOS_COSTO_ACTIVORow[] GetAll()
		{
		...
		/// includes all records from the <c>ARTICULOS_COSTO_ACTIVO</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>ARTICULOS_COSTO_ACTIVO</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="ARTICULOS_COSTO_ACTIVORow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public ARTICULOS_COSTO_ACTIVORow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			ARTICULOS_COSTO_ACTIVORow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects that 
		...
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		public ARTICULOS_COSTO_ACTIVORow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		public virtual ARTICULOS_COSTO_ACTIVORow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.ARTICULOS_COSTO_ACTIVO";
		...
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		protected ARTICULOS_COSTO_ACTIVORow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		protected ARTICULOS_COSTO_ACTIVORow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="ARTICULOS_COSTO_ACTIVORow"/> objects.</returns>
		protected virtual ARTICULOS_COSTO_ACTIVORow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					ARTICULOS_COSTO_ACTIVORow record = new ARTICULOS_COSTO_ACTIVORow();
			...
			return (ARTICULOS_COSTO_ACTIVORow[])(recordList.ToArray(typeof(ARTICULOS_COSTO_ACTIVORow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="ARTICULOS_COSTO_ACTIVORow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="ARTICULOS_COSTO_ACTIVORow"/> object.</returns>
		protected virtual ARTICULOS_COSTO_ACTIVORow MapRow(DataRow row)
		{
			ARTICULOS_COSTO_ACTIVORow mappedObject = new ARTICULOS_COSTO_ACTIVORow();
		...
		/// the <c>ARTICULOS_COSTO_ACTIVO</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "ARTICULOS_COSTO_ACTIVO";
			DataColumn dataColumn;
	...
	} // End of ARTICULOS_COSTO_ACTIVOCollection_Base class
}  // End of namespace
