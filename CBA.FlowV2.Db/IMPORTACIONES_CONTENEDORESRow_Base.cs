// <fileinfo name="IMPORTACIONES_CONTENEDORESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="IMPORTACIONES_CONTENEDORESRow"/> that 
	/// represents a record in the <c>IMPORTACIONES_CONTENEDORES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="IMPORTACIONES_CONTENEDORESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class IMPORTACIONES_CONTENEDORESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="IMPORTACIONES_CONTENEDORESRow_Base"/> class.
		/// </summary>
		public IMPORTACIONES_CONTENEDORESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(IMPORTACIONES_CONTENEDORESRow_Base original)
		{
	...
	} // End of IMPORTACIONES_CONTENEDORESRow_Base class
} // End of namespace
