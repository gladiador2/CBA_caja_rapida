// <fileinfo name="ESCALAS_PREMIOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ESCALAS_PREMIOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>ESCALAS_PREMIOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ESCALAS_PREMIOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ESCALAS_PREMIOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		private decimal _entidad_id;
		private decimal _tipo_escala_premio_id;
		private string _tipo_escala_premio_nombre;
		private decimal _porcentaje_limite_superior;
		private decimal _porcentaje_premio;
		private string _estado;

		/// <summary>
		/// Initializes a new instance of the <see cref="ESCALAS_PREMIOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public ESCALAS_PREMIOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ESCALAS_PREMIOS_INFO_COMPLETARow_Base original)
		{
			if (this.ID != original.ID) return true;
			if (this.ENTIDAD_ID != original.ENTIDAD_ID) return true;
			if (this.TIPO_ESCALA_PREMIO_ID != original.TIPO_ESCALA_PREMIO_ID) return true;
			if (this.TIPO_ESCALA_PREMIO_NOMBRE != original.TIPO_ESCALA_PREMIO_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>TIPO_ESCALA_PREMIO_NOMBRE</c> column value.
		/// </summary>
		/// <value>The <c>TIPO_ESCALA_PREMIO_NOMBRE</c> column value.</value>
		public string TIPO_ESCALA_PREMIO_NOMBRE
		{
			get { return _tipo_escala_premio_nombre; }
			set { _tipo_escala_premio_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@TIPO_ESCALA_PREMIO_NOMBRE=");
			dynStr.Append(TIPO_ESCALA_PREMIO_NOMBRE);
	...
	} // End of ESCALAS_PREMIOS_INFO_COMPLETARow_Base class
} // End of namespace
