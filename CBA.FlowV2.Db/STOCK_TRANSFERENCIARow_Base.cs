// <fileinfo name="STOCK_TRANSFERENCIARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSFERENCIARow"/> that 
	/// represents a record in the <c>STOCK_TRANSFERENCIA</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSFERENCIARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSFERENCIARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSFERENCIARow_Base"/> class.
		/// </summary>
		public STOCK_TRANSFERENCIARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSFERENCIARow_Base original)
		{
	...
	} // End of STOCK_TRANSFERENCIARow_Base class
} // End of namespace
