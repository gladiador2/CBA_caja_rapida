// <fileinfo name="ARTICULOS_COSTO_PONDERADORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_COSTO_PONDERADORow"/> that 
	/// represents a record in the <c>ARTICULOS_COSTO_PONDERADO</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_COSTO_PONDERADORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_COSTO_PONDERADORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_COSTO_PONDERADORow_Base"/> class.
		/// </summary>
		public ARTICULOS_COSTO_PONDERADORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_COSTO_PONDERADORow_Base original)
		{
	...
	} // End of ARTICULOS_COSTO_PONDERADORow_Base class
} // End of namespace
