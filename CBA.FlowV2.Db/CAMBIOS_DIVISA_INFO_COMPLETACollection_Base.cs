// <fileinfo name="CAMBIOS_DIVISA_INFO_COMPLETACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CAMBIOS_DIVISA_INFO_COMPLETACollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CAMBIOS_DIVISA_INFO_COMPLETACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CAMBIOS_DIVISA_INFO_COMPLETACollection_Base
	{
		// Constants
		...
		public const string CTACTE_CAJA_TESORERIA_SUC_IDColumnName = "CTACTE_CAJA_TESORERIA_SUC_ID";
		public const string CTACTE_CAJA_TESORERIA_SUC_NOMColumnName = "CTACTE_CAJA_TESORERIA_SUC_NOM";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CAMBIOS_DIVISA_INFO_COMPLETACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CAMBIOS_DIVISA_INFO_COMPLETACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CAMBIOS_DIVISA_INFO_COMPLETA</c> view.
		/// </summary>
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISA_INFO_COMPLETARow[] GetAll()
		{
		...
		/// includes all records from the <c>CAMBIOS_DIVISA_INFO_COMPLETA</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>CAMBIOS_DIVISA_INFO_COMPLETA</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CAMBIOS_DIVISA_INFO_COMPLETARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CAMBIOS_DIVISA_INFO_COMPLETARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects that 
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		public CAMBIOS_DIVISA_INFO_COMPLETARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISA_INFO_COMPLETARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CAMBIOS_DIVISA_INFO_COMPLETA";
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		protected CAMBIOS_DIVISA_INFO_COMPLETARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		protected CAMBIOS_DIVISA_INFO_COMPLETARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> objects.</returns>
		protected virtual CAMBIOS_DIVISA_INFO_COMPLETARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int ctacte_caja_tesoreria_suc_idColumnIndex = reader.GetOrdinal("CTACTE_CAJA_TESORERIA_SUC_ID");
			int ctacte_caja_tesoreria_suc_nomColumnIndex = reader.GetOrdinal("CTACTE_CAJA_TESORERIA_SUC_NOM");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CAMBIOS_DIVISA_INFO_COMPLETARow record = new CAMBIOS_DIVISA_INFO_COMPLETARow();
					...
					record.CTACTE_CAJA_TESORERIA_SUC_ID = Math.Round(Convert.ToDecimal(reader.GetValue(ctacte_caja_tesoreria_suc_idColumnIndex)), 9);
					record.CTACTE_CAJA_TESORERIA_SUC_NOM = Convert.ToString(reader.GetValue(ctacte_caja_tesoreria_suc_nomColumnIndex));
			...
			return (CAMBIOS_DIVISA_INFO_COMPLETARow[])(recordList.ToArray(typeof(CAMBIOS_DIVISA_INFO_COMPLETARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CAMBIOS_DIVISA_INFO_COMPLETARow"/> object.</returns>
		protected virtual CAMBIOS_DIVISA_INFO_COMPLETARow MapRow(DataRow row)
		{
			CAMBIOS_DIVISA_INFO_COMPLETARow mappedObject = new CAMBIOS_DIVISA_INFO_COMPLETARow();
			...
			// Column "CTACTE_CAJA_TESORERIA_SUC_ID"
			dataColumn = dataTable.Columns["CTACTE_CAJA_TESORERIA_SUC_ID"];
			if(!row.IsNull(dataColumn))
				mappedObject.CTACTE_CAJA_TESORERIA_SUC_ID = (decimal)row[dataColumn];
			// Column "CTACTE_CAJA_TESORERIA_SUC_NOM"
			dataColumn = dataTable.Columns["CTACTE_CAJA_TESORERIA_SUC_NOM"];
			if(!row.IsNull(dataColumn))
				mappedObject.CTACTE_CAJA_TESORERIA_SUC_NOM = (string)row[dataColumn];
		...
		/// the <c>CAMBIOS_DIVISA_INFO_COMPLETA</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CAMBIOS_DIVISA_INFO_COMPLETA";
			DataColumn dataColumn;
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("CTACTE_CAJA_TESORERIA_SUC_ID", typeof(decimal));
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("CTACTE_CAJA_TESORERIA_SUC_NOM", typeof(string));
			dataColumn.MaxLength = 50;
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
		...
		protected virtual IDbDataParameter AddParameter(IDbCommand cmd, string paramName, object value)
		{
			...
			switch(paramName)
			{
				...
				case "CTACTE_CAJA_TESORERIA_SUC_ID":
					parameter = _db.AddParameter(cmd, paramName, DbType.Decimal, value);
					break;

				case "CTACTE_CAJA_TESORERIA_SUC_NOM":
					parameter = _db.AddParameter(cmd, paramName, DbType.AnsiString, value);
					break;
	...
	} // End of CAMBIOS_DIVISA_INFO_COMPLETACollection_Base class
}  // End of namespace
