// <fileinfo name="TMP_FACTURA_PROVEEDORRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TMP_FACTURA_PROVEEDORRow"/> that 
	/// represents a record in the <c>TMP_FACTURA_PROVEEDOR</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="TMP_FACTURA_PROVEEDORRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TMP_FACTURA_PROVEEDORRow_Base
	{
		private string _ruc;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TMP_FACTURA_PROVEEDORRow_Base"/> class.
		/// </summary>
		public TMP_FACTURA_PROVEEDORRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(TMP_FACTURA_PROVEEDORRow_Base original)
		{
	...
	} // End of TMP_FACTURA_PROVEEDORRow_Base class
} // End of namespace
