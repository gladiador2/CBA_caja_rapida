// <fileinfo name="EGRESOS_VARIOS_CAJA_VALRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EGRESOS_VARIOS_CAJA_VALRow"/> that 
	/// represents a record in the <c>EGRESOS_VARIOS_CAJA_VAL</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EGRESOS_VARIOS_CAJA_VALRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EGRESOS_VARIOS_CAJA_VALRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EGRESOS_VARIOS_CAJA_VALRow_Base"/> class.
		/// </summary>
		public EGRESOS_VARIOS_CAJA_VALRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EGRESOS_VARIOS_CAJA_VALRow_Base original)
		{
	...
	} // End of EGRESOS_VARIOS_CAJA_VALRow_Base class
} // End of namespace
