// <fileinfo name="CTB_INDICADORES_DETALLERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTB_INDICADORES_DETALLERow"/> that 
	/// represents a record in the <c>CTB_INDICADORES_DETALLE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTB_INDICADORES_DETALLERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTB_INDICADORES_DETALLERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTB_INDICADORES_DETALLERow_Base"/> class.
		/// </summary>
		public CTB_INDICADORES_DETALLERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTB_INDICADORES_DETALLERow_Base original)
		{
	...
	} // End of CTB_INDICADORES_DETALLERow_Base class
} // End of namespace
