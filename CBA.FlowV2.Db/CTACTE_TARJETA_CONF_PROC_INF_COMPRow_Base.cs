// <fileinfo name="CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_TARJETA_CONF_PROC_INF_COMPRow"/> that 
	/// represents a record in the <c>CTACTE_TARJETA_CONF_PROC_INF_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_TARJETA_CONF_PROC_INF_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base
	{
		private decimal _id;
		...
		private string _procesadora_nombre;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base"/> class.
		/// </summary>
		public CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base original)
		{
			...
			if (this.PROCESADORA_NOMBRE != original.PROCESADORA_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>PROCESADORA_NOMBRE</c> column value.
		/// </summary>
		/// <value>The <c>PROCESADORA_NOMBRE</c> column value.</value>
		public string PROCESADORA_NOMBRE
		{
			get { return _procesadora_nombre; }
			set { _procesadora_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@PROCESADORA_NOMBRE=");
			dynStr.Append(PROCESADORA_NOMBRE);
			return dynStr.ToString();
		}
	} // End of CTACTE_TARJETA_CONF_PROC_INF_COMPRow_Base class
} // End of namespace
