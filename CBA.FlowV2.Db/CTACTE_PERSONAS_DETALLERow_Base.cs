// <fileinfo name="CTACTE_PERSONAS_DETALLERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_PERSONAS_DETALLERow"/> that 
	/// represents a record in the <c>CTACTE_PERSONAS_DETALLE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_PERSONAS_DETALLERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_PERSONAS_DETALLERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_PERSONAS_DETALLERow_Base"/> class.
		/// </summary>
		public CTACTE_PERSONAS_DETALLERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_PERSONAS_DETALLERow_Base original)
		{
	...
	} // End of CTACTE_PERSONAS_DETALLERow_Base class
} // End of namespace
