// <fileinfo name="ACTIVOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ACTIVOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>ACTIVOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ACTIVOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ACTIVOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		private decimal _inmueble_id;
		private bool _inmueble_idNull = true;
		private string _inmueble_nombre;
		...
		private string _codigo_descripcion;
		...
		private string _activo_rubro_descripcion;
		private decimal _activo_rubro_vida_util_anhos;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ACTIVOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public ACTIVOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ACTIVOS_INFO_COMPLETARow_Base original)
		{
			...
			if (this.INMUEBLE_NOMBRE != original.INMUEBLE_NOMBRE) return true;
			...
			if (this.CODIGO_DESCRIPCION != original.CODIGO_DESCRIPCION) return true;
			...
			if (this.ACTIVO_RUBRO_DESCRIPCION != original.ACTIVO_RUBRO_DESCRIPCION) return true;
			if (this.ACTIVO_RUBRO_VIDA_UTIL_ANHOS != original.ACTIVO_RUBRO_VIDA_UTIL_ANHOS) return true;
		...
		/// <summary>
		/// Gets or sets the <c>INMUEBLE_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>INMUEBLE_NOMBRE</c> column value.</value>
		public string INMUEBLE_NOMBRE
		{
			get { return _inmueble_nombre; }
			set { _inmueble_nombre = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>CODIGO_DESCRIPCION</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CODIGO_DESCRIPCION</c> column value.</value>
		public string CODIGO_DESCRIPCION
		{
			get { return _codigo_descripcion; }
			set { _codigo_descripcion = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>ACTIVO_RUBRO_DESCRIPCION</c> column value.
		/// </summary>
		/// <value>The <c>ACTIVO_RUBRO_DESCRIPCION</c> column value.</value>
		public string ACTIVO_RUBRO_DESCRIPCION
		{
			get { return _activo_rubro_descripcion; }
			set { _activo_rubro_descripcion = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>ACTIVO_RUBRO_VIDA_UTIL_ANHOS</c> column value.
		/// </summary>
		/// <value>The <c>ACTIVO_RUBRO_VIDA_UTIL_ANHOS</c> column value.</value>
		public decimal ACTIVO_RUBRO_VIDA_UTIL_ANHOS
		{
			get { return _activo_rubro_vida_util_anhos; }
			set { _activo_rubro_vida_util_anhos = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@INMUEBLE_NOMBRE=");
			dynStr.Append(INMUEBLE_NOMBRE);
			...
			dynStr.Append("@CBA@CODIGO_DESCRIPCION=");
			dynStr.Append(CODIGO_DESCRIPCION);
			...
			dynStr.Append("@CBA@ACTIVO_RUBRO_DESCRIPCION=");
			dynStr.Append(ACTIVO_RUBRO_DESCRIPCION);
			dynStr.Append("@CBA@ACTIVO_RUBRO_VIDA_UTIL_ANHOS=");
			dynStr.Append(ACTIVO_RUBRO_VIDA_UTIL_ANHOS);
	...
	} // End of ACTIVOS_INFO_COMPLETARow_Base class
} // End of namespace
