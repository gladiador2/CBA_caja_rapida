// <fileinfo name="PUERTAS_MOVIMIENTOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PUERTAS_MOVIMIENTOSRow"/> that 
	/// represents a record in the <c>PUERTAS_MOVIMIENTOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PUERTAS_MOVIMIENTOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PUERTAS_MOVIMIENTOSRow_Base
	{
		private decimal _id;
		...
		private string _cliente_externo;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PUERTAS_MOVIMIENTOSRow_Base"/> class.
		/// </summary>
		public PUERTAS_MOVIMIENTOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PUERTAS_MOVIMIENTOSRow_Base original)
		{
			...
			if (this.CLIENTE_EXTERNO != original.CLIENTE_EXTERNO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>CLIENTE_EXTERNO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CLIENTE_EXTERNO</c> column value.</value>
		public string CLIENTE_EXTERNO
		{
			get { return _cliente_externo; }
			set { _cliente_externo = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CLIENTE_EXTERNO=");
			dynStr.Append(CLIENTE_EXTERNO);
	...
	} // End of PUERTAS_MOVIMIENTOSRow_Base class
} // End of namespace
