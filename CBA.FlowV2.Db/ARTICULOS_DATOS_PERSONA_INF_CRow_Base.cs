// <fileinfo name="ARTICULOS_DATOS_PERSONA_INF_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_DATOS_PERSONA_INF_CRow"/> that 
	/// represents a record in the <c>ARTICULOS_DATOS_PERSONA_INF_C</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_DATOS_PERSONA_INF_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_DATOS_PERSONA_INF_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_DATOS_PERSONA_INF_CRow_Base"/> class.
		/// </summary>
		public ARTICULOS_DATOS_PERSONA_INF_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_DATOS_PERSONA_INF_CRow_Base original)
		{
	...
	} // End of ARTICULOS_DATOS_PERSONA_INF_CRow_Base class
} // End of namespace
