// <fileinfo name="STOCK_ART_RESERVA_POR_EGRPROMACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_ART_RESERVA_POR_EGRPROMACollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="STOCK_ART_RESERVA_POR_EGRPROMACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_ART_RESERVA_POR_EGRPROMACollection_Base
	{
		// Constants
		...
		public const string CODIGO_PERSONAColumnName = "CODIGO_PERSONA";

		// Instance fields
		private CBAV2 _db;

		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_ART_RESERVA_POR_EGRPROMACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public STOCK_ART_RESERVA_POR_EGRPROMACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>STOCK_ART_RESERVA_POR_EGRPROMA</c> view.
		/// </summary>
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		public virtual STOCK_ART_RESERVA_POR_EGRPROMARow[] GetAll()
		{
		...
		/// includes all records from the <c>STOCK_ART_RESERVA_POR_EGRPROMA</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>STOCK_ART_RESERVA_POR_EGRPROMA</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public STOCK_ART_RESERVA_POR_EGRPROMARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			STOCK_ART_RESERVA_POR_EGRPROMARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects that 
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		public STOCK_ART_RESERVA_POR_EGRPROMARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		public virtual STOCK_ART_RESERVA_POR_EGRPROMARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.STOCK_ART_RESERVA_POR_EGRPROMA";
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		protected STOCK_ART_RESERVA_POR_EGRPROMARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		protected STOCK_ART_RESERVA_POR_EGRPROMARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> objects.</returns>
		protected virtual STOCK_ART_RESERVA_POR_EGRPROMARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int codigo_personaColumnIndex = reader.GetOrdinal("CODIGO_PERSONA");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					STOCK_ART_RESERVA_POR_EGRPROMARow record = new STOCK_ART_RESERVA_POR_EGRPROMARow();
					...
					if(!reader.IsDBNull(codigo_personaColumnIndex))
						record.CODIGO_PERSONA = Convert.ToString(reader.GetValue(codigo_personaColumnIndex));
			...
			return (STOCK_ART_RESERVA_POR_EGRPROMARow[])(recordList.ToArray(typeof(STOCK_ART_RESERVA_POR_EGRPROMARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="STOCK_ART_RESERVA_POR_EGRPROMARow"/> object.</returns>
		protected virtual STOCK_ART_RESERVA_POR_EGRPROMARow MapRow(DataRow row)
		{
			STOCK_ART_RESERVA_POR_EGRPROMARow mappedObject = new STOCK_ART_RESERVA_POR_EGRPROMARow();
			...
			dataColumn = dataTable.Columns["CODIGO_PERSONA"];
			if(!row.IsNull(dataColumn))
				mappedObject.CODIGO_PERSONA = (string)row[dataColumn];
			return mappedObject;
		}

		/// <summary>
		/// Creates a <see cref="System.Data.DataTable"/> object for 
		/// the <c>STOCK_ART_RESERVA_POR_EGRPROMA</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "STOCK_ART_RESERVA_POR_EGRPROMA";
			DataColumn dataColumn;
			...
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("CODIGO_PERSONA", typeof(string));
	...
	} // End of STOCK_ART_RESERVA_POR_EGRPROMACollection_Base class
}  // End of namespace
