// <fileinfo name="STOCK_CRITICO_POLITICASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_CRITICO_POLITICASRow"/> that 
	/// represents a record in the <c>STOCK_CRITICO_POLITICAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_CRITICO_POLITICASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_CRITICO_POLITICASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_CRITICO_POLITICASRow_Base"/> class.
		/// </summary>
		public STOCK_CRITICO_POLITICASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_CRITICO_POLITICASRow_Base original)
		{
	...
	} // End of STOCK_CRITICO_POLITICASRow_Base class
} // End of namespace
