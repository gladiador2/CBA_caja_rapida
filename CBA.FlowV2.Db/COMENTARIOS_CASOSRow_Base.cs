// <fileinfo name="COMENTARIOS_CASOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="COMENTARIOS_CASOSRow"/> that 
	/// represents a record in the <c>COMENTARIOS_CASOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="COMENTARIOS_CASOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class COMENTARIOS_CASOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="COMENTARIOS_CASOSRow_Base"/> class.
		/// </summary>
		public COMENTARIOS_CASOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(COMENTARIOS_CASOSRow_Base original)
		{
	...
	} // End of COMENTARIOS_CASOSRow_Base class
} // End of namespace
