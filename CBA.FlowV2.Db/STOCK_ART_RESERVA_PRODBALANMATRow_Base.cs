// <fileinfo name="STOCK_ART_RESERVA_PRODBALANMATRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_ART_RESERVA_PRODBALANMATRow"/> that 
	/// represents a record in the <c>STOCK_ART_RESERVA_PRODBALANMAT</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_ART_RESERVA_PRODBALANMATRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_ART_RESERVA_PRODBALANMATRow_Base
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_ART_RESERVA_PRODBALANMATRow_Base"/> class.
		/// </summary>
		public STOCK_ART_RESERVA_PRODBALANMATRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_ART_RESERVA_PRODBALANMATRow_Base original)
		{
	...
	} // End of STOCK_ART_RESERVA_PRODBALANMATRow_Base class
} // End of namespace
