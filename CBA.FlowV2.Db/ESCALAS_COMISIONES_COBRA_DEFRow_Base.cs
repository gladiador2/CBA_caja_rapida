// <fileinfo name="ESCALAS_COMISIONES_COBRA_DEFRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ESCALAS_COMISIONES_COBRA_DEFRow"/> that 
	/// represents a record in the <c>ESCALAS_COMISIONES_COBRA_DEF</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ESCALAS_COMISIONES_COBRA_DEFRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ESCALAS_COMISIONES_COBRA_DEFRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ESCALAS_COMISIONES_COBRA_DEFRow_Base"/> class.
		/// </summary>
		public ESCALAS_COMISIONES_COBRA_DEFRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ESCALAS_COMISIONES_COBRA_DEFRow_Base original)
		{
	...
	} // End of ESCALAS_COMISIONES_COBRA_DEFRow_Base class
} // End of namespace
