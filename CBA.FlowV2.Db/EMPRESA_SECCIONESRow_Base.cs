// <fileinfo name="EMPRESA_SECCIONESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EMPRESA_SECCIONESRow"/> that 
	/// represents a record in the <c>EMPRESA_SECCIONES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EMPRESA_SECCIONESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EMPRESA_SECCIONESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EMPRESA_SECCIONESRow_Base"/> class.
		/// </summary>
		public EMPRESA_SECCIONESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EMPRESA_SECCIONESRow_Base original)
		{
	...
	} // End of EMPRESA_SECCIONESRow_Base class
} // End of namespace
