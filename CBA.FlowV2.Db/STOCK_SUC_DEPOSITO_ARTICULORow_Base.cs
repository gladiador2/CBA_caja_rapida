// <fileinfo name="STOCK_SUC_DEPOSITO_ARTICULORow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_SUC_DEPOSITO_ARTICULORow"/> that 
	/// represents a record in the <c>STOCK_SUC_DEPOSITO_ARTICULO</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_SUC_DEPOSITO_ARTICULORow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_SUC_DEPOSITO_ARTICULORow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_SUC_DEPOSITO_ARTICULORow_Base"/> class.
		/// </summary>
		public STOCK_SUC_DEPOSITO_ARTICULORow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_SUC_DEPOSITO_ARTICULORow_Base original)
		{
	...
	} // End of STOCK_SUC_DEPOSITO_ARTICULORow_Base class
} // End of namespace
