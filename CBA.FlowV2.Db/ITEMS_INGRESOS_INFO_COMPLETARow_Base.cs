// <fileinfo name="ITEMS_INGRESOS_INFO_COMPLETARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ITEMS_INGRESOS_INFO_COMPLETARow"/> that 
	/// represents a record in the <c>ITEMS_INGRESOS_INFO_COMPLETA</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ITEMS_INGRESOS_INFO_COMPLETARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ITEMS_INGRESOS_INFO_COMPLETARow_Base
	{
		private decimal _id;
		...
		private string _trasportadora_persona_codigo;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ITEMS_INGRESOS_INFO_COMPLETARow_Base"/> class.
		/// </summary>
		public ITEMS_INGRESOS_INFO_COMPLETARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ITEMS_INGRESOS_INFO_COMPLETARow_Base original)
		{
			...
			if (this.TRASPORTADORA_PERSONA_CODIGO != original.TRASPORTADORA_PERSONA_CODIGO) return true;
		...
		/// <summary>
		/// Gets or sets the <c>TRASPORTADORA_PERSONA_CODIGO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>TRASPORTADORA_PERSONA_CODIGO</c> column value.</value>
		public string TRASPORTADORA_PERSONA_CODIGO
		{
			get { return _trasportadora_persona_codigo; }
			set { _trasportadora_persona_codigo = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@TRASPORTADORA_PERSONA_CODIGO=");
			dynStr.Append(TRASPORTADORA_PERSONA_CODIGO);
	...
	} // End of ITEMS_INGRESOS_INFO_COMPLETARow_Base class
} // End of namespace
