// <fileinfo name="CAMBIOS_DIVISACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CAMBIOS_DIVISACollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CAMBIOS_DIVISACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CAMBIOS_DIVISACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CAMBIOS_DIVISACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CAMBIOS_DIVISACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetAll()
		{
		...
		/// includes all records from the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CAMBIOS_DIVISARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CAMBIOS_DIVISARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CAMBIOS_DIVISARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CAMBIOS_DIVISARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects that 
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public CAMBIOS_DIVISARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CAMBIOS_DIVISA";
		...
		/// <summary>
		/// Gets <see cref="CAMBIOS_DIVISARow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="CAMBIOS_DIVISARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual CAMBIOS_DIVISARow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			CAMBIOS_DIVISARow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects 
		/// by the <c>FK_CAMBIOS_DIVISA</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// return records by the <c>FK_CAMBIOS_DIVISA</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects 
		/// by the <c>FK_CAMBIOS_DIVISA_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public CAMBIOS_DIVISARow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CAMBIOS_DIVISA_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects 
		/// by the <c>FK_CAMBIOS_DIVISA_CAJA_TESO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetByCTACTE_CAJA_TESORERIA_ID(decimal ctacte_caja_tesoreria_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CAMBIOS_DIVISA_CAJA_TESO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects 
		/// by the <c>FK_CAMBIOS_DIVISA_FUNCIONARIO</c> foreign key.
		/// </summary>
		/// <param name="funcionario_id">The <c>FUNCIONARIO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetByFUNCIONARIO_ID(decimal funcionario_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CAMBIOS_DIVISA_FUNCIONARIO</c> foreign key.
		/// </summary>
		/// <param name="funcionario_id">The <c>FUNCIONARIO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CAMBIOS_DIVISARow"/> objects 
		/// by the <c>FK_CAMBIOS_DIVISA_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		public virtual CAMBIOS_DIVISARow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CAMBIOS_DIVISA_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CAMBIOS_DIVISARow"/> object to be inserted.</param>
		public virtual void Insert(CAMBIOS_DIVISARow value)
		{
						
			string sqlStr = "INSERT INTO TRC.CAMBIOS_DIVISA (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
			...
			AddParameter(cmd, "TOTAL_DOLARIZADO", value.TOTAL_DOLARIZADO);
		...
		/// <summary>
		/// Updates a record in the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CAMBIOS_DIVISARow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(CAMBIOS_DIVISARow value)
		{
			
			string sqlStr = "UPDATE TRC.CAMBIOS_DIVISA SET " +
		...
		/// <summary>
		/// Updates the <c>CAMBIOS_DIVISA</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>CAMBIOS_DIVISA</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CAMBIOS_DIVISARow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(CAMBIOS_DIVISARow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>CAMBIOS_DIVISA</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>CAMBIOS_DIVISA</c> table using the 
		/// <c>FK_CAMBIOS_DIVISA</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CAMBIOS_DIVISA</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CAMBIOS_DIVISA</c> table using the 
		/// <c>FK_CAMBIOS_DIVISA_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CAMBIOS_DIVISA_AUTONUM</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CAMBIOS_DIVISA</c> table using the 
		/// <c>FK_CAMBIOS_DIVISA_CAJA_TESO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CAMBIOS_DIVISA_CAJA_TESO</c> foreign key.
		/// </summary>
		/// <param name="ctacte_caja_tesoreria_id">The <c>CTACTE_CAJA_TESORERIA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CAMBIOS_DIVISA</c> table using the 
		/// <c>FK_CAMBIOS_DIVISA_FUNCIONARIO</c> foreign key.
		/// </summary>
		/// <param name="funcionario_id">The <c>FUNCIONARIO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CAMBIOS_DIVISA_FUNCIONARIO</c> foreign key.
		/// </summary>
		/// <param name="funcionario_id">The <c>FUNCIONARIO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CAMBIOS_DIVISA</c> table using the 
		/// <c>FK_CAMBIOS_DIVISA_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CAMBIOS_DIVISA_SUCURSAL</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>CAMBIOS_DIVISA</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>CAMBIOS_DIVISA</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.CAMBIOS_DIVISA";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		protected CAMBIOS_DIVISARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		protected CAMBIOS_DIVISARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CAMBIOS_DIVISARow"/> objects.</returns>
		protected virtual CAMBIOS_DIVISARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CAMBIOS_DIVISARow record = new CAMBIOS_DIVISARow();
			...
			return (CAMBIOS_DIVISARow[])(recordList.ToArray(typeof(CAMBIOS_DIVISARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CAMBIOS_DIVISARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CAMBIOS_DIVISARow"/> object.</returns>
		protected virtual CAMBIOS_DIVISARow MapRow(DataRow row)
		{
			CAMBIOS_DIVISARow mappedObject = new CAMBIOS_DIVISARow();
		...
		/// the <c>CAMBIOS_DIVISA</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CAMBIOS_DIVISA";
			DataColumn dataColumn;
	...
	} // End of CAMBIOS_DIVISACollection_Base class
}  // End of namespace
