// <fileinfo name="EQUIPOS_AUTORIZADOS_DETALLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EQUIPOS_AUTORIZADOS_DETALLESRow"/> that 
	/// represents a record in the <c>EQUIPOS_AUTORIZADOS_DETALLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="EQUIPOS_AUTORIZADOS_DETALLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EQUIPOS_AUTORIZADOS_DETALLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EQUIPOS_AUTORIZADOS_DETALLESRow_Base"/> class.
		/// </summary>
		public EQUIPOS_AUTORIZADOS_DETALLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(EQUIPOS_AUTORIZADOS_DETALLESRow_Base original)
		{
	...
	} // End of EQUIPOS_AUTORIZADOS_DETALLESRow_Base class
} // End of namespace
