// <fileinfo name="CASOS_ASIGNACIONESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CASOS_ASIGNACIONESRow"/> that 
	/// represents a record in the <c>CASOS_ASIGNACIONES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CASOS_ASIGNACIONESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CASOS_ASIGNACIONESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CASOS_ASIGNACIONESRow_Base"/> class.
		/// </summary>
		public CASOS_ASIGNACIONESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CASOS_ASIGNACIONESRow_Base original)
		{
	...
	} // End of CASOS_ASIGNACIONESRow_Base class
} // End of namespace
