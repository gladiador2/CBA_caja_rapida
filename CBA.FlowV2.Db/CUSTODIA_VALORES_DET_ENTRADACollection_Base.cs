// <fileinfo name="CUSTODIA_VALORES_DET_ENTRADACollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CUSTODIA_VALORES_DET_ENTRADACollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="CUSTODIA_VALORES_DET_ENTRADACollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CUSTODIA_VALORES_DET_ENTRADACollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CUSTODIA_VALORES_DET_ENTRADACollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public CUSTODIA_VALORES_DET_ENTRADACollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetAll()
		{
		...
		/// includes all records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public CUSTODIA_VALORES_DET_ENTRADARow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			CUSTODIA_VALORES_DET_ENTRADARow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects that 
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public CUSTODIA_VALORES_DET_ENTRADARow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.CUSTODIA_VALORES_DET_ENTRADA";
		...
		/// <summary>
		/// Gets <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			CUSTODIA_VALORES_DET_ENTRADARow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_CHEQ</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public CUSTODIA_VALORES_DET_ENTRADARow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id)
		{
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByCTACTE_CHEQUE_RECIBIDO_ID(decimal ctacte_cheque_recibido_id, bool ctacte_cheque_recibido_idNull)
		{
		...
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_CHEQ</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_CUS</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_id">The <c>CUSTODIA_VALOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByCUSTODIA_VALOR_ID(decimal custodia_valor_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_CUS</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_id">The <c>CUSTODIA_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_CUS_D</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_det_id">The <c>CUSTODIA_VALOR_DET_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public CUSTODIA_VALORES_DET_ENTRADARow[] GetByCUSTODIA_VALOR_DET_ID(decimal custodia_valor_det_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByCUSTODIA_VALOR_DET_ID(decimal custodia_valor_det_id, bool custodia_valor_det_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_CUS_D</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_det_id">The <c>CUSTODIA_VALOR_DET_ID</c> column value.</param>
		/// <param name="custodia_valor_det_idNull">true if the method ignores the custodia_valor_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_PAGAR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public CUSTODIA_VALORES_DET_ENTRADARow[] GetByCTACTE_PAGARE_DET_ID(decimal ctacte_pagare_det_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByCTACTE_PAGARE_DET_ID(decimal ctacte_pagare_det_id, bool ctacte_pagare_det_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_PAGAR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <param name="ctacte_pagare_det_idNull">true if the method ignores the ctacte_pagare_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects 
		/// by the <c>FK_CUSTODIA_VAL_DET_ENT_VALOR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		public virtual CUSTODIA_VALORES_DET_ENTRADARow[] GetByCTACTE_VALOR_ID(decimal ctacte_valor_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_CUSTODIA_VAL_DET_ENT_VALOR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> object to be inserted.</param>
		public virtual void Insert(CUSTODIA_VALORES_DET_ENTRADARow value)
		{
						
			string sqlStr = "INSERT INTO TRC.CUSTODIA_VALORES_DET_ENTRADA (" +
				"ID, " +
				"CUSTODIA_VALOR_ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(CUSTODIA_VALORES_DET_ENTRADARow value)
		{
			
			string sqlStr = "UPDATE TRC.CUSTODIA_VALORES_DET_ENTRADA SET " +
		...
		/// <summary>
		/// Updates the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <param name="value">The <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(CUSTODIA_VALORES_DET_ENTRADARow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_CHEQ</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_CHEQ</c> foreign key.
		/// </summary>
		/// <param name="ctacte_cheque_recibido_id">The <c>CTACTE_CHEQUE_RECIBIDO_ID</c> column value.</param>
		/// <param name="ctacte_cheque_recibido_idNull">true if the method ignores the ctacte_cheque_recibido_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_CUS</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_id">The <c>CUSTODIA_VALOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_CUS</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_id">The <c>CUSTODIA_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_CUS_D</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_det_id">The <c>CUSTODIA_VALOR_DET_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_CUS_D</c> foreign key.
		/// </summary>
		/// <param name="custodia_valor_det_id">The <c>CUSTODIA_VALOR_DET_ID</c> column value.</param>
		/// <param name="custodia_valor_det_idNull">true if the method ignores the custodia_valor_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_MON</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_PAGAR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_PAGAR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_pagare_det_id">The <c>CTACTE_PAGARE_DET_ID</c> column value.</param>
		/// <param name="ctacte_pagare_det_idNull">true if the method ignores the ctacte_pagare_det_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table using the 
		/// <c>FK_CUSTODIA_VAL_DET_ENT_VALOR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_CUSTODIA_VAL_DET_ENT_VALOR</c> foreign key.
		/// </summary>
		/// <param name="ctacte_valor_id">The <c>CTACTE_VALOR_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>CUSTODIA_VALORES_DET_ENTRADA</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>CUSTODIA_VALORES_DET_ENTRADA</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.CUSTODIA_VALORES_DET_ENTRADA";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		protected CUSTODIA_VALORES_DET_ENTRADARow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		protected CUSTODIA_VALORES_DET_ENTRADARow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> objects.</returns>
		protected virtual CUSTODIA_VALORES_DET_ENTRADARow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					CUSTODIA_VALORES_DET_ENTRADARow record = new CUSTODIA_VALORES_DET_ENTRADARow();
			...
			return (CUSTODIA_VALORES_DET_ENTRADARow[])(recordList.ToArray(typeof(CUSTODIA_VALORES_DET_ENTRADARow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="CUSTODIA_VALORES_DET_ENTRADARow"/> object.</returns>
		protected virtual CUSTODIA_VALORES_DET_ENTRADARow MapRow(DataRow row)
		{
			CUSTODIA_VALORES_DET_ENTRADARow mappedObject = new CUSTODIA_VALORES_DET_ENTRADARow();
		...
		/// the <c>CUSTODIA_VALORES_DET_ENTRADA</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "CUSTODIA_VALORES_DET_ENTRADA";
			DataColumn dataColumn;
	...
	} // End of CUSTODIA_VALORES_DET_ENTRADACollection_Base class
}  // End of namespace
