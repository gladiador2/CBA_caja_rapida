// <fileinfo name="STOCK_TRANSFERENCIA_INSUMOS_DETCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSFERENCIA_INSUMOS_DETCollection_Base
	{
		// Constants
		public const string IDColumnName = "ID";
		public const string TRANSFERENCIA_INSUMOS_IDColumnName = "TRANSFERENCIA_INSUMOS_ID";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public STOCK_TRANSFERENCIA_INSUMOS_DETCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetAll()
		{
		...
		/// includes all records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			STOCK_TRANSFERENCIA_INSUMOS_DETRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects that 
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.STOCK_TRANSFERENCIA_INSUMOS_DET";
		...
		/// <summary>
		/// Gets <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			STOCK_TRANSFERENCIA_INSUMOS_DETRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByCASO_ID(decimal caso_id, bool caso_idNull)
		{
		...
		/// return records by the <c>FK_STK_TRANF_INS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <param name="caso_idNull">true if the method ignores the caso_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByDEPOSITO_DESTINO_ID(decimal deposito_destino_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByDEPOSITO_DESTINO_ID(decimal deposito_destino_id, bool deposito_destino_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <param name="deposito_destino_idNull">true if the method ignores the deposito_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_ARTICULO</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByARTICULO_ID(decimal articulo_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByARTICULO_ID(decimal articulo_id, bool articulo_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_ARTICULO</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_COSTO_ID</c> foreign key.
		/// </summary>
		/// <param name="costos_id">The <c>COSTOS_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByCOSTOS_ID(decimal costos_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByCOSTOS_ID(decimal costos_id, bool costos_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_COSTO_ID</c> foreign key.
		/// </summary>
		/// <param name="costos_id">The <c>COSTOS_ID</c> column value.</param>
		/// <param name="costos_idNull">true if the method ignores the costos_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_LOTE</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByLOTE_ID(decimal lote_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByLOTE_ID(decimal lote_id, bool lote_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_LOTE</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_PROVEEDOR</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByPROVEEDOR_ID(decimal proveedor_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByPROVEEDOR_ID(decimal proveedor_id, bool proveedor_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_PROVEEDOR</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_TRANSF</c> foreign key.
		/// </summary>
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByTRANSFERENCIA_INSUMOS_ID(decimal transferencia_insumos_id)
		{
			return GetByTRANSFERENCIA_INSUMOS_ID(transferencia_insumos_id, false);
		}
		...
		/// </summary>
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <param name="transferencia_insumos_idNull">true if the method ignores the transferencia_insumos_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByTRANSFERENCIA_INSUMOS_ID(decimal transferencia_insumos_id, bool transferencia_insumos_idNull)
		{
			return MapRecords(CreateGetByTRANSFERENCIA_INSUMOS_IDCommand(transferencia_insumos_id, transferencia_insumos_idNull));
		}
		...
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public DataTable GetByTRANSFERENCIA_INSUMOS_IDAsDataTable(decimal transferencia_insumos_id)
		{
			return GetByTRANSFERENCIA_INSUMOS_IDAsDataTable(transferencia_insumos_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		public virtual DataTable GetByTRANSFERENCIA_INSUMOS_IDAsDataTable(decimal transferencia_insumos_id, bool transferencia_insumos_idNull)
		{
			return MapRecordsToDataTable(CreateGetByTRANSFERENCIA_INSUMOS_IDCommand(transferencia_insumos_id, transferencia_insumos_idNull));
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_TRANSF</c> foreign key.
		/// </summary>
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <param name="transferencia_insumos_idNull">true if the method ignores the transferencia_insumos_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateGetByTRANSFERENCIA_INSUMOS_IDCommand(decimal transferencia_insumos_id, bool transferencia_insumos_idNull)
		{
			string whereSql = "";
			if(transferencia_insumos_idNull)
				whereSql += "TRANSFERENCIA_INSUMOS_ID IS NULL";
			else
				whereSql += "TRANSFERENCIA_INSUMOS_ID=" + _db.CreateSqlParameterName("TRANSFERENCIA_INSUMOS_ID");

			IDbCommand cmd = CreateGetCommand(whereSql, null);
			if(!transferencia_insumos_idNull)
				AddParameter(cmd, "TRANSFERENCIA_INSUMOS_ID", transferencia_insumos_id);
			return cmd;
		}

		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_UNID_DEST</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_destino_id">The <c>UNIDAD_MEDIDA_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByUNIDAD_MEDIDA_DESTINO_ID(string unidad_medida_destino_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_UNID_DEST</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_destino_id">The <c>UNIDAD_MEDIDA_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_DET_UNID_ORIG</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_origen_id">The <c>UNIDAD_MEDIDA_ORIGEN_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetByUNIDAD_MEDIDA_ORIGEN_ID(string unidad_medida_origen_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_DET_UNID_ORIG</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_origen_id">The <c>UNIDAD_MEDIDA_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects 
		/// by the <c>FK_STK_TRANF_INS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetBySUCURSAL_DESTINO_ID(decimal sucursal_destino_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		public virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] GetBySUCURSAL_DESTINO_ID(decimal sucursal_destino_id, bool sucursal_destino_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_STK_TRANF_INS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <param name="sucursal_destino_idNull">true if the method ignores the sucursal_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Adds a new record into the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> object to be inserted.</param>
		public virtual void Insert(STOCK_TRANSFERENCIA_INSUMOS_DETRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.STOCK_TRANSFERENCIA_INSUMOS_DET (" +
				"ID, " +
				"TRANSFERENCIA_INSUMOS_ID, " +
				"ARTICULO_ID, " +
				"LOTE_ID, " +
				...
				_db.CreateSqlParameterName("TRANSFERENCIA_INSUMOS_ID") + ", " +
			...
			AddParameter(cmd, "TRANSFERENCIA_INSUMOS_ID",
				value.IsTRANSFERENCIA_INSUMOS_IDNull ? DBNull.Value : (object)value.TRANSFERENCIA_INSUMOS_ID);
		...
		/// <summary>
		/// Updates a record in the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(STOCK_TRANSFERENCIA_INSUMOS_DETRow value)
		{
			
			string sqlStr = "UPDATE TRC.STOCK_TRANSFERENCIA_INSUMOS_DET SET " +
				"TRANSFERENCIA_INSUMOS_ID=" + _db.CreateSqlParameterName("TRANSFERENCIA_INSUMOS_ID") + ", " +
		...
		/// <summary>
		/// Updates the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <param name="value">The <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(STOCK_TRANSFERENCIA_INSUMOS_DETRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <param name="caso_idNull">true if the method ignores the caso_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DEPO_DEST</c> foreign key.
		/// </summary>
		/// <param name="deposito_destino_id">The <c>DEPOSITO_DESTINO_ID</c> column value.</param>
		/// <param name="deposito_destino_idNull">true if the method ignores the deposito_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_ARTICULO</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_ARTICULO</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_COSTO_ID</c> foreign key.
		/// </summary>
		/// <param name="costos_id">The <c>COSTOS_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_COSTO_ID</c> foreign key.
		/// </summary>
		/// <param name="costos_id">The <c>COSTOS_ID</c> column value.</param>
		/// <param name="costos_idNull">true if the method ignores the costos_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_LOTE</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_LOTE</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_PROVEEDOR</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_PROVEEDOR</c> foreign key.
		/// </summary>
		/// <param name="proveedor_id">The <c>PROVEEDOR_ID</c> column value.</param>
		/// <param name="proveedor_idNull">true if the method ignores the proveedor_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_TRANSF</c> foreign key.
		/// </summary>
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTRANSFERENCIA_INSUMOS_ID(decimal transferencia_insumos_id)
		{
			return DeleteByTRANSFERENCIA_INSUMOS_ID(transferencia_insumos_id, false);
		}
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>The number of records deleted from the table.</returns>
		public int DeleteByTRANSFERENCIA_INSUMOS_ID(decimal transferencia_insumos_id, bool transferencia_insumos_idNull)
		{
			return CreateDeleteByTRANSFERENCIA_INSUMOS_IDCommand(transferencia_insumos_id, transferencia_insumos_idNull).ExecuteNonQuery();
		}

		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_TRANSF</c> foreign key.
		/// </summary>
		/// <param name="transferencia_insumos_id">The <c>TRANSFERENCIA_INSUMOS_ID</c> column value.</param>
		/// <param name="transferencia_insumos_idNull">true if the method ignores the transferencia_insumos_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteByTRANSFERENCIA_INSUMOS_IDCommand(decimal transferencia_insumos_id, bool transferencia_insumos_idNull)
		{
			string whereSql = "";
			if(transferencia_insumos_idNull)
				whereSql += "TRANSFERENCIA_INSUMOS_ID IS NULL";
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_UNID_DEST</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_destino_id">The <c>UNIDAD_MEDIDA_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_UNID_DEST</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_destino_id">The <c>UNIDAD_MEDIDA_DESTINO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_DET_UNID_ORIG</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_origen_id">The <c>UNIDAD_MEDIDA_ORIGEN_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_DET_UNID_ORIG</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_origen_id">The <c>UNIDAD_MEDIDA_ORIGEN_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table using the 
		/// <c>FK_STK_TRANF_INS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_STK_TRANF_INS_SUC_DEST</c> foreign key.
		/// </summary>
		/// <param name="sucursal_destino_id">The <c>SUCURSAL_DESTINO_ID</c> column value.</param>
		/// <param name="sucursal_destino_idNull">true if the method ignores the sucursal_destino_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.STOCK_TRANSFERENCIA_INSUMOS_DET";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		protected STOCK_TRANSFERENCIA_INSUMOS_DETRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		protected STOCK_TRANSFERENCIA_INSUMOS_DETRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> objects.</returns>
		protected virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int transferencia_insumos_idColumnIndex = reader.GetOrdinal("TRANSFERENCIA_INSUMOS_ID");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					STOCK_TRANSFERENCIA_INSUMOS_DETRow record = new STOCK_TRANSFERENCIA_INSUMOS_DETRow();
					recordList.Add(record);

					record.ID = Math.Round(Convert.ToDecimal(reader.GetValue(idColumnIndex)), 9);
					if(!reader.IsDBNull(transferencia_insumos_idColumnIndex))
						record.TRANSFERENCIA_INSUMOS_ID = Math.Round(Convert.ToDecimal(reader.GetValue(transferencia_insumos_idColumnIndex)), 9);
			...
			return (STOCK_TRANSFERENCIA_INSUMOS_DETRow[])(recordList.ToArray(typeof(STOCK_TRANSFERENCIA_INSUMOS_DETRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="STOCK_TRANSFERENCIA_INSUMOS_DETRow"/> object.</returns>
		protected virtual STOCK_TRANSFERENCIA_INSUMOS_DETRow MapRow(DataRow row)
		{
			STOCK_TRANSFERENCIA_INSUMOS_DETRow mappedObject = new STOCK_TRANSFERENCIA_INSUMOS_DETRow();
			...
			// Column "TRANSFERENCIA_INSUMOS_ID"
			dataColumn = dataTable.Columns["TRANSFERENCIA_INSUMOS_ID"];
			if(!row.IsNull(dataColumn))
				mappedObject.TRANSFERENCIA_INSUMOS_ID = (decimal)row[dataColumn];
			// Column "ARTICULO_ID"
		...
		/// the <c>STOCK_TRANSFERENCIA_INSUMOS_DET</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "STOCK_TRANSFERENCIA_INSUMOS_DET";
			DataColumn dataColumn;
			dataColumn = dataTable.Columns.Add("ID", typeof(decimal));
			dataColumn.AllowDBNull = false;
			dataColumn = dataTable.Columns.Add("TRANSFERENCIA_INSUMOS_ID", typeof(decimal));
	...
	} // End of STOCK_TRANSFERENCIA_INSUMOS_DETCollection_Base class
}  // End of namespace
