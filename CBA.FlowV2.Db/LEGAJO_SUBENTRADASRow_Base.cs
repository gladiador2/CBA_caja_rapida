// <fileinfo name="LEGAJO_SUBENTRADASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="LEGAJO_SUBENTRADASRow"/> that 
	/// represents a record in the <c>LEGAJO_SUBENTRADAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="LEGAJO_SUBENTRADASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class LEGAJO_SUBENTRADASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LEGAJO_SUBENTRADASRow_Base"/> class.
		/// </summary>
		public LEGAJO_SUBENTRADASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(LEGAJO_SUBENTRADASRow_Base original)
		{
	...
	} // End of LEGAJO_SUBENTRADASRow_Base class
} // End of namespace
