// <fileinfo name="ARTICULOS_POR_TEMPORADARow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ARTICULOS_POR_TEMPORADARow"/> that 
	/// represents a record in the <c>ARTICULOS_POR_TEMPORADA</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ARTICULOS_POR_TEMPORADARow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ARTICULOS_POR_TEMPORADARow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ARTICULOS_POR_TEMPORADARow_Base"/> class.
		/// </summary>
		public ARTICULOS_POR_TEMPORADARow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ARTICULOS_POR_TEMPORADARow_Base original)
		{
	...
	} // End of ARTICULOS_POR_TEMPORADARow_Base class
} // End of namespace
