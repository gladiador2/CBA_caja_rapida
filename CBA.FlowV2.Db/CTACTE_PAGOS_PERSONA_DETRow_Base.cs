// <fileinfo name="CTACTE_PAGOS_PERSONA_DETRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_PAGOS_PERSONA_DETRow"/> that 
	/// represents a record in the <c>CTACTE_PAGOS_PERSONA_DET</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_PAGOS_PERSONA_DETRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_PAGOS_PERSONA_DETRow_Base
	{
		private decimal _id;
		...
		private decimal _transferencia_caja_sucursal_id;
		private bool _transferencia_caja_sucursal_idNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_PAGOS_PERSONA_DETRow_Base"/> class.
		/// </summary>
		public CTACTE_PAGOS_PERSONA_DETRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_PAGOS_PERSONA_DETRow_Base original)
		{
			...
			if (this.IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull != original.IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull) return true;
			if (!this.IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull && !original.IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull)
				if (this.TRANSFERENCIA_CAJA_SUCURSAL_ID != original.TRANSFERENCIA_CAJA_SUCURSAL_ID) return true;
		...
		/// <summary>
		/// Gets or sets the <c>TRANSFERENCIA_CAJA_SUCURSAL_ID</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>TRANSFERENCIA_CAJA_SUCURSAL_ID</c> column value.</value>
		public decimal TRANSFERENCIA_CAJA_SUCURSAL_ID
		{
			get
			{
				if(IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _transferencia_caja_sucursal_id;
			}
			set
			{
				_transferencia_caja_sucursal_idNull = false;
				_transferencia_caja_sucursal_id = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="TRANSFERENCIA_CAJA_SUCURSAL_ID"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull
		{
			get { return _transferencia_caja_sucursal_idNull; }
			set { _transferencia_caja_sucursal_idNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@TRANSFERENCIA_CAJA_SUCURSAL_ID=");
			dynStr.Append(IsTRANSFERENCIA_CAJA_SUCURSAL_IDNull ? (object)"<NULL>" : TRANSFERENCIA_CAJA_SUCURSAL_ID);
			return dynStr.ToString();
		}
	} // End of CTACTE_PAGOS_PERSONA_DETRow_Base class
} // End of namespace
