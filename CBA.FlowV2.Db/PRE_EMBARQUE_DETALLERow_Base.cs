// <fileinfo name="PRE_EMBARQUE_DETALLERow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PRE_EMBARQUE_DETALLERow"/> that 
	/// represents a record in the <c>PRE_EMBARQUE_DETALLE</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PRE_EMBARQUE_DETALLERow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PRE_EMBARQUE_DETALLERow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PRE_EMBARQUE_DETALLERow_Base"/> class.
		/// </summary>
		public PRE_EMBARQUE_DETALLERow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PRE_EMBARQUE_DETALLERow_Base original)
		{
	...
	} // End of PRE_EMBARQUE_DETALLERow_Base class
} // End of namespace
