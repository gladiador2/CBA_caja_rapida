// <fileinfo name="ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ITEMS_SALIDA_DEPOSITO_DETALLESRow"/> that 
	/// represents a record in the <c>ITEMS_SALIDA_DEPOSITO_DETALLES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="ITEMS_SALIDA_DEPOSITO_DETALLESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base"/> class.
		/// </summary>
		public ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base original)
		{
	...
	} // End of ITEMS_SALIDA_DEPOSITO_DETALLESRow_Base class
} // End of namespace
