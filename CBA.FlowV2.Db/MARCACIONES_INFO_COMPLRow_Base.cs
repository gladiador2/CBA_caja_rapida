// <fileinfo name="MARCACIONES_INFO_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MARCACIONES_INFO_COMPLRow"/> that 
	/// represents a record in the <c>MARCACIONES_INFO_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MARCACIONES_INFO_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MARCACIONES_INFO_COMPLRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MARCACIONES_INFO_COMPLRow_Base"/> class.
		/// </summary>
		public MARCACIONES_INFO_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(MARCACIONES_INFO_COMPLRow_Base original)
		{
	...
	} // End of MARCACIONES_INFO_COMPLRow_Base class
} // End of namespace
