// <fileinfo name="USO_DE_INSUMOS_DET_CC_INFO_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="USO_DE_INSUMOS_DET_CC_INFO_CRow"/> that 
	/// represents a record in the <c>USO_DE_INSUMOS_DET_CC_INFO_C</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="USO_DE_INSUMOS_DET_CC_INFO_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class USO_DE_INSUMOS_DET_CC_INFO_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="USO_DE_INSUMOS_DET_CC_INFO_CRow_Base"/> class.
		/// </summary>
		public USO_DE_INSUMOS_DET_CC_INFO_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(USO_DE_INSUMOS_DET_CC_INFO_CRow_Base original)
		{
	...
	} // End of USO_DE_INSUMOS_DET_CC_INFO_CRow_Base class
} // End of namespace
