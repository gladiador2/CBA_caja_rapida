// <fileinfo name="CREDITOS_PROVEEDOR_INFO_COMPRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CREDITOS_PROVEEDOR_INFO_COMPRow"/> that 
	/// represents a record in the <c>CREDITOS_PROVEEDOR_INFO_COMP</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CREDITOS_PROVEEDOR_INFO_COMPRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CREDITOS_PROVEEDOR_INFO_COMPRow_Base
	{
		private decimal _id;
		...
		private string _caso_relac_ing_val_flujo;
		private string _caso_relac_ing_val_estado;
		private decimal _tipo_credito_id;
		private string _tipo_credito_nombre;
		...
		private bool _cantidad_cuotasNull = true;

		/// <summary>
		/// Initializes a new instance of the <see cref="CREDITOS_PROVEEDOR_INFO_COMPRow_Base"/> class.
		/// </summary>
		public CREDITOS_PROVEEDOR_INFO_COMPRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CREDITOS_PROVEEDOR_INFO_COMPRow_Base original)
		{
			...
			if (this.CASO_RELAC_ING_VAL_FLUJO != original.CASO_RELAC_ING_VAL_FLUJO) return true;
			if (this.CASO_RELAC_ING_VAL_ESTADO != original.CASO_RELAC_ING_VAL_ESTADO) return true;
			if (this.TIPO_CREDITO_ID != original.TIPO_CREDITO_ID) return true;
			if (this.TIPO_CREDITO_NOMBRE != original.TIPO_CREDITO_NOMBRE) return true;
			...
			if (this.IsCANTIDAD_CUOTASNull != original.IsCANTIDAD_CUOTASNull) return true;
			if (!this.IsCANTIDAD_CUOTASNull && !original.IsCANTIDAD_CUOTASNull)
		...
		/// <summary>
		/// Gets or sets the <c>CASO_RELAC_ING_VAL_FLUJO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CASO_RELAC_ING_VAL_FLUJO</c> column value.</value>
		public string CASO_RELAC_ING_VAL_FLUJO
		{
			get { return _caso_relac_ing_val_flujo; }
			set { _caso_relac_ing_val_flujo = value; }
		}
		
		/// <summary>
		/// Gets or sets the <c>CASO_RELAC_ING_VAL_ESTADO</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>CASO_RELAC_ING_VAL_ESTADO</c> column value.</value>
		public string CASO_RELAC_ING_VAL_ESTADO
		{
			get { return _caso_relac_ing_val_estado; }
			set { _caso_relac_ing_val_estado = value; }
		}
		...
		/// <summary>
		/// Gets or sets the <c>TIPO_CREDITO_NOMBRE</c> column value.
		/// </summary>
		/// <value>The <c>TIPO_CREDITO_NOMBRE</c> column value.</value>
		public string TIPO_CREDITO_NOMBRE
		{
			get { return _tipo_credito_nombre; }
			set { _tipo_credito_nombre = value; }
		}
		...
		public decimal CANTIDAD_CUOTAS
		{
			get
			{
				if(IsCANTIDAD_CUOTASNull)
					throw new InvalidOperationException("Cannot get value because it is DBNull.");
				return _cantidad_cuotas;
			}
			set
			{
				_cantidad_cuotasNull = false;
				_cantidad_cuotas = value;
			}
		}

		/// <summary>
		/// Indicates whether the <see cref="CANTIDAD_CUOTAS"/>
		/// property value is null.
		/// </summary>
		/// <value>true if the property value is null, otherwise false.</value>
		public bool IsCANTIDAD_CUOTASNull
		{
			get { return _cantidad_cuotasNull; }
			set { _cantidad_cuotasNull = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@CASO_RELAC_ING_VAL_FLUJO=");
			dynStr.Append(CASO_RELAC_ING_VAL_FLUJO);
			dynStr.Append("@CBA@CASO_RELAC_ING_VAL_ESTADO=");
			dynStr.Append(CASO_RELAC_ING_VAL_ESTADO);
			dynStr.Append("@CBA@TIPO_CREDITO_ID=");
			dynStr.Append(TIPO_CREDITO_ID);
			dynStr.Append("@CBA@TIPO_CREDITO_NOMBRE=");
			dynStr.Append(TIPO_CREDITO_NOMBRE);
			...
			dynStr.Append(IsCANTIDAD_CUOTASNull ? (object)"<NULL>" : CANTIDAD_CUOTAS);
			return dynStr.ToString();
		}
	} // End of CREDITOS_PROVEEDOR_INFO_COMPRow_Base class
} // End of namespace
