// <fileinfo name="TRAMITES_TIPOS_ESTADOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TRAMITES_TIPOS_ESTADOSRow"/> that 
	/// represents a record in the <c>TRAMITES_TIPOS_ESTADOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="TRAMITES_TIPOS_ESTADOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TRAMITES_TIPOS_ESTADOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TRAMITES_TIPOS_ESTADOSRow_Base"/> class.
		/// </summary>
		public TRAMITES_TIPOS_ESTADOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(TRAMITES_TIPOS_ESTADOSRow_Base original)
		{
	...
	} // End of TRAMITES_TIPOS_ESTADOSRow_Base class
} // End of namespace
