// <fileinfo name="ORDENES_COMPRA_DET_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="ORDENES_COMPRA_DET_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="ORDENES_COMPRA_DET_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class ORDENES_COMPRA_DET_INFO_COMPLCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="ORDENES_COMPRA_DET_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public ORDENES_COMPRA_DET_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>ORDENES_COMPRA_DET_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		public virtual ORDENES_COMPRA_DET_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>ORDENES_COMPRA_DET_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>ORDENES_COMPRA_DET_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public ORDENES_COMPRA_DET_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			ORDENES_COMPRA_DET_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		public ORDENES_COMPRA_DET_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		public virtual ORDENES_COMPRA_DET_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.ORDENES_COMPRA_DET_INFO_COMPL";
		...
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		protected ORDENES_COMPRA_DET_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		protected ORDENES_COMPRA_DET_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> objects.</returns>
		protected virtual ORDENES_COMPRA_DET_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					ORDENES_COMPRA_DET_INFO_COMPLRow record = new ORDENES_COMPRA_DET_INFO_COMPLRow();
			...
			return (ORDENES_COMPRA_DET_INFO_COMPLRow[])(recordList.ToArray(typeof(ORDENES_COMPRA_DET_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="ORDENES_COMPRA_DET_INFO_COMPLRow"/> object.</returns>
		protected virtual ORDENES_COMPRA_DET_INFO_COMPLRow MapRow(DataRow row)
		{
			ORDENES_COMPRA_DET_INFO_COMPLRow mappedObject = new ORDENES_COMPRA_DET_INFO_COMPLRow();
		...
		/// the <c>ORDENES_COMPRA_DET_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "ORDENES_COMPRA_DET_INFO_COMPL";
			DataColumn dataColumn;
	...
	} // End of ORDENES_COMPRA_DET_INFO_COMPLCollection_Base class
}  // End of namespace
