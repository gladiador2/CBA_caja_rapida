// <fileinfo name="DETALLES_PERSONALIZ_INF_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DETALLES_PERSONALIZ_INF_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="DETALLES_PERSONALIZ_INF_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DETALLES_PERSONALIZ_INF_COMPLCollection_Base
	{
		// Constants
		...
		public const string USUARIO_BORRADO_NOMBREColumnName = "USUARIO_BORRADO_NOMBRE";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DETALLES_PERSONALIZ_INF_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public DETALLES_PERSONALIZ_INF_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>DETALLES_PERSONALIZ_INF_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		public virtual DETALLES_PERSONALIZ_INF_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>DETALLES_PERSONALIZ_INF_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>DETALLES_PERSONALIZ_INF_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public DETALLES_PERSONALIZ_INF_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			DETALLES_PERSONALIZ_INF_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		public DETALLES_PERSONALIZ_INF_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		public virtual DETALLES_PERSONALIZ_INF_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.DETALLES_PERSONALIZ_INF_COMPL";
		...
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		protected DETALLES_PERSONALIZ_INF_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		protected DETALLES_PERSONALIZ_INF_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> objects.</returns>
		protected virtual DETALLES_PERSONALIZ_INF_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int usuario_borrado_nombreColumnIndex = reader.GetOrdinal("USUARIO_BORRADO_NOMBRE");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					DETALLES_PERSONALIZ_INF_COMPLRow record = new DETALLES_PERSONALIZ_INF_COMPLRow();
					...
					if(!reader.IsDBNull(usuario_borrado_nombreColumnIndex))
						record.USUARIO_BORRADO_NOMBRE = Convert.ToString(reader.GetValue(usuario_borrado_nombreColumnIndex));
			...
			return (DETALLES_PERSONALIZ_INF_COMPLRow[])(recordList.ToArray(typeof(DETALLES_PERSONALIZ_INF_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> object.</returns>
		protected virtual DETALLES_PERSONALIZ_INF_COMPLRow MapRow(DataRow row)
		{
			DETALLES_PERSONALIZ_INF_COMPLRow mappedObject = new DETALLES_PERSONALIZ_INF_COMPLRow();
			...
			// Column "USUARIO_BORRADO_NOMBRE"
			dataColumn = dataTable.Columns["USUARIO_BORRADO_NOMBRE"];
			if(!row.IsNull(dataColumn))
				mappedObject.USUARIO_BORRADO_NOMBRE = (string)row[dataColumn];
		...
		/// the <c>DETALLES_PERSONALIZ_INF_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "DETALLES_PERSONALIZ_INF_COMPL";
			DataColumn dataColumn;
			...
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("USUARIO_BORRADO_NOMBRE", typeof(string));
			dataColumn.MaxLength = 101;
			dataColumn.ReadOnly = true;
	...
	} // End of DETALLES_PERSONALIZ_INF_COMPLCollection_Base class
}  // End of namespace
