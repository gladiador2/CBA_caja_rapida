// <fileinfo name="CTACTE_FONDOS_FIJOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CTACTE_FONDOS_FIJOSRow"/> that 
	/// represents a record in the <c>CTACTE_FONDOS_FIJOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CTACTE_FONDOS_FIJOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CTACTE_FONDOS_FIJOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CTACTE_FONDOS_FIJOSRow_Base"/> class.
		/// </summary>
		public CTACTE_FONDOS_FIJOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CTACTE_FONDOS_FIJOSRow_Base original)
		{
	...
	} // End of CTACTE_FONDOS_FIJOSRow_Base class
} // End of namespace
