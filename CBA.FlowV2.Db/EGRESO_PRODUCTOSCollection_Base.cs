// <fileinfo name="EGRESO_PRODUCTOSCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="EGRESO_PRODUCTOSCollection"/>. Provides methods 
	/// for common database table operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="EGRESO_PRODUCTOSCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class EGRESO_PRODUCTOSCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EGRESO_PRODUCTOSCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public EGRESO_PRODUCTOSCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetAll()
		{
		...
		/// includes all records from the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		...
		/// to retrieve all records from the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="EGRESO_PRODUCTOSRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="EGRESO_PRODUCTOSRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public EGRESO_PRODUCTOSRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			EGRESO_PRODUCTOSRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects that 
		...
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.EGRESO_PRODUCTOS";
		...
		/// <summary>
		/// Gets <see cref="EGRESO_PRODUCTOSRow"/> by the primary key.
		/// </summary>
		/// <param name="id">The <c>ID</c> column value.</param>
		/// <returns>An instance of <see cref="EGRESO_PRODUCTOSRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public virtual EGRESO_PRODUCTOSRow GetByPrimaryKey(decimal id)
		{
			string whereSql = "ID=" + _db.CreateSqlParameterName("ID");
			IDbCommand cmd = CreateGetCommand(whereSql, null);
			AddParameter(cmd, "ID", id);
			EGRESO_PRODUCTOSRow[] tempArray = MapRecords(cmd);
			return 0 == tempArray.Length ? null : tempArray[0];
		}

		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_ARTICULO_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByARTICULO_ID(decimal articulo_id)
		{
		...
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByARTICULO_ID(decimal articulo_id, bool articulo_idNull)
		{
		...
		/// return records by the <c>FK_EGRESO_INSUMOS_ARTICULO_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByAUTONUMERACION_ID(decimal autonumeracion_id, bool autonumeracion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByCASO_ID(decimal caso_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByDEPOSITO_ID(decimal deposito_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByLOTE_ID(decimal lote_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByLOTE_ID(decimal lote_id, bool lote_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByMONEDA_ID(decimal moneda_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByMONEDA_ID(decimal moneda_id, bool moneda_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <param name="moneda_idNull">true if the method ignores the moneda_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByPERSONA_ID(decimal persona_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByPERSONA_ID(decimal persona_id, bool persona_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_PRESENTA_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public EGRESO_PRODUCTOSRow[] GetByPRESENTACION_ID(decimal presentacion_id)
		{
		...
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByPRESENTACION_ID(decimal presentacion_id, bool presentacion_idNull)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_PRESENTA_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <param name="presentacion_idNull">true if the method ignores the presentacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetBySUCURSAL_ID(decimal sucursal_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Gets an array of <see cref="EGRESO_PRODUCTOSRow"/> objects 
		/// by the <c>FK_EGRESO_INSUMOS_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		public virtual EGRESO_PRODUCTOSRow[] GetByUNIDAD_MEDIDA_ID(string unidad_medida_id)
		{
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to 
		/// return records by the <c>FK_EGRESO_INSUMOS_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Adds a new record into the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="EGRESO_PRODUCTOSRow"/> object to be inserted.</param>
		public virtual void Insert(EGRESO_PRODUCTOSRow value)
		{
						
			string sqlStr = "INSERT INTO TRC.EGRESO_PRODUCTOS (" +
				"ID, " +
				"CASO_ID, " +
				"SUCURSAL_ID, " +
				"DEPOSITO_ID, " +
		...
		/// <summary>
		/// Updates a record in the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="EGRESO_PRODUCTOSRow"/>
		/// object used to update the table record.</param>
		/// <returns>true if the record was updated; otherwise, false.</returns>
		public virtual bool Update(EGRESO_PRODUCTOSRow value)
		{
			
			string sqlStr = "UPDATE TRC.EGRESO_PRODUCTOS SET " +
		...
		/// <summary>
		/// Updates the <c>EGRESO_PRODUCTOS</c> table and calls the <c>AcceptChanges</c> method
		...
		/// <summary>
		/// Updates the <c>EGRESO_PRODUCTOS</c> table. Pass <c>false</c> as the <c>acceptChanges</c> 
		...
		/// <summary>
		/// Deletes the specified object from the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <param name="value">The <see cref="EGRESO_PRODUCTOSRow"/> object to delete.</param>
		/// <returns>true if the record was deleted; otherwise, false.</returns>
		public bool Delete(EGRESO_PRODUCTOSRow value)
		{
			return DeleteByPrimaryKey(value.ID);
		}

		/// <summary>
		/// Deletes a record from the <c>EGRESO_PRODUCTOS</c> table using
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_ARTICULO_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_ARTICULO_ID</c> foreign key.
		/// </summary>
		/// <param name="articulo_id">The <c>ARTICULO_ID</c> column value.</param>
		/// <param name="articulo_idNull">true if the method ignores the articulo_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_AUTONUM_ID</c> foreign key.
		/// </summary>
		/// <param name="autonumeracion_id">The <c>AUTONUMERACION_ID</c> column value.</param>
		/// <param name="autonumeracion_idNull">true if the method ignores the autonumeracion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_CASO_ID</c> foreign key.
		/// </summary>
		/// <param name="caso_id">The <c>CASO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_DEPOSITO_ID</c> foreign key.
		/// </summary>
		/// <param name="deposito_id">The <c>DEPOSITO_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_LOTE_ID</c> foreign key.
		/// </summary>
		/// <param name="lote_id">The <c>LOTE_ID</c> column value.</param>
		/// <param name="lote_idNull">true if the method ignores the lote_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_MONEDA_ID</c> foreign key.
		/// </summary>
		/// <param name="moneda_id">The <c>MONEDA_ID</c> column value.</param>
		/// <param name="moneda_idNull">true if the method ignores the moneda_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_PERSONA_ID</c> foreign key.
		/// </summary>
		/// <param name="persona_id">The <c>PERSONA_ID</c> column value.</param>
		/// <param name="persona_idNull">true if the method ignores the persona_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_PRESENTA_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_PRESENTA_ID</c> foreign key.
		/// </summary>
		/// <param name="presentacion_id">The <c>PRESENTACION_ID</c> column value.</param>
		/// <param name="presentacion_idNull">true if the method ignores the presentacion_id
		/// parameter value and uses DbNull instead of it; otherwise, false.</param>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_SUCURSAL_ID</c> foreign key.
		/// </summary>
		/// <param name="sucursal_id">The <c>SUCURSAL_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes records from the <c>EGRESO_PRODUCTOS</c> table using the 
		/// <c>FK_EGRESO_INSUMOS_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>The number of records deleted from the table.</returns>
		...
		/// <summary>
		/// Creates an <see cref="System.Data.IDbCommand"/> object that can be used to
		/// delete records using the <c>FK_EGRESO_INSUMOS_UNIDAD_ID</c> foreign key.
		/// </summary>
		/// <param name="unidad_medida_id">The <c>UNIDAD_MEDIDA_ID</c> column value.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		...
		/// <summary>
		/// Deletes <c>EGRESO_PRODUCTOS</c> records that match the specified criteria.
		/// </summary>
		...
		/// to delete <c>EGRESO_PRODUCTOS</c> records that match the specified criteria.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. 
		/// For example: <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>A reference to the <see cref="System.Data.IDbCommand"/> object.</returns>
		protected virtual IDbCommand CreateDeleteCommand(string whereSql)
		{
			...
			string sql = "DELETE FROM TRC.EGRESO_PRODUCTOS";
			if(null != whereSql && 0 < whereSql.Length)
				sql += " WHERE " + whereSql;
			return _db.CreateCommand(sql);
		}
		...
		/// <summary>
		/// Deletes all records from the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <returns>The number of deleted records.</returns>
		...
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		protected EGRESO_PRODUCTOSRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		protected EGRESO_PRODUCTOSRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="EGRESO_PRODUCTOSRow"/> objects.</returns>
		protected virtual EGRESO_PRODUCTOSRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					EGRESO_PRODUCTOSRow record = new EGRESO_PRODUCTOSRow();
			...
			return (EGRESO_PRODUCTOSRow[])(recordList.ToArray(typeof(EGRESO_PRODUCTOSRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="EGRESO_PRODUCTOSRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="EGRESO_PRODUCTOSRow"/> object.</returns>
		protected virtual EGRESO_PRODUCTOSRow MapRow(DataRow row)
		{
			EGRESO_PRODUCTOSRow mappedObject = new EGRESO_PRODUCTOSRow();
		...
		/// the <c>EGRESO_PRODUCTOS</c> table.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "EGRESO_PRODUCTOS";
			DataColumn dataColumn;
	...
	} // End of EGRESO_PRODUCTOSCollection_Base class
}  // End of namespace
