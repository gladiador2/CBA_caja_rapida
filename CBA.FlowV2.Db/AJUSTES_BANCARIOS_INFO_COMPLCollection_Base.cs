// <fileinfo name="AJUSTES_BANCARIOS_INFO_COMPLCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="AJUSTES_BANCARIOS_INFO_COMPLCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="AJUSTES_BANCARIOS_INFO_COMPLCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class AJUSTES_BANCARIOS_INFO_COMPLCollection_Base
	{
		// Constants
		...
		public const string CTACTE_BANCARIA_NUMERO_CUENTAColumnName = "CTACTE_BANCARIA_NUMERO_CUENTA";
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="AJUSTES_BANCARIOS_INFO_COMPLCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public AJUSTES_BANCARIOS_INFO_COMPLCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>AJUSTES_BANCARIOS_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		public virtual AJUSTES_BANCARIOS_INFO_COMPLRow[] GetAll()
		{
		...
		/// includes all records from the <c>AJUSTES_BANCARIOS_INFO_COMPL</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>AJUSTES_BANCARIOS_INFO_COMPL</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public AJUSTES_BANCARIOS_INFO_COMPLRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			AJUSTES_BANCARIOS_INFO_COMPLRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects that 
		...
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		public AJUSTES_BANCARIOS_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		public virtual AJUSTES_BANCARIOS_INFO_COMPLRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.AJUSTES_BANCARIOS_INFO_COMPL";
		...
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		protected AJUSTES_BANCARIOS_INFO_COMPLRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		protected AJUSTES_BANCARIOS_INFO_COMPLRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> objects.</returns>
		protected virtual AJUSTES_BANCARIOS_INFO_COMPLRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			int ctacte_bancaria_numero_cuentaColumnIndex = reader.GetOrdinal("CTACTE_BANCARIA_NUMERO_CUENTA");
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					AJUSTES_BANCARIOS_INFO_COMPLRow record = new AJUSTES_BANCARIOS_INFO_COMPLRow();
					...
					record.CTACTE_BANCARIA_NUMERO_CUENTA = Convert.ToString(reader.GetValue(ctacte_bancaria_numero_cuentaColumnIndex));
			...
			return (AJUSTES_BANCARIOS_INFO_COMPLRow[])(recordList.ToArray(typeof(AJUSTES_BANCARIOS_INFO_COMPLRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="AJUSTES_BANCARIOS_INFO_COMPLRow"/> object.</returns>
		protected virtual AJUSTES_BANCARIOS_INFO_COMPLRow MapRow(DataRow row)
		{
			AJUSTES_BANCARIOS_INFO_COMPLRow mappedObject = new AJUSTES_BANCARIOS_INFO_COMPLRow();
			...
			// Column "CTACTE_BANCARIA_NUMERO_CUENTA"
			dataColumn = dataTable.Columns["CTACTE_BANCARIA_NUMERO_CUENTA"];
			if(!row.IsNull(dataColumn))
				mappedObject.CTACTE_BANCARIA_NUMERO_CUENTA = (string)row[dataColumn];
			// Column "SUCURSAL_ID"
		...
		/// the <c>AJUSTES_BANCARIOS_INFO_COMPL</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "AJUSTES_BANCARIOS_INFO_COMPL";
			DataColumn dataColumn;
			...
			dataColumn.AllowDBNull = false;
			dataColumn.ReadOnly = true;
			dataColumn = dataTable.Columns.Add("CTACTE_BANCARIA_NUMERO_CUENTA", typeof(string));
		...
		protected virtual IDbDataParameter AddParameter(IDbCommand cmd, string paramName, object value)
		{
			...
			switch(paramName)
			{
				...
				case "CTACTE_BANCARIA_NUMERO_CUENTA":
					parameter = _db.AddParameter(cmd, paramName, DbType.AnsiString, value);
					break;
	...
	} // End of AJUSTES_BANCARIOS_INFO_COMPLCollection_Base class
}  // End of namespace
