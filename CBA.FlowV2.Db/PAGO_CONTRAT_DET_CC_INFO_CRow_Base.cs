// <fileinfo name="PAGO_CONTRAT_DET_CC_INFO_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PAGO_CONTRAT_DET_CC_INFO_CRow"/> that 
	/// represents a record in the <c>PAGO_CONTRAT_DET_CC_INFO_C</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PAGO_CONTRAT_DET_CC_INFO_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PAGO_CONTRAT_DET_CC_INFO_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PAGO_CONTRAT_DET_CC_INFO_CRow_Base"/> class.
		/// </summary>
		public PAGO_CONTRAT_DET_CC_INFO_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PAGO_CONTRAT_DET_CC_INFO_CRow_Base original)
		{
	...
	} // End of PAGO_CONTRAT_DET_CC_INFO_CRow_Base class
} // End of namespace
