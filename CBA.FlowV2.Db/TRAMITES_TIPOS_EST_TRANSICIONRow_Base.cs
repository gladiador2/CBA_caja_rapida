// <fileinfo name="TRAMITES_TIPOS_EST_TRANSICIONRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TRAMITES_TIPOS_EST_TRANSICIONRow"/> that 
	/// represents a record in the <c>TRAMITES_TIPOS_EST_TRANSICION</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="TRAMITES_TIPOS_EST_TRANSICIONRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TRAMITES_TIPOS_EST_TRANSICIONRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TRAMITES_TIPOS_EST_TRANSICIONRow_Base"/> class.
		/// </summary>
		public TRAMITES_TIPOS_EST_TRANSICIONRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(TRAMITES_TIPOS_EST_TRANSICIONRow_Base original)
		{
		...
		{
			get { return _tramite_tipo_estado_destino_id; }
			set { _tramite_tipo_estado_destino_id = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append(TRAMITE_TIPO_ESTADO_DESTINO_ID);
			return dynStr.ToString();
		}
	} // End of TRAMITES_TIPOS_EST_TRANSICIONRow_Base class
} // End of namespace
