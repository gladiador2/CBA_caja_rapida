// <fileinfo name="MOV_FONDO_FIJO_DET_CENT_CRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="MOV_FONDO_FIJO_DET_CENT_CRow"/> that 
	/// represents a record in the <c>MOV_FONDO_FIJO_DET_CENT_C</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="MOV_FONDO_FIJO_DET_CENT_CRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class MOV_FONDO_FIJO_DET_CENT_CRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="MOV_FONDO_FIJO_DET_CENT_CRow_Base"/> class.
		/// </summary>
		public MOV_FONDO_FIJO_DET_CENT_CRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(MOV_FONDO_FIJO_DET_CENT_CRow_Base original)
		{
	...
	} // End of MOV_FONDO_FIJO_DET_CENT_CRow_Base class
} // End of namespace
