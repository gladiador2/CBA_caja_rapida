// <fileinfo name="DETALLES_PERSONALIZ_INF_COMPLRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/> that 
	/// represents a record in the <c>DETALLES_PERSONALIZ_INF_COMPL</c> view.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="DETALLES_PERSONALIZ_INF_COMPLRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class DETALLES_PERSONALIZ_INF_COMPLRow_Base
	{
		private decimal _id;
		...
		private string _usuario_borrado_nombre;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="DETALLES_PERSONALIZ_INF_COMPLRow_Base"/> class.
		/// </summary>
		public DETALLES_PERSONALIZ_INF_COMPLRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(DETALLES_PERSONALIZ_INF_COMPLRow_Base original)
		{
			...
			if (this.USUARIO_BORRADO_NOMBRE != original.USUARIO_BORRADO_NOMBRE) return true;
		...
		/// <summary>
		/// Gets or sets the <c>USUARIO_BORRADO_NOMBRE</c> column value.
		/// This column is nullable.
		/// </summary>
		/// <value>The <c>USUARIO_BORRADO_NOMBRE</c> column value.</value>
		public string USUARIO_BORRADO_NOMBRE
		{
			get { return _usuario_borrado_nombre; }
			set { _usuario_borrado_nombre = value; }
		}
		...
		public override string ToString()
		{
			...
			dynStr.Append("@CBA@USUARIO_BORRADO_NOMBRE=");
			dynStr.Append(USUARIO_BORRADO_NOMBRE);
	...
	} // End of DETALLES_PERSONALIZ_INF_COMPLRow_Base class
} // End of namespace
