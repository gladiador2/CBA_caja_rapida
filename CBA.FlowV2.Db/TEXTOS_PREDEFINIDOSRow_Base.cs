// <fileinfo name="TEXTOS_PREDEFINIDOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="TEXTOS_PREDEFINIDOSRow"/> that 
	/// represents a record in the <c>TEXTOS_PREDEFINIDOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="TEXTOS_PREDEFINIDOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class TEXTOS_PREDEFINIDOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="TEXTOS_PREDEFINIDOSRow_Base"/> class.
		/// </summary>
		public TEXTOS_PREDEFINIDOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(TEXTOS_PREDEFINIDOSRow_Base original)
		{
	...
	} // End of TEXTOS_PREDEFINIDOSRow_Base class
} // End of namespace
