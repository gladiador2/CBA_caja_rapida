// <fileinfo name="PLAN_TAREASRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="PLAN_TAREASRow"/> that 
	/// represents a record in the <c>PLAN_TAREAS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="PLAN_TAREASRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class PLAN_TAREASRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="PLAN_TAREASRow_Base"/> class.
		/// </summary>
		public PLAN_TAREASRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(PLAN_TAREASRow_Base original)
		{
	...
	} // End of PLAN_TAREASRow_Base class
} // End of namespace
