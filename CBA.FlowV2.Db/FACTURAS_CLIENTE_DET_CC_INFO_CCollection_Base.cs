// <fileinfo name="FACTURAS_CLIENTE_DET_CC_INFO_CCollection_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CCollection"/>. Provides methods 
	/// for common database view operations. 
	/// </summary>
	/// <remarks>
	/// Do not change this source code. Update the <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CCollection"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class FACTURAS_CLIENTE_DET_CC_INFO_CCollection_Base
	{
		// Constants
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CCollection_Base"/> 
		/// class with the specified <see cref="CBAV2"/>.
		/// </summary>
		/// <param name="db">The <see cref="CBAV2"/> object.</param>
		public FACTURAS_CLIENTE_DET_CC_INFO_CCollection_Base(CBAV2 db)
		{
			_db = db;
		}
		...
		/// <summary>
		/// Gets an array of all records from the <c>FACTURAS_CLIENTE_DET_CC_INFO_C</c> view.
		/// </summary>
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		public virtual FACTURAS_CLIENTE_DET_CC_INFO_CRow[] GetAll()
		{
		...
		/// includes all records from the <c>FACTURAS_CLIENTE_DET_CC_INFO_C</c> view.
		/// </summary>
		...
		/// to retrieve all records from the <c>FACTURAS_CLIENTE_DET_CC_INFO_C</c> view.
		/// </summary>
		...
		/// <summary>
		/// Gets the first <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects that 
		/// match the search condition.
		/// </summary>
		/// <param name="whereSql">The SQL search condition. For example: 
		/// <c>"FirstName='Smith' AND Zip=75038"</c>.</param>
		/// <returns>An instance of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> or null reference 
		/// (Nothing in Visual Basic) if the object was not found.</returns>
		public FACTURAS_CLIENTE_DET_CC_INFO_CRow GetRow(string whereSql)
		{
			int totalRecordCount = -1;
			FACTURAS_CLIENTE_DET_CC_INFO_CRow[] rows = GetAsArray(whereSql, null, 0, 1, ref totalRecordCount);
			return 0 == rows.Length ? null : rows[0];
		}

		/// <summary>
		/// Gets an array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects that 
		...
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		public FACTURAS_CLIENTE_DET_CC_INFO_CRow[] GetAsArray(string whereSql, string orderBySql)
		{
			int totalRecordCount = -1;
		...
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		public virtual FACTURAS_CLIENTE_DET_CC_INFO_CRow[] GetAsArray(string whereSql, string orderBySql,
		...
		protected virtual IDbCommand CreateGetCommand(string whereSql, string orderBySql)
		{
			...
			string sql = "SELECT * FROM TRC.FACTURAS_CLIENTE_DET_CC_INFO_C";
		...
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		protected FACTURAS_CLIENTE_DET_CC_INFO_CRow[] MapRecords(IDbCommand command)
		{
		...
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		protected FACTURAS_CLIENTE_DET_CC_INFO_CRow[] MapRecords(IDataReader reader)
		{
			int totalRecordCount = -1;
		...
		/// of records in the reader object if 0 was passed into the method; otherwise it returns -1.</param>
		/// <returns>An array of <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> objects.</returns>
		protected virtual FACTURAS_CLIENTE_DET_CC_INFO_CRow[] MapRecords(IDataReader reader, 
										int startIndex, int length, ref int totalRecordCount)
		{
			if(0 > startIndex)
			...
			while(reader.Read())
			{
				...
				if(ri > 0 && ri <= length)
				{
					FACTURAS_CLIENTE_DET_CC_INFO_CRow record = new FACTURAS_CLIENTE_DET_CC_INFO_CRow();
			...
			return (FACTURAS_CLIENTE_DET_CC_INFO_CRow[])(recordList.ToArray(typeof(FACTURAS_CLIENTE_DET_CC_INFO_CRow)));
		}
		...
		/// <summary>
		/// Converts <see cref="System.Data.DataRow"/> to <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/>.
		/// </summary>
		/// <param name="row">The <see cref="System.Data.DataRow"/> object to be mapped.</param>
		/// <returns>A reference to the <see cref="FACTURAS_CLIENTE_DET_CC_INFO_CRow"/> object.</returns>
		protected virtual FACTURAS_CLIENTE_DET_CC_INFO_CRow MapRow(DataRow row)
		{
			FACTURAS_CLIENTE_DET_CC_INFO_CRow mappedObject = new FACTURAS_CLIENTE_DET_CC_INFO_CRow();
		...
		/// the <c>FACTURAS_CLIENTE_DET_CC_INFO_C</c> view.
		/// </summary>
		/// <returns>A reference to the <see cref="System.Data.DataTable"/> object.</returns>
		protected virtual DataTable CreateDataTable()
		{
			DataTable dataTable = new DataTable();
			dataTable.TableName = "FACTURAS_CLIENTE_DET_CC_INFO_C";
			DataColumn dataColumn;
	...
	} // End of FACTURAS_CLIENTE_DET_CC_INFO_CCollection_Base class
}  // End of namespace
