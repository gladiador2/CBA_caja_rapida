// <fileinfo name="STOCK_TRANSFERENCIA_BALANCEADOSRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="STOCK_TRANSFERENCIA_BALANCEADOSRow"/> that 
	/// represents a record in the <c>STOCK_TRANSFERENCIA_BALANCEADOS</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="STOCK_TRANSFERENCIA_BALANCEADOSRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class STOCK_TRANSFERENCIA_BALANCEADOSRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="STOCK_TRANSFERENCIA_BALANCEADOSRow_Base"/> class.
		/// </summary>
		public STOCK_TRANSFERENCIA_BALANCEADOSRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(STOCK_TRANSFERENCIA_BALANCEADOSRow_Base original)
		{
	...
	} // End of STOCK_TRANSFERENCIA_BALANCEADOSRow_Base class
} // End of namespace
