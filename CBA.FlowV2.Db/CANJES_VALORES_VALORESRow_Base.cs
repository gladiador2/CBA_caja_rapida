// <fileinfo name="CANJES_VALORES_VALORESRow_Base.cs">
//		<copyright>
//			All rights reserved.
//		</copyright>
//		<remarks>
...
{
	/// <summary>
	/// The base class for <see cref="CANJES_VALORES_VALORESRow"/> that 
	/// represents a record in the <c>CANJES_VALORES_VALORES</c> table.
	/// </summary>
	/// <remarks>
	/// Do not change this source code manually. Update the <see cref="CANJES_VALORES_VALORESRow"/>
	/// class if you need to add or change some functionality.
	/// </remarks>
	public abstract class CANJES_VALORES_VALORESRow_Base
	{
		private decimal _id;
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="CANJES_VALORES_VALORESRow_Base"/> class.
		/// </summary>
		public CANJES_VALORES_VALORESRow_Base()
		{
			// EMPTY
		}
		...
		/// </summary>
		public bool FueModificado(CANJES_VALORES_VALORESRow_Base original)
		{
	...
	} // End of CANJES_VALORES_VALORESRow_Base class
} // End of namespace
